<v-image-search-result-component>
    <div class="mt-8 rounded-lg border border-navyBorder p-5 max-sm:grid max-sm:gap-y-2.5 max-sm:p-2.5">
...
@pushOnce('scripts')
    ...
    >
        <div class="mt-8 rounded-lg border border-navyBorder bg-navySurface p-5 max-sm:mt-0 max-sm:grid max-sm:gap-y-2.5 max-sm:p-2.5">
            <div class="flex gap-12 max-sm:items-center max-sm:gap-4">
                <img
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-wrap gap-5 max-sm:hidden">
                        <span 
                            class="flex cursor-pointer items-center justify-center rounded-full border border-darkBlue px-4 py-1.5 font-medium text-darkBlue"
                            :class="{'rounded-full bg-darkBlue text-navyBlue': term.name.trim() === queryParameter.trim()}"
            ...
            <div class="hidden flex-wrap gap-2 max-sm:flex">
                <span 
                    class="flex cursor-pointer items-center justify-center rounded-full border border-darkBlue bg-navySurface font-medium text-darkBlue"
                    v-for="term in searchedTerms"
                    @click="search(term)"
                >
                    <span
