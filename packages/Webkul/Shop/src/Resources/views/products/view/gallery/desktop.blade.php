...
<div class="sticky top-20 flex h-max gap-8 max-1180:hidden">
        ...
        >
            <template v-for="(media, index) in [...media.images, ...media.videos]">
                <video
                    ...
                    :class="`transparent max-h-[100px] min-w-[100px] cursor-pointer rounded-xl border ${isActiveMedia(index) ? 'pointer-events-none border-darkBlue' : 'border-navyBorder'}`"
                ...
                <img
                    v-else
                    :class="`transparent max-h-[100px] min-w-[100px] cursor-pointer rounded-xl border ${isActiveMedia(index) ? 'pointer-events-none border border-darkBlue' : 'border-navyBorder'}`"
    ...
    >
        <div class="shimmer min-h-[607px] min-w-[560px] rounded-xl bg-navySurfaceHover"></div>
    </div>
