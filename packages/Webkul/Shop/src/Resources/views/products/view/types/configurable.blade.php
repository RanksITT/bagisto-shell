                            ...
                            <template v-for="(option, index) in attribute.options">
                                <template v-if="option.id">
                                    ...
                                    <label
                                        ...
                                        :class="{'ring-2 ring-darkBlue' : option.id == attribute.selectedValue}"
                                        :title="option.label"
                                    ...
                                    >
                                        ...
                                        <span
                                            class="h-8 w-8 rounded-full border border-navyBorder max-sm:h-[25px] max-sm:w-[25px]"
                                            tabindex="0"
                                    ...
                                    <label 
                                        class="group relative flex h-[60px] w-[60px] cursor-pointer items-center justify-center overflow-hidden rounded-md border bg-navySurface font-medium uppercase text-offWhite hover:bg-navySurfaceHover sm:py-6"
                                        :class="{'border-darkBlue' : option.id == attribute.selectedValue }"
                                        :title="option.label"
                                    ...
                                    <!-- Text Swatch Options -->
                                    <label 
                                        class="group relative flex h-fit min-w-fit cursor-pointer items-center justify-center rounded-full border border-navyBorder bg-navySurface px-5 py-3 font-medium uppercase text-offWhite hover:bg-navySurfaceHover max-sm:h-fit max-sm:w-fit max-sm:px-3.5 max-sm:py-2"
                                        :class="{'border-transparent !bg-darkBlue text-navyBlue' : option.id == attribute.selectedValue }"
                                        :title="option.label"
