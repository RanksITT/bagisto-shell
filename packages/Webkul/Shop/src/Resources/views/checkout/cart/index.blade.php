                ...
                <template v-else>
                    ...
                    >
                        <div class="flex flex-1 flex-col gap-6 max-md:gap-5">
                            ...
                            <div class="flex items-center justify-between border-b border-navyBorder pb-2.5 max-md:py-2.5">
                                ...
                                <div v-if="selectedItemsCount">
                                    <span
                                        class="cursor-pointer text-base text-darkBlue max-sm:text-xs"
                                        role="button"
                                        tabindex="0"
                                    ...
                                    @if (auth()->guard()->check())
                                        <span class="mx-2.5 border-r-2 border-navyBorder"></span>
                            ...
                            >
                                <div class="flex justify-between gap-x-2.5 border-b border-navyBorder pb-5">
                                    <div class="flex gap-x-5">
                                        ...
                                        <div class="grid place-content-start gap-y-2.5 max-md:gap-y-0">
                                            ...
                                            <div class="md:hidden">
                                                ...
                                                <span
                                                    class="cursor-pointer text-base text-darkBlue max-md:hidden"
                                                    role="button"
                                                    tabindex="0"
                                            ...
                                            <div class="flex items-center gap-2.5 max-md:mt-2.5">
                                                <x-shop::quantity-changer
                                                    ...
                                                    class="flex max-w-max items-center gap-x-2.5 rounded-[54px] border border-darkBlue px-3.5 py-1.5 max-md:gap-x-1.5 max-md:px-1 max-md:py-0.5"
                                                    name="quantity"
                                                    ::value="item?.quantity"
                                                    :removable="true"
                                                ...
                                                <span
                                                    class="hidden cursor-pointer text-sm text-darkBlue max-md:block"
                                                    role="button"
                                                    tabindex="0"
                                                    @click="removeItem(item.id)"
                                                >
                                    ...
                                    <div class="text-right max-md:hidden">
                                        ...
                                        <span
                                            class="cursor-pointer text-base text-darkBlue"
                                            role="button"
                                            tabindex="0"
                                            @click="removeItem(item.id)"
                                        >
