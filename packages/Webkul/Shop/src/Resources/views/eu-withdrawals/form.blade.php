    ...
    <div class="container mt-10 mx-auto max-w-3xl px-5 max-md:mt-6 max-md:px-4">
        ...
        >
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                {{-- Reason Input --}}
                <div class="rounded-xl border border-navyBorder bg-navySurface p-5 md:col-span-2">
                    <label
                        for="reason_text"
                    ...
                    <textarea
                        ...
                        rows="6"
                        maxlength="5000"
                        class="mt-3 block w-full rounded-lg border border-navyBorder bg-navySurface px-4 py-3 text-sm text-offWhite placeholder:text-mutedBlue focus:border-darkBlue focus:outline-none focus:ring-1 focus:ring-darkBlue"
