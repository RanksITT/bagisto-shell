            ...
            <template v-else>
                <div class="flex w-full items-center gap-x-1">
                    ...
                    <div class="flex max-w-[445px] items-center max-md:w-full max-md:max-w-[250px]">
                        <div class="relative w-full">
                            <input
                                ...
                                class="rounded-lg border border-navyBorder bg-navySurface px-3 py-2 text-base text-mutedBlue transition-all hover:border-darkBlue focus:border-darkBlue max-md:max-w-[250px] max-md:py-2 max-sm:py-1.5 ltr:pr-8 rtl:pl-8"
                    ...
                    <div class="max-md:hidden ltr:pl-2.5 rtl:pr-2.5">
                        <p class="text-sm font-light text-offWhite max-md:w-full">
