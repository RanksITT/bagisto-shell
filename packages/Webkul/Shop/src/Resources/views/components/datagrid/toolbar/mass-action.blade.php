            ...
            <div class="flex w-full items-center gap-x-1">
                <x-shop::dropdown position="bottom-left">
                    <x-slot:toggle>
                        <button
                            type="button"
                            class="inline-flex w-full max-w-max cursor-pointer appearance-none items-center justify-between gap-x-2 rounded-md border border-navyBorder bg-navySurface px-2.5 py-1.5 text-center leading-6 text-mutedBlue transition-all marker:shadow hover:border-darkBlue focus:border-darkBlue focus:ring-darkBlue"
                        >
                            <span>
                    ...
                    <x-slot:menu class="border-navyBorder !p-0 shadow-[0_5px_20px_rgba(0,0,0,0.15)]">
                        <template v-for="massAction in available.massActions">
                            ...
                            >
                                <a
                                    class="whitespace-no-wrap !rounded-0 flex cursor-not-allowed justify-between gap-1.5 bg-navySurface px-4 py-2 hover:bg-navySurfaceHover"
                                ...
                                <ul class="absolute top-0 z-10 hidden w-max min-w-[150px] rounded border border-navyBorder bg-navySurface shadow-[0_5px_20px_rgba(0,0,0,0.15)] group-hover/item:block ltr:left-full rtl:right-full">
                                    <li v-for="option in massAction.options">
                                        <a
                                            class="whitespace-no-wrap block rounded-t px-4 py-2 hover:bg-navySurfaceHover"
                                            href="javascript:void(0);"
                            ...
                            <li v-else>
                                <a
                                    class="whitespace-no-wrap flex gap-1.5 rounded-b px-4 py-2 hover:bg-navySurfaceHover"
                                    href="javascript:void(0);"
                ...
                <div class="ltr:pl-2.5 rtl:pr-2.5">
                    <p class="text-sm font-light text-offWhite">
