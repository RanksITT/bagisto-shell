            ...
            <div class="relative">
                ...
                >
                    ...
                    >
                        <a
                            :href="category.slug"
                            class="h-[110px] w-[110px] rounded-full bg-photoBackdrop max-md:h-20 max-md:w-20 max-sm:h-[60px] max-sm:w-[60px]"
                        ...
                        >
                            <p
                                class="text-center text-lg text-offWhite max-md:text-base max-md:font-normal max-sm:text-sm"
                ...
                <span
                    class="icon-arrow-left-stylish absolute -left-10 top-9 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-navyBorder bg-navySurface text-2xl transition hover:bg-darkBlue hover:text-navyBlue max-lg:-left-7 max-md:hidden"
                    role="button"
                ...
                <span
                    class="icon-arrow-right-stylish absolute -right-6 top-9 flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-full border border-navyBorder bg-navySurface text-2xl transition hover:bg-darkBlue hover:text-navyBlue max-lg:-right-7 max-md:hidden"
                    role="button"
