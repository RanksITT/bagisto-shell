...
<div class="mt-8">
    ...
    <div class="grid grid-cols-2 gap-5 max-1060:grid-cols-[1fr] max-lg:grid-cols-2 max-sm:mt-4 max-sm:grid-cols-1">
        <!-- Single card addredd -->
        <div class="relative max-w-[414px] rounded-xl border border-navyBorder p-0">
        ...
        <!-- Single card addredd -->
        <div class="flex max-w-[414px] items-center justify-center rounded-xl border border-navyBorder p-5 max-sm:flex-wrap">
