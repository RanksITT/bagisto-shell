...
@pushOnce('scripts')
    ...
    >
        <span class="relative">
            ...
            <i class="icon-calendar pointer-events-none absolute top-1/2 -translate-y-1/2 text-2xl text-mutedBlue ltr:right-2 rtl:left-2"></i>
        </span>
    </script>
        ...
        app.component('v-date-picker', {
            ...
            watch: {
                minDate: function (value) {
                    this.datepicker?.set('minDate', value ?? '');
                },
