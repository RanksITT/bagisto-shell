<x-shop::layouts.account>
    ...
    <div class="flex-auto mx-4 max-md:mx-6 max-sm:mx-4">
        ...
        <div class="grid grid-cols-1 mt-8 gap-y-6 max-md:mt-5 max-sm:gap-y-4">
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-navyBorder px-8 py-3 max-md:px-0">
                <p class="text-sm font-medium">
                    @lang('shop::app.customers.account.profile.index.first-name')
                </p>

                <p class="text-sm font-medium text-mutedBlue" v-pre>
                    {{ $customer->first_name }}
                </p>
            </div>
            ...
            <div class="grid w-full grid-cols-[2fr_3fr] border-b border-navyBorder px-8 py-3 max-md:px-0">
                ...
                <p
                    class="text-sm font-medium no-underline text-mutedBlue"
                    v-pre
                >
                    {{ $customer->email }}
                </p>
