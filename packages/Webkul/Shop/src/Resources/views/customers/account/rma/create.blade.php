                        ...
                        >
                            ...
                            <x-slot:footer>
                                <div class="flex justify-end">
                                    ...
                                    >
                                        <svg v-if="!rmaFormSubmit" aria-hidden="true" class="w-5 h-5 text-navyBorder animate-spin fill-darkBlue" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p class="flex text-sm justify-between">
                                    <template v-if="product.url_key && product.visible_individually">
                                        <a
                                            ...
                                            target='_blank'
                                            class="text-darkBlue text-base font-semibold hover:underline"
                                        >
                                            @{{ product.name }}
