...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© حقوق الطبع والنشر 2010 - :current_year، Rancon LubMart. جميع الحقوق محفوظة.',
        ...
        'signup-form' => [
            ...
            'verify-failed' => 'لا يمكننا التحقق من حساب البريد الإلكتروني الخاص بك.',
        ],
        ...
        'account' => [
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'shipping-and-payment' => 'تفاصيل الشحن والدفع',
                    'status' => 'الحالة',
                    'title' => 'عرض',
                    'total' => 'الإجمالي',
                    ...
                    'information' => [
                        ...
                        'item-refunded' => 'تمت المرتجعة (:qty_refunded)',
                        'invoiced-item' => 'تمت الفوترة (:qty_invoiced)',
                        'item-shipped' => 'تم الشحن (:qty_shipped)',
                        'item-status' => 'حالة العنصر',
                        'ordered-item' => 'تم الطلب (:qty_ordered)',
                        'placed-on' => 'تم الطلب في',
                        'price' => 'السعر',
                        'product-name' => 'الاسم',
                        'shipping-handling' => 'الشحن والتسليم',
                        'shipping-handling-excl-tax' => 'الشحن والتسليم (باستثناء الضريبة)',
                        ...
                        'total-refunded' => 'المجموع المسترد',
                    ],
                    ...
                    'shipments' => [
                        'individual-shipment' => 'الشحنة #:shipment_id',
                        'product-name' => 'الاسم',
                        'qty' => 'الكمية',
                        'shipments' => 'الشحنات',
                        'sku' => 'رمز المنتج',
                    ...
                    'refunds' => [
                        ...
                        'discount' => 'الخصم',
                        'grand-total' => 'المجموع الكلي',
                        'individual-refund' => 'الاسترداد #:refund_id',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'webmcp' => [
                ...
                'proceed-to-checkout' => 'افتح صفحة الدفع لبدء تقديم طلب للمنتجات الموجودة حاليًا في السلة.',
                'search-products' => 'ابحث في كتالوج المتجر عن المنتجات بالكلمات المفتاحية وافتح النتائج المطابقة.',
                'search-products-query' => 'الكلمات المفتاحية أو اسم المنتج للبحث في الكتالوج.',
                'subscribe-newsletter' => 'اشترك بعنوان بريد إلكتروني في النشرة الإخبارية للمتجر.',
                'subscribe-newsletter-email' => 'عنوان البريد الإلكتروني للاشتراك في النشرة الإخبارية.',
                'view-cart' => 'افتح صفحة سلة التسوق ليتمكن العميل من مراجعة المنتجات التي أضافها.',
                'view-product' => 'افتح صفحة تفاصيل المنتج باسم المنتج.',
                'view-product-query' => 'اسم المنتج أو مفتاح الرابط لفتحه.',
                'view-wishlist' => 'افتح صفحة قائمة الأمنيات لمراجعة المنتجات المحفوظة للعميل.',
            ],
            ...
            'footer' => [
                ...
                'footer-text' => '© حقوق النشر 2010 - :current_year ، Rancon LubMart. كل الحقوق محفوظة.',
                'locale' => 'اللغة',
        ...
        'story' => [
            ...
            'protection' => [
                'kept' => 'محمي',
                'text' => 'سطح المحمل يتخدش ويتنقر دون طبقة تفصل بين المعدن. حافظ على الطبقة تحافظ على القطعة.',
                'title' => 'التآكل يحدث حيث لا يوجد زيت',
                'worn' => 'بدون حماية',
            ],
            ...
            'viscosity' => [
                'cold' => 'بارد',
                'hot' => 'ساخن',
                'text' => 'الرقم الأول يوضح الانسياب على البارد والثاني الثبات على الحار. الزيت متعدد الدرجات يجمع الاثنين.',
                'title' => 'اعثر على الدرجة المناسبة',
            ],

            'engine' => [
                'eyebrow' => 'داخل المحرك',
                'step-gallery' => 'يصعد عبر القنوات',
                'step-ring' => 'يغلف جدار الأسطوانة',
                'step-sump' => 'يملأ حوض الزيت',
                'text' => 'يصل زيت شل الأصلي إلى كل جزء متحرك، من الحوض إلى الحلقة العليا.',
                'title' => 'حماية كاملة حتى العمق',
            ],
        ],
        ...
        'carousel' => [
            ...
            'go-to-slide' => 'الانتقال إلى الشريحة :number',
    ...
    'categories' => [
        ...
        'view' => [
            'empty' => 'لا تتوفر منتجات في هذا الفئة',
            'load-more' => 'تحميل المزيد',
        ],
    ],

    'search' => [
        'title' => 'هذه هي النتائج لـ : :query',
        'suggest' => 'ابحث بدلاً من ذلك عن',
        'results' => 'نتائج البحث',
    ...
    'checkout' => [
        ...
        'onepage' => [
            'address' => [
                ...
                'check-shipping-address' => 'العنوان الشحن مفقود.',
                'city' => 'المدينة',
                'company-name' => 'اسم الشركة',
                'confirm' => 'تأكيد',
                'country' => 'الدولة',
    ...
    'home' => [
        ...
        'index' => [
            'brand-strip' => 'شريط العلامات التجارية',
    ...
    'subscription' => [
        ...
        'subscribe-success' => 'لقد اشتركت بنجاح في النشرة الإخبارية لدينا.',
        'unsubscribe-success' => 'تم إلغاء اشتراكك بنجاح في النشرة الإخبارية لدينا.',
    ],
    ...
    'emails' => [
        ...
        'customers' => [
            'registration' => [
                'credentials-description' => 'تم إنشاء حسابك. تفاصيل حسابك أدناه:',
    ...
    'eu_withdrawal' => [
        'button' => [
            ...
            'view_existing' => 'عرض طلب الانسحاب',
        ],

        'guest_dropdown' => [
            'link' => 'الانسحاب من عقد',
        ],

        'lookup' => [
            'page_title' => 'الانسحاب من عقد',
            'heading' => 'الانسحاب من عقدك',
            'intro' => 'أدخل رقم الطلب وعنوان البريد الإلكتروني الذي استخدمته عند الدفع، وسنرسل إليك رابطاً لتقديم طلب الانسحاب.',
            'order_number' => 'رقم الطلب',
            'email' => 'عنوان البريد الإلكتروني',
            'submit' => 'أرسل لي رابط الانسحاب',
            'sent_notice' => 'إذا كان هناك طلب مطابق، فقد أرسلنا للتو رابط الانسحاب إلى ذلك العنوان. سيكون الرابط صالحاً لمدة 24 ساعة.',
            'legal_note' => 'يحقّ لك قانونياً بموجب التوجيه الأوروبي 2011/83/EU (وتعديلاته) الانسحاب من عقدك خلال 14 يوماً. وتظل سُبل الانسحاب الأخرى — بما في ذلك إرسال إقرار خطّي إلى خدمة العملاء — سارية المفعول.',
        ],

        'form' => [
            'page_title' => 'تأكيد طلب الانسحاب',
            'heading' => 'تأكيد الانسحاب من العقد',
            'legal_notice_title' => 'هذا إقرار مُلزِم قانونياً',
            'legal_effect' => 'بإرسالك هذا النموذج فإنك تمارس حقّك القانوني في الانسحاب من الطلب رقم ‎#:order_id. ويصبح الإقرار نافذاً قانونياً فور إرساله.',
            'order_summary' => 'الطلب',
            'order_total' => 'الإجمالي',
            'order_items' => 'العناصر',
            'placed_on' => 'تم في :date',
            'reason_label' => 'السبب',
            'reason_optional' => '(اختياري)',
            'reason_help' => 'لستَ مُلزَماً بذكر سبب. وأيّ نصّ تكتبه هنا سيُسجَّل في أدلة الانسحاب ويُرسَل إلى التاجر.',
            'reason_placeholder' => 'مثلاً: «غيّرتُ رأيي»، أو «المنتج لا يطابق الوصف»، أو اتركه فارغاً.',
            'submit' => 'إرسال طلب الانسحاب',
            'cancel' => 'إلغاء والعودة',
        ],

        'confirmation' => [
            'page_title' => 'إيصال الانسحاب',
            'heading' => 'تم استلام طلب الانسحاب',
            'heading_received' => 'تم استلام طلب الانسحاب',
            'heading_refunded' => 'تم إصدار المبلغ المستردّ',
            'heading_declined' => 'تم رفض طلب الانسحاب',
            'intro' => 'لقد سجّلنا إقرارك. وتُعدّ هذه الصفحة والبريد الإلكتروني الذي أرسلناه إليك للتو بمثابة تأكيد على وسيط دائم.',
            'intro_received' => 'لقد سجّلنا إقرارك. وتُعدّ هذه الصفحة والبريد الإلكتروني الذي أرسلناه إليك للتو بمثابة تأكيد على وسيط دائم.',
            'intro_refunded' => 'قام التاجر بمعالجة مبلغ الاسترداد. وسيصل المبلغ قريباً إلى وسيلة الدفع الأصلية.',
            'intro_declined' => 'اعترض التاجر على استحقاقك للاسترداد بموجب هذا الإقرار. راجع التفاصيل أدناه للاطلاع على السبب المُقدَّم وخياراتك المتبقية.',
            ...
            'status_refunded' => 'مُستردّ',
            'status_declined' => 'مرفوض',
            'print' => 'طباعة',
            'next_steps_title' => 'الخطوات التالية',
            'step_received' => 'تم استلام إقرارك وتسجيله.',
            'step_email' => 'تم إرسال بريد التأكيد إلى صندوق بريدك.',
            'step_refund' => 'يُصدَر الاسترداد خلال 14 يوماً.',
            'step_refund_done' => 'تم إصدار الاسترداد.',
            'step_declined' => 'تم رفض طلب الانسحاب من قِبَل التاجر.',
            'declined_reason_label' => 'السبب الذي قدّمه التاجر',
            'declined_notice' => 'تحتفظ بجميع وسائل الانتصاف القانونية الأخرى وفقاً لقوانين حماية المستهلك في الاتحاد الأوروبي. إذا كنت لا توافق على هذا القرار، يُرجى التواصل مع التاجر مباشرةً.',
            'refund_notice' => 'نُعيد المبلغ بنفس وسيلة الدفع التي استخدمتها في المعاملة الأصلية، ما لم تكن قد اتفقتَ معنا صراحةً على خلاف ذلك.',
            'email_sent' => 'تم إرسال بريد التأكيد.',
            'email_pending' => 'تعذّر علينا إرسال بريد التأكيد في الحال؛ سيقوم فريقنا بالمتابعة. يُرجى حفظ هذه الصفحة بوصفها إيصالك.',
            'durable_medium_notice' => 'هذه الصفحة هي إيصالك. يمكنك حفظها أو طباعتها.',
        ],

        'emails' => [
            'confirmation' => [
                'subject' => 'تأكيد طلب الانسحاب — الطلب :order_id',
                'title' => 'تم استلام طلب الانسحاب',
                'title_received' => 'تم استلام طلب الانسحاب',
                'title_refunded' => 'تم إصدار الاسترداد',
                'title_declined' => 'تم رفض طلب الانسحاب',
                'greeting' => 'مرحباً،',
                'intro' => 'لقد تلقّينا إقرارك بالانسحاب من العقد الخاص بالطلب رقم ‎#:order_id. وفيما يلي الطابع الزمني للاستلام النافذ قانونياً.',
                'intro_received' => 'لقد تلقّينا إقرارك بالانسحاب من العقد الخاص بالطلب رقم ‎#:order_id. وفيما يلي الطابع الزمني للاستلام النافذ قانونياً.',
                'intro_refunded' => 'تم إصدار مبلغ الاسترداد الخاص بالطلب رقم ‎#:order_id. وسيصل المبلغ قريباً إلى وسيلة الدفع الأصلية.',
                'intro_declined' => 'اعترض التاجر على استحقاقك للاسترداد عن الطلب رقم ‎#:order_id بموجب هذا الإقرار. والسبب المُقدَّم مذكور أدناه.',
                'summary' => 'ملخص الانسحاب',
                'received_at' => 'تاريخ الاستلام',
                'reference' => 'الرقم المرجعي',
                'order' => 'الطلب',
                'email' => 'البريد الإلكتروني',
                'reason' => 'السبب المُقدَّم',
                'declined_reason' => 'سبب الرفض',
                'refund_notice' => 'حيثما كان الاسترداد مستحقاً، فإننا نُعيد المبلغ بنفس وسيلة الدفع التي استخدمتها في المعاملة الأصلية، خلال 14 يوماً من التاريخ المذكور أعلاه، ما لم تكن قد اتفقتَ معنا صراحةً على خلاف ذلك.',
                'footer' => 'تُعدّ هذه الرسالة التأكيد على وسيط دائم المطلوب بموجب المادة 11أ من التوجيه 2011/83/EU (بصيغته المعدّلة بالتوجيه (EU) 2023/2673). يُرجى الاحتفاظ بها في سجلّاتك.',
            ],

            'guest_link' => [
                'subject' => 'رابط طلب الانسحاب',
                'title' => 'رابط طلب الانسحاب',
                'intro' => 'استخدم الرابط أدناه لتقديم طلب الانسحاب الخاص بالطلب رقم :order_id. الرابط صالح لمدة 24 ساعة.',
                'button' => 'فتح نموذج الانسحاب',
                'expiry' => 'تنتهي صلاحية الرابط خلال 24 ساعة. إذا لم تطلب هذا البريد، يمكنك تجاهله بأمان.',
            ],
        ],
    ],
];
