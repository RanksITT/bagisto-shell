...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Prawa autorskie 2010 - :current_year, Rancon LubMart. Wszelkie prawa zastrzeżone.',
        ...
        'account' => [
            ...
            'profile' => [
                'index' => [
                    'delete' => 'Usuń',
                    'delete-failed' => 'Wystąpił błąd podczas usuwania konta.',
                    'delete-profile' => 'Usuń konto',
                    'delete-success' => 'Konto zostało pomyślnie usunięte',
                    'dob' => 'Data urodzenia',
                    'edit' => 'Edytuj',
                    'edit-success' => 'Konto zostało pomyślnie zaktualizowane',
                    'email' => 'E-mail',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Prawa autorskie 2010 - :current_year, Rancon LubMart. Wszelkie prawa zastrzeżone.',
                'locale' => 'Lokalizacja',
        ...
        'carousel' => [
            ...
            'go-to-slide' => 'Przejdź do slajdu :number',
    ...
    'products' => [
        ...
        'view' => [
            'type' => [
                ...
                'booking' => [
                    ...
                    'event' => [
                        ...
                        'summary-title' => 'Twoja rezerwacja',
                        'ticket-line' => ':name (:count × :price)',
                        'base-fee-line' => 'Opłata podstawowa (:count × :price)',
                        'ticket' => 'bilet',
                        'tickets' => 'bilety',
                        'total' => 'Razem',
                        'select-tickets-hint' => 'Wybierz liczbę biletów, aby zobaczyć łączną kwotę.',
                        'starting-from' => 'Od',
                        'base-fee-note' => 'Zawiera opłatę podstawową + najtańszy bilet. Suma aktualizuje się zgodnie z wyborem biletów.',
                    ],
                    ...
                    'rental' => [
                        ...
                        'to' => 'Do',
                        'summary-title' => 'Twój wynajem',
                        'base-rental-fee' => 'Podstawowa opłata za wynajem',
                        'daily-rate-line' => 'Stawka dzienna (:count × :rate)',
                        'hourly-rate-line' => 'Stawka godzinowa (:count × :rate)',
                        'day' => 'dzień',
                        'days' => 'dni',
                        'hour' => 'godzina',
                        'hours' => 'godziny',
                        'total' => 'Razem',
                        'select-dates-hint' => 'Wybierz daty wynajmu, aby zobaczyć łączną kwotę.',
                        'starting-from' => 'Od',
                        'rental-fee-note' => 'Zawiera opłatę podstawową + minimalną stawkę wynajmu. Suma aktualizuje się zgodnie z wybranym czasem.',
                    ],
            ...
            'contact-us' => [
                ...
                'desc' => 'Treść wiadomości',
                'describe-here' => 'Wpisz treść wiadomości...',
                'email' => 'E-mail',
                'message' => 'Wiadomość',
                'name' => 'Imię',
        ...
        'booking' => [
            ...
            'cart' => [
                ...
                'integrity' => [
                    ...
                    'select_hourly_duration' => 'Wybierz czas trwania co najmniej jednej godziny.',
                ],
    ...
    'checkout' => [
        ...
        'coupon' => [
            'already-applied' => 'Kod rabatowy jest już zastosowany',
            'applied' => 'Kod rabatowy został zastosowany',
            'apply' => 'Zastosuj kod rabatowy',
            'apply-issue' => 'Kod rabatowy nie może być zastosowany',
            'button-title' => 'Zastosuj',
            'code' => 'Kod rabatowy',
            'discount' => 'Rabat z kodu rabatowego',
    ...
    'emails' => [
        ...
        'orders' => [
            ...
            'invoiced' => [
                'greeting' => 'Faktura nr :invoice_id do zamówienia :order_id została wystawiona w dniu :created_at.',
                'subject' => 'Nowa faktura do Twojego zamówienia',
                'summary' => 'Szczegóły dokumentu',
                'title' => 'Faktura do zamówienia',
            ],
            ...
            'shipping' => 'Wysyłka',
            'shipping-address' => 'Adres dostawy',
            'shipping-handling' => 'Koszt wysyłki',
            'shipping-handling-excl-tax' => 'Koszt wysyłki (bez podatku)',
            'shipping-handling-incl-tax' => 'Koszt wysyłki (z podatkiem)',
            'sku' => 'SKU',
            'subtotal' => 'Suma częściowa',
            'subtotal-excl-tax' => 'Suma częściowa (bez podatku)',
            'subtotal-incl-tax' => 'Suma częściowa (z podatkiem)',
