...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer' => '© Copyright 2010 - :current_year, Rancon LubMart (in Indien registriert). Alle Rechte vorbehalten.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text' => '© Copyright 2010 - :current_year, Rancon LubMart (eingetragen in Indien). Alle Rechte vorbehalten.',
                'locale' => 'Sprache',
