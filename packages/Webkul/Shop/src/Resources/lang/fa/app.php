...
return [
    'customers' => [
        ...
        'signup-form' => [
            ...
            'verify-failed' => 'ما نمی‌توانیم ایمیل شما را تأیید کنیم.',
        ],
        ...
        'account' => [
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'cancel-success' => 'سفارش شما لغو شد',
                    'contact' => 'تماس',
                    'item-invoiced' => 'مورد صورتحساب شده',
                    ...
                    'shipping-and-payment' => 'جزئیات حمل و نقل و پرداخت',
                    'status' => 'وضعیت',
                    'title' => 'مشاهده',
                    'total' => 'مجموع',
                    ...
                    'information' => [
                        ...
                        'total-refunded' => 'مجموع بازپرداخت شده',
                    ],
                    ...
                    'shipments' => [
                        'individual-shipment' => 'ارسال #:shipment_id',
                        'product-name' => 'نام',
                        'qty' => 'تعداد',
                        'shipments' => 'ارسال‌ها',
                        'sku' => 'کد SKU',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'profile' => 'پروفایل',
                        'search' => 'جستجو',
                        'search-text' => 'اینجا محصولات را جستجو کنید',
                        'sign-in' => 'ورود',
                        'sign-up' => 'ثبت‌نام',
                        'submit' => 'ارسال',
                        'welcome' => 'خوش آمدید',
                        'welcome-guest' => 'مهمان خوش آمدید',
            ...
            'webmcp' => [
                'add-to-wishlist' => 'یک محصول را با نام به فهرست علاقه‌مندی‌های مشتری اضافه کنید.',
                'add-to-wishlist-query' => 'نام محصول یا کلید URL برای افزودن به فهرست علاقه‌مندی‌ها.',
                'proceed-to-checkout' => 'صفحه تسویه‌حساب را باز کنید تا سفارش محصولات موجود در سبد خرید را آغاز کنید.',
                'search-products' => 'کاتالوگ فروشگاه را با کلمه کلیدی برای محصولات جستجو کنید و نتایج منطبق را باز کنید.',
                'search-products-query' => 'کلمات کلیدی یا نام محصول برای جستجو در کاتالوگ.',
                'subscribe-newsletter' => 'یک آدرس ایمیل را در خبرنامه فروشگاه مشترک کنید.',
                'subscribe-newsletter-email' => 'آدرس ایمیل برای اشتراک در خبرنامه.',
                'view-cart' => 'صفحه سبد خرید را باز کنید تا مشتری بتواند محصولات افزوده‌شده را بررسی کند.',
                'view-product' => 'صفحه جزئیات یک محصول را با نام محصول باز کنید.',
                'view-product-query' => 'نام محصول یا کلید URL برای باز کردن.',
                'view-wishlist' => 'صفحه فهرست علاقه‌مندی‌ها را برای بررسی محصولات ذخیره‌شده مشتری باز کنید.',
            ],
        ...
        'story' => [
            'figures' => [
                'grades' => 'درجات گرانروی',
                'products' => 'محصولات',
                'title' => 'آنچه عرضه می‌کنیم',
                'vehicles' => 'انواع خودرو',
            ],

            'protection' => [
                'kept' => 'محافظت‌شده',
                'text' => 'سطح یاتاقان بدون لایه روغن میان فلزها خط می‌افتد و حفره‌دار می‌شود. لایه را نگه دارید تا قطعه بماند.',
                'title' => 'سایش آنجاست که روغن نیست',
                'worn' => 'بدون محافظت',
            ],
            ...
            'viscosity' => [
                'cold' => 'سرد',
                'hot' => 'گرم',
                'text' => 'عدد نخست روانی در سرما و عدد دوم پایداری در گرماست. روغن چنددرجه‌ای هر دو را دارد.',
                'title' => 'درجه خود را بیابید',
            ],

            'engine' => [
                'eyebrow' => 'درون موتور',
                'step-gallery' => 'در مجاری بالا می‌رود',
                'step-ring' => 'جداره سیلندر را می‌پوشاند',
                'step-sump' => 'کارتر را پر می‌کند',
                'text' => 'روغن اصل شل به هر قطعه متحرک می‌رسد، از کارتر تا رینگ بالایی.',
                'title' => 'محافظت تا عمق',
            ],
        ],
        ...
        'carousel' => [
            ...
            'go-to-slide' => 'رفتن به اسلاید :number',
    ...
    'categories' => [
        ...
        'view' => [
            'empty' => 'در این دسته بندی محصولی موجود نمی‌باشد',
            'load-more' => 'بارگذاری بیشتر',
        ],
    ],
    ...
    'compare' => [
        'already-added' => 'مورد در حال حاضر در لیست مقایسه قرار دارد',
        'delete-all' => 'حذف همه',
        'empty-text' => 'شما موردی در لیست مقایسه ندارید',
        'item-add-success' => 'مورد با موفقیت به لیست مقایسه افزوده شد',
        'product-compare' => 'مقایسه محصولات',
        'remove-all-success' => 'تمام موارد با موفقیت حذف شدند.',
        'remove-error' => 'مشکلی پیش آمده است، لطفاً بعداً دوباره تلاش کنید.',
        'remove-success' => 'مورد با موفقیت حذف شد.',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'qty-missing' => 'حداقل یک محصول باید بیشتر از ۱ تعداد داشته باشد.',
            ...
            'index' => [
                ...
                'move-to-wishlist-success' => 'موارد انتخاب شده با موفقیت به لیست علاقه‌مندی منتقل شدند.',
                'price' => 'قیمت',
                'product-name' => 'نام محصول',
                'quantity' => 'تعداد',
        ...
        'onepage' => [
            'address' => [
                ...
                'check-shipping-address' => 'آدرس حمل و نقل از دست رفته است.',
                'city' => 'شهر',
                'company-name' => 'نام شرکت',
                'confirm' => 'تایید',
                'country' => 'کشور',
    ...
    'emails' => [
        ...
        'customers' => [
            'registration' => [
                'credentials-description' => 'حساب شما ایجاد شده است. جزئیات حساب شما در زیر آمده است:',
    ...
    'rma' => [
        ...
        'response' => [
            ...
            'invalid-order' => 'سفارش انتخاب‌شده نامعتبر است.',
    ...
    'eu_withdrawal' => [
        'button' => [
            'withdraw' => 'انصراف از قرارداد',
            'view_existing' => 'مشاهده درخواست انصراف شما',
        ],

        'guest_dropdown' => [
            'link' => 'انصراف از یک قرارداد',
        ],

        'lookup' => [
            'page_title' => 'انصراف از یک قرارداد',
            'heading' => 'انصراف از قرارداد خود',
            'intro' => 'شماره سفارش و آدرس ایمیلی را که هنگام پرداخت استفاده کردید وارد کنید. ما لینکی برای ثبت درخواست انصراف برای شما ارسال خواهیم کرد.',
            'order_number' => 'شماره سفارش',
            'email' => 'آدرس ایمیل',
            'submit' => 'لینک انصراف را برایم بفرست',
            'sent_notice' => 'در صورتی که سفارشی مطابق وجود داشته باشد، هم‌اکنون لینک انصراف را به آن آدرس ایمیل کردیم. این لینک به مدت ۲۴ ساعت معتبر است.',
            'legal_note' => 'بر اساس دستورالعمل اتحادیه اروپا 2011/83/EU (با اصلاحات بعدی)، شما حق قانونی دارید ظرف ۱۴ روز از قرارداد خود انصراف دهید. سایر روش‌های انصراف — از جمله اظهاریه کتبی ارسال‌شده به خدمات مشتریان ما — همچنان معتبر باقی می‌مانند.',
        ],

        'form' => [
            'page_title' => 'تأیید درخواست انصراف',
            'heading' => 'تأیید انصراف از قرارداد',
            'legal_notice_title' => 'این یک اعلامیه دارای الزام قانونی است',
            'legal_effect' => 'با ارسال این فرم، حق قانونی انصراف خود را برای سفارش #:order_id اعمال می‌کنید. این اعلامیه از لحظه ارسال از نظر قانونی نافذ می‌شود.',
            'order_summary' => 'سفارش',
            'order_total' => 'مجموع',
            'order_items' => 'اقلام',
            'placed_on' => 'ثبت‌شده در :date',
            'reason_label' => 'دلیل',
            'reason_optional' => '(اختیاری)',
            'reason_help' => 'الزامی به ارائه دلیل نیست. هر آنچه اینجا بنویسید در مدارک انصراف ثبت و برای فروشنده ارسال می‌شود.',
            'reason_placeholder' => 'برای مثال: «نظرم عوض شد»، «کالا مطابق توضیحات نبود»، یا خالی بگذارید.',
            'submit' => 'ثبت درخواست انصراف',
            'cancel' => 'انصراف و بازگشت',
        ],

        'confirmation' => [
            'page_title' => 'رسید انصراف',
            'heading' => 'درخواست انصراف شما دریافت شد',
            'heading_received' => 'درخواست انصراف شما دریافت شد',
            'heading_refunded' => 'بازپرداخت شما صادر شد',
            'heading_declined' => 'درخواست انصراف شما رد شد',
            'intro' => 'اعلامیه شما را ثبت کردیم. این صفحه و ایمیلی که هم‌اکنون برای شما ارسال شد، هر دو به‌عنوان تأییدیه بر یک رسانه ماندگار به‌حساب می‌آیند.',
            'intro_received' => 'اعلامیه شما را ثبت کردیم. این صفحه و ایمیلی که هم‌اکنون برای شما ارسال شد، هر دو به‌عنوان تأییدیه بر یک رسانه ماندگار به‌حساب می‌آیند.',
            'intro_refunded' => 'فروشنده بازپرداخت شما را پردازش کرده است. مبلغ به‌زودی از طریق همان روش پرداخت اولیه به شما بازگردانده می‌شود.',
            'intro_declined' => 'فروشنده استحقاق شما برای بازپرداخت در چارچوب این اعلامیه را به چالش کشیده است. برای اطلاع از دلیل ارائه‌شده و گزینه‌های باقی‌مانده، جزئیات زیر را مشاهده کنید.',
            ...
            'step_received' => 'اعلامیه شما دریافت و ثبت شد.',
            'step_email' => 'ایمیل تأییدیه به صندوق ورودی شما ارسال شد.',
            'step_refund' => 'بازپرداخت ظرف ۱۴ روز صادر می‌شود.',
            'step_refund_done' => 'بازپرداخت صادر شده است.',
            'step_declined' => 'درخواست انصراف توسط فروشنده رد شد.',
            'declined_reason_label' => 'دلیلی که فروشنده ارائه داده است',
            'declined_notice' => 'تمامی سایر راه‌های جبران قانونی بر اساس قوانین حمایت از مصرف‌کننده اتحادیه اروپا برای شما محفوظ است. اگر با این تصمیم موافق نیستید، مستقیماً با فروشنده تماس بگیرید.',
            'refund_notice' => 'بازپرداخت با همان روش پرداختی که در معامله اولیه استفاده کرده‌اید انجام می‌شود، مگر آن‌که صراحتاً به‌گونه دیگری توافق کرده باشید.',
            'email_sent' => 'ایمیل تأییدیه ارسال شد.',
            'email_pending' => 'موفق به ارسال فوری ایمیل تأییدیه نشدیم؛ تیم ما پیگیری خواهد کرد. لطفاً این صفحه را به‌عنوان رسید خود ذخیره کنید.',
            'durable_medium_notice' => 'این صفحه رسید شماست. می‌توانید آن را ذخیره یا چاپ کنید.',
        ],

        'emails' => [
            'confirmation' => [
                'subject' => 'تأیید درخواست انصراف شما — سفارش :order_id',
                'title' => 'درخواست انصراف دریافت شد',
                'title_received' => 'درخواست انصراف دریافت شد',
                'title_refunded' => 'بازپرداخت صادر شد',
                'title_declined' => 'درخواست انصراف رد شد',
                'greeting' => 'سلام،',
                'intro' => 'اعلامیه انصراف شما از قرارداد مربوط به سفارش #:order_id را دریافت کردیم. زمان دقیق دریافت که از نظر قانونی نافذ است، در زیر ثبت شده است.',
                'intro_received' => 'اعلامیه انصراف شما از قرارداد مربوط به سفارش #:order_id را دریافت کردیم. زمان دقیق دریافت که از نظر قانونی نافذ است، در زیر ثبت شده است.',
                'intro_refunded' => 'بازپرداخت شما برای سفارش #:order_id صادر شده است. مبلغ به‌زودی از طریق همان روش پرداخت اولیه به شما بازگردانده می‌شود.',
                'intro_declined' => 'فروشنده استحقاق شما برای بازپرداخت در سفارش #:order_id را بر اساس این اعلامیه به چالش کشیده است. دلیل ارائه‌شده در زیر آمده است.',
                'summary' => 'خلاصه درخواست انصراف',
                'received_at' => 'زمان دریافت',
                'reference' => 'شناسه مرجع',
                'order' => 'سفارش',
                'email' => 'ایمیل',
                'reason' => 'دلیل ارائه‌شده',
                'declined_reason' => 'دلیل رد',
                'refund_notice' => 'در مواردی که بازپرداخت لازم باشد، با همان روش پرداختی که در معامله اولیه استفاده کرده‌اید و ظرف ۱۴ روز از تاریخ فوق آن را بازمی‌گردانیم، مگر آن‌که صراحتاً به‌گونه دیگری توافق کرده باشید.',
                'footer' => 'این پیام همان تأییدیه بر رسانه ماندگار است که بر اساس ماده 11a از دستورالعمل 2011/83/EU (با اصلاحات دستورالعمل (EU) 2023/2673) الزامی است. لطفاً آن را برای سوابق خود نگه دارید.',
            ],

            'guest_link' => [
                'subject' => 'لینک درخواست انصراف شما',
                'title' => 'لینک درخواست انصراف شما',
                'intro' => 'از لینک زیر برای ثبت درخواست انصراف خود برای سفارش :order_id استفاده کنید. این لینک به مدت ۲۴ ساعت معتبر است.',
                'button' => 'بازکردن فرم انصراف',
                'expiry' => 'این لینک پس از ۲۴ ساعت منقضی می‌شود. اگر این ایمیل را درخواست نکرده‌اید، می‌توانید با خیال راحت آن را نادیده بگیرید.',
            ],
        ],
    ],
];
