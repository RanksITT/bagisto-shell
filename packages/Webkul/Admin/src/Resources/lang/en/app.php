...
return [
        ...
        'rma' => [
            'all-rma' => [
                ...
                'view' => [
                    ...
                    'confirm-item-canceled' => 'This will cancel the item on the order. Do you want to proceed?',
                    'confirm-item-refund' => 'This will refund the amount to the customer and close the RMA. Do you want to proceed?',
            ...
            'reasons' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'enabled' => 'Active',
                        'id' => 'ID',
                        'mass-delete-partial' => 'Deleted :deleted of the selected records; :skipped had already been removed.',
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    ...
                    'action-type-info-buy-x-get-y' => 'When the customer buys X items, additional Y items are free.',
                    'action-type-info-by-fixed' => 'Apply a fixed amount off each matching item.',
                    'action-type-info-by-percent' => 'Apply a percentage discount to matching items.',
                    'action-type-info-cart-fixed' => 'Apply a fixed amount off the entire cart.',
                    'actions' => 'Actions',
                    ...
                    'apply-to-shipping-disabled-info' => 'Only applies to Percentage and Fixed Amount discounts.',
                    'attribute-family' => 'Attribute Family',
                    ...
                    'auto-generate-info' => 'Coupon codes can be generated from the rule edit page after saving.',
                    'back-btn' => 'Back',
                    ...
                    'maximum-discounted-quantity' => 'Maximum Discounted Quantity',
                    'maximum-discounted-quantity-info' => 'Caps how many units of each matching item receive the discount.',
                    'maximum-eligible-quantity-info' => 'Caps how many units of this item participate in the Buy X Get Y deal.',
                    'maximum-eligible-quantity' => 'Maximum Eligible Quantity',
                    'name' => 'Name',
                    'no' => 'No',
                    'no-coupon' => 'No Coupon',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name (Parent Only)',
                    'auto-generate-coupon' => 'Auto Generate Coupon',
                    'auto-generate-banner-description' => 'Bulk-create unique coupon codes for this rule.',
                    'auto-generate-banner-title' => 'Auto-generation enabled',
                    'back-btn' => 'Back',
                    'buy-x-get-y-free' => 'Buy X Get Y Free',
                    'buy-x-quantity' => 'Buy X Quantity',
                    'cart-attribute' => 'Cart attribute',
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'import-confirmation' => 'The import will start as soon as this is saved. Do you want to continue?',
                ...
                'import' => [
                    ...
                    'deleting-info' => 'Deletion In Process',
                    'download-error-report' => 'Download Full Report',
                    'downloading-info' => 'Downloading Images',
                    'edit-btn' => 'Edit',
                    'failed-batches' => ':count batches did not complete. Check the error log and run the import again for those rows.',
                    'images-downloaded' => 'Images Downloaded:',
                    'images-progress' => 'images downloaded',
                    ...
                    'validation-partial-info' => 'Your import can proceed, but some rows will be skipped. Review the errors below or download the full report.',
                    'validation-success-info' => 'Your import is valid. Click on Import to start the import process.',
                ],

                'images' => [
                    'current-archive' => 'Currently uploaded: :name — :count image(s) ready.',
                    'current-images' => ':count image(s) are already uploaded for this import.',
                    'directory-example' => 'For example, in case product-images, files should be placed into /project-root/storage/app/import/product-images folder.',
                    'directory-hint' => 'Use relative path to /project-root/storage/app/import, e.g. product-images, import-images.',
                    'directory-info' => 'If you have code-base access, place the images in a folder on the server and name that folder below.',
                    'directory-placeholder' => 'Images Directory Path',
                    'directory-title' => 'Images already on the server',
                    'download-sample-zip' => 'Download sample images',
                    'info' => 'Choose where the images named in your file should be found.',
                    'recommended' => 'Recommended',
                    'replace-archive' => 'Choosing a new archive replaces them.',
                    'title' => 'Product Images',
                    'upload-info' => 'Upload a single archive containing every image. The images column then names the files inside it.',
                    'upload-title' => 'Upload a ZIP of images',
                    'url-info' => 'Put the full https:// address of each image in the images column. They are downloaded before the import runs, so nothing has to be placed on the server first.',
                    'url-title' => 'Image links in the file',
                ],
                ...
                'processing-failed' => 'The import could not be processed. Please check the file and try again.',
        ...
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    ...
                    'brevo-api-key-info' => 'Create a v3 API key in your Brevo account under SMTP & API.',
                    'driver' => 'Driver',
                    'driver-brevo-api' => 'Brevo (API)',
                    'driver-info' => 'Choose how your store sends email.',
                    ...
                    'driver-notice' => 'Driver Notice',
                    'driver-smtp' => 'SMTP',
                    'encryption' => 'Encryption',
                    'host' => 'Host',
                    'info' => 'Choose how your store sends email and configure the selected driver.',
                    'password' => 'Password',
                    'port' => 'Port',
                    'title' => 'Mail Driver',
                    'username' => 'Username',
            ...
            'sales' => [
                ...
                'rma' => [
                    ...
                    'allowed-request-cancelled-request' => 'Allow Reopening Cancelled Returns',
                    'allowed-request-declined-request' => 'Allow Reopening Declined Returns',
                    'allowed-rma-for-product' => 'Allowed Rma For Product',
                    'cancel-items' => 'Cancel-items',
                    'cancelled-request-info' => 'When enabled, a customer can resubmit a return that was cancelled; it moves back to "Pending Review" for a fresh look. When disabled, a cancelled return is final and cannot be reopened.',
                    'complete' => 'Complete',
                    ...
                    'declined-request-info' => 'When enabled, a customer can resubmit a return that the admin declined; it moves back to "Pending Review" for a fresh look. When disabled, a declined return is final and cannot be reopened.',
                    ...
                    'product-type-info' => 'Only the selected product types are eligible for RMA. The return window is locked in when the order is placed, so changes here apply to future orders only.',
                    'resolution-type' => 'Resolution Type',
                    'return' => 'Return/Refund',
                    'return-pickup-address' => 'Return Pickup Address',
                    'return-pickup-time' => 'Return Pickup Time',
                    'return-policy' => 'Return Policy',
                    'return-policy-info' => 'The return policy shown to customers on the storefront before they submit a return request.',
                    'specific-products' => 'Specific Products',
                    'title' => 'RMA',
                    'yes' => 'Yes',

                    'setting' => [
                        'info' => 'Set how returns (RMA) work in your store: the return window, allowed attachment file types, eligible product types, the return policy shown to customers, and whether cancelled or declined returns can be reopened.',
                        'read' => 'Read Policy',
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'timeline_received_desc' => 'The customer submitted a withdrawal-from-contract request.',
            'timeline_email' => 'Confirmation email',
            'timeline_email_pending' => 'Not yet sent',
            'timeline_initial_email' => 'Initial Confirmation Email',
            'timeline_initial_email_desc_sent' => 'Confirmation email delivered to the customer.',
            'timeline_initial_email_desc_error' => 'Initial confirmation email failed to send.',
            'timeline_initial_email_desc_pending' => 'Initial confirmation email has not been sent yet.',
            'timeline_final_email' => 'Final Confirmation Email',
            'timeline_final_email_pending' => 'Not yet sent',
            'timeline_final_email_desc_sent' => 'Outcome email delivered to the customer.',
            'timeline_final_email_desc_pending' => 'Final confirmation email has not been sent yet.',
            'timeline_declined' => 'Withdrawal Declined',
            'timeline_declined_desc' => 'Withdrawal declined by :name.',
            'timeline_declined_desc_system' => 'Withdrawal declined.',
            'timeline_declined_reason_label' => 'Reason given:',
            'timeline_refunded' => 'Refund Issued',
            'timeline_refunded_desc' => 'Refund issued by :name.',
            'timeline_refunded_desc_system' => 'Refund issued.',
            'timeline_refunded_note_label' => 'Admin note:',
            'timeline_resolution' => 'Resolution Pending',
            'timeline_resolution_desc' => 'Awaiting admin review and decision.',
