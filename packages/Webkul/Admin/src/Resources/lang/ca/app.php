...
return [
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Tot el que necessites per treure el màxim profit de Bagisto: allotjament, suport i serveis professionals, a més d\'extensions i documentació per a desenvolupadors.',

            'services-title' => 'Serveis',
            'resources-title' => 'Recursos i documentació',

            'cloud-hosting' => 'Allotjament al núvol',
            'cloud-hosting-info' => 'Allotjament al núvol gestionat i rendible: posa en marxa la teva botiga Bagisto al núvol en minuts, totalment optimitzada i escalable.',

            'support' => 'Suport i manteniment',
            'support-info' => 'Suport tècnic dedicat i plans de manteniment continu per mantenir la teva botiga segura, actualitzada i funcionant sense problemes.',

            'paid-services' => 'Serveis de pagament',
            'paid-services-info' => 'Ajuda experta per a la integració de mòduls, personalització, migració de dades, actualitzacions de versió i desenvolupament a mida.',

            'extensions' => 'Extensions',
            'extensions-info' => 'Explora complements oficials i de la comunitat per ampliar Bagisto amb nous connectors, canals i funcionalitats.',

            'docs' => 'Documentació i blogs per a desenvolupadors',
            'docs-info' => 'Guies per a desenvolupadors, tutorials i els articles més recents per ajudar-te a construir, configurar i mantenir-te al dia.',

            'api-docs' => 'Documentació de l\'API',
            'api-docs-info' => 'Referència completa de l\'API REST i GraphQL amb punts d\'accés, autenticació i exemples per integrar Bagisto amb el teu sistema.',

            'community' => 'Fòrum de la comunitat',
            'community-info' => 'Fes preguntes, comparteix idees i connecta amb milers de desenvolupadors i comerciants de Bagisto de tot el món.',

            'video-tutorials' => 'Videotutorials',
            'video-tutorials-info' => 'Guies en vídeo pas a pas que cobreixen la instal·lació, la configuració i la gestió diària de la botiga.',

            'cta-title' => 'Encara necessites ajuda?',
            'cta-description' => 'Parla amb l\'equip de Bagisto sobre allotjament, desenvolupament personalitzat o qualsevol altra cosa.',
            'cta-btn' => 'Contacta amb nosaltres',
        ],
    ],
        ...
        'rma' => [
            'all-rma' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'order-date' => 'Data de la comanda',
                        'order-id' => 'ID de la comanda',
                        'order-ref' => 'Referència de la comanda',
                        'order-status' => 'Estat de lliurament',
                        'return-window' => 'Període de devolució',
                        'rma-status' => 'Estat de la sol·licitud',
                        'status' => 'Estat',
                        'total' => 'Total',
                        'undelivered' => 'No lliurat',
                        'view' => 'Veure',
                    ],
                ],
                ...
                'view' => [
                    ...
                    'attachment' => 'Adjunt',
                    'by' => 'Per',
                    'change-status' => 'Canviar estat de la sol·licitud',
                    'close-rma' => 'La RMA està tancada',
                    'confirm-item-canceled' => 'L\'estat d\'article cancel·lat cancel·larà l\'article. Vols continuar?',
                    'confirm-item-refund' => 'L\'estat de paquet rebut reemborsarà l\'import al client. Vols continuar?',
                    ...
                    'conversation-process' => 'La teva sol·licitud RMA ha estat processada.',
                    'conversations' => 'Converses',
                    'customer' => 'Client:',
                    'customer-details' => 'Detalls del client',
                    'customer-email' => 'Correu electrònic del client:',
                    'declined-admin' => 'Sol·licitud rebutjada per l\'administrador',
                    ...
                    'on' => 'El',
                    'order-date' => 'Data de la comanda:',
                    'order-details' => 'Article(s) sol·licitats per a RMA',
                    'order-id' => 'ID de la comanda:',
                    'order-status' => 'Estat de lliurament:',
                    ...
                    'solved' => 'Resolt',
                    'solved-by-admin' => 'Resol per l\'administrador',
                    'status' => 'Estat',
                    'status-message' => 'L\'estat de la teva RMA ID #:id ha canviat. Estat: :status',
            ...
            'reasons' => [
                'index' => [
                    ...
                    'datagrid' => [
                        'created-at' => 'Creat el',
                        'delete' => 'Suprimeix',
                        'delete-success' => 'El motiu s\'ha suprimit correctament.',
                        'disabled' => 'Inactiu',
                        'edit' => 'Edita',
                        'enabled' => 'Actiu',
                        'id' => 'ID',
                        'mass-delete-partial' => 'S\'han eliminat :deleted dels registres seleccionats; :skipped ja s\'havien suprimit.',
                        'mass-delete-success' => 'Les dades seleccionades s\'han suprimit correctament.',
                        'reason-error' => 'El motiu s\'utilitza en un RMA.',
                        'reason' => 'Motiu',
                        'status' => 'Estat',
                        'update' => 'Actualitza',
                    ],
            ...
            'custom-field' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'created-at' => 'Creat el',
                        'delete' => 'Suprimeix',
                        'delete-success' => 'Els camps personalitzats s\'han suprimit correctament.',
                        'disabled' => 'Inactiu',
                        'edit' => 'Edita',
                        'enabled' => 'Actiu',
                        'id' => 'ID',
            ...
            'rules' => [
                'index' => [
                    ...
                    'datagrid' => [
                        'delete' => 'Eliminar',
                        'delete-success' => 'Les regles RMA s’han eliminat correctament.',
                        'disabled' => 'Inactiu',
                        'edit' => 'Editar',
                        'enabled' => 'Actiu',
                        ...
                        'id' => 'ID',
                        'mass-delete-partial' => 'S\'han eliminat :deleted dels registres seleccionats; :skipped ja s\'havien suprimit.',
                        'mass-delete-success' => 'Les dades seleccionades s’han eliminat correctament.',
                        'name' => 'Nom',
                        'reason' => 'Regles',
            ...
            'create-rma' => [
                'conversation-process' => 'La teva sol·licitud RMA ha estat processada.',
                'create-success' => 'RMA creat correctament.',
                'create-title' => 'Crear RMA',
                'email' => 'Correu electrònic',
                'failed' => 'No s’ha pogut crear el RMA.',
                'image' => 'Imatge',
                'invalid-order-id' => 'ID de comanda no vàlid',
                'mismatch' => 'L’ID de comanda i el correu no coincideixen',
                'new-rma' => 'Nou RMA',
                'order-id' => 'ID de comanda',
                'quantity' => 'Quantitat',
                'reason' => 'Motiu',
                'rma-already-exist' => 'El RMA ja existeix',
                'rma-not-available-quotes' => 'L’article no està disponible per a RMA',
                'save-btn' => 'Desar',
                'search' => '--Selecciona--',
                'validate' => 'Validar',
            ],
        ...
        'products' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'sku' => 'SKU',
                    'sku-value' => 'SKU - :sku',
                    'stock-disabled' => 'Estoc desactivat',
                    'status' => 'Estat',
                    'type' => 'Tipus',
                    'update-status' => 'Actualitzar estat',
                ],
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    ...
                    'action-type-info-buy-x-get-y' => 'Quan el client compra X articles, obté Y articles addicionals gratis.',
                    'action-type-info-by-fixed' => 'Aplica una quantitat fixa de descompte a cada article coincident.',
                    'action-type-info-by-percent' => 'Aplica un descompte percentual als articles coincidents.',
                    'action-type-info-cart-fixed' => 'Aplica una quantitat fixa de descompte a tot el carret.',
                    'actions' => 'Accions',
                    ...
                    'apply-to-shipping-disabled-info' => 'Només s’aplica a descomptes percentuals i d’import fix.',
                    'attribute-family' => 'Família d\'Atributs',
                    ...
                    'auto-generate-info' => 'Els codis de cupó es poden generar des de la pàgina d\'edició de la regla després de desar-la.',
                    'back-btn' => 'Tornar',
                    ...
                    'description' => 'Descripció',
                    'discount-amount' => 'Quantitat de Descompte',
                    'discount-percent' => 'Percentatge de descompte (%)',
                    ...
                    'free-quantity' => 'Quantitat gratuïta (Y)',
                    'from' => 'Des de',
                    'general' => 'General',
                    ...
                    'maximum-discounted-quantity' => 'Quantitat Màxima amb Descompte',
                    'maximum-discounted-quantity-info' => 'Limita quantes unitats de cada article coincident reben el descompte.',
                    'maximum-eligible-quantity-info' => 'Limita quantes unitats d\'aquest article participen en l\'oferta Compra X Obté Y.',
                    'maximum-eligible-quantity' => 'Quantitat Màxima Elegible',
                    'name' => 'Nom',
                    'no' => 'No',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name (Només Pares)',
                    'auto-generate-coupon' => 'Generació Automàtica de Cupó',
                    'auto-generate-banner-description' => 'Crea codis de cupó únics en bloc per a aquesta regla.',
                    'auto-generate-banner-title' => 'Generació automàtica activada',
                    'back-btn' => 'Tornar',
                    'buy-x-get-y-free' => 'Comprar X i Obtenir Y Gratis',
                    'buy-x-quantity' => 'Comprar X Quantitat',
                    ...
                    'general' => 'General',
                    'generate' => 'Generar',
                    'generate-coupons' => 'Generar Cupons',
                    'generate-here' => 'Genera ara',
                    'generated-coupons' => 'Cupons Generats',
                    'greater-than' => 'Major Que',
                    'is-equal-to' => 'És Igual a',
                    'is-not-equal-to' => 'No És Igual a',
                    'less-than' => 'Menor Que',
    ...
    'appearance' => [
        'themes' => [
            'index' => [
                'activate-btn' => 'Activa',
                'activate-success' => ':theme ja està actiu a :channel.',
                'active' => 'Actiu',
                'active-on' => 'Actiu a:',
                'active-on-all' => 'Actiu a tots els canals',
                'buy-btn' => 'Veure i comprar',
                'buy-themes' => 'Comprar temes',
                'by' => 'per',
                'customize-btn' => 'Personalitza',
                'info' => 'Explora els temes disponibles per a la teva botiga i tria quin utilitza cada canal.',
                'my-themes' => 'Els meus temes',
                'not-in-use' => 'No s\'utilitza',
                'not-installed' => 'Aquest tema no està instal·lat en aquesta botiga.',
                'preview-btn' => 'Vista prèvia',
                'title' => 'Temes',

                'activate' => [
                    'channels' => 'Canals',
                    'channels-hint' => 'Mantén premuda la tecla Ctrl (Cmd al Mac) per triar més d\'un canal.',
                    'confirm-btn' => 'Activa',
                    'info' => 'Tria els canals que han de començar a utilitzar :theme.',
                    'title' => 'Activa el tema',
                    'warning' => ':channel té :count personalitzacions creades per a :theme. Es conserven, però no apareixeran mentre el tema nou estigui actiu.',
                ],
            ],
        ],
        'sections' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'story-chapter' => 'Capítol de la història',
                    'title' => 'Tipus',
                ],
            ],
            ...
            'edit' => [
                ...
                'asc' => 'Asc',
                'back' => 'Enrere',
                'brand-add-btn' => 'Afegeix una marca',
                'brand-logo' => 'Logotip de la marca',
                'brand-name' => 'Nom de la marca',
                'brands' => 'Marques',
                'chapter' => 'Capítol',
                'chapter-engine' => 'Motor',
                'chapter-figures' => 'Xifres',
                'chapter-protection' => 'Protecció',
                'chapter-viscosity' => 'Viscositat',
                'category-carousel' => 'Carrousel de Categoria',
            ...
            'create-success' => 'La secció s\'ha creat correctament',
            'delete-success' => 'La secció s\'ha suprimit correctament',
            'update-success' => 'La secció s\'ha actualitzat correctament',
        ],
    ],
    ...
    'reporting' => [
        'sales' => [
            'index' => [
                ...
                'sales-by-coupon' => 'Vendes per Cupó',
    ...
    'settings' => [
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'import-confirmation' => 'La importació començarà tan bon punt es desi. Voleu continuar?',
                ...
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'view-progress' => 'Mostra el progrés',
                    ],
                ],
                ...
                'import' => [
                    ...
                    'deleting-info' => 'Eliminació en curs',
                    'download-error-report' => 'Descarregar Informe Complet',
                    'downloading-info' => 'Baixant imatges',
                    'edit-btn' => 'Editar',
                    'failed-batches' => ':count lots no s\'han completat. Reviseu el registre d\'errors i torneu a executar la importació per a aquestes files.',
                    'images-downloaded' => 'Imatges baixades:',
                    'images-progress' => 'imatges baixades',
                    ...
                    'progress' => 'Progrés:',
                    'rows-validated' => 'files validades',
                    'step-create' => 'Crear',
                    'step-delete' => 'Eliminar',
                    'step-download' => 'Imatges',
                    'step-index' => 'Indexar',
                    'step-link' => 'Enllaçar',
                    ...
                    'validation-partial-info' => 'La importació pot continuar, però algunes files s\'ometran. Reviseu els errors següents o descarregueu l\'informe complet.',
                    'validation-success-info' => 'La teva importació és vàlida. Feu clic a Importar per iniciar el procés d\'importació',
                ],

                'images' => [
                    'current-archive' => 'Pujat actualment: :name — :count imatge/s a punt.',
                    'current-images' => 'Ja hi ha :count imatge/s pujada/es per a aquesta importació.',
                    'directory-example' => 'Per exemple, en el cas de product-images, els fitxers s\'han de posar a la carpeta /project-root/storage/app/import/product-images.',
                    'directory-hint' => 'Feu servir el camí relatiu a /project-root/storage/app/import, p. ex. product-images, import-images.',
                    'directory-info' => 'Si teniu accés al codi, poseu les imatges en una carpeta del servidor i indiqueu aquesta carpeta a continuació.',
                    'directory-placeholder' => 'Camí del directori d\'imatges',
                    'directory-title' => 'Imatges ja al servidor',
                    'download-sample-zip' => 'Baixa imatges d\'exemple',
                    'info' => 'Trieu on s\'han de trobar les imatges indicades al vostre fitxer.',
                    'recommended' => 'Recomanat',
                    'replace-archive' => 'Escollir un arxiu nou les substitueix.',
                    'title' => 'Imatges de producte',
                    'upload-info' => 'Pugeu un únic arxiu amb totes les imatges. La columna «images» anomena llavors els fitxers que conté.',
                    'upload-title' => 'Puja un ZIP d\'imatges',
                    'url-info' => 'Poseu l\'adreça https:// completa de cada imatge a la columna «images». Es baixen abans de la importació, sense haver de deixar res al servidor.',
                    'url-title' => 'Enllaços d\'imatge al fitxer',
                ],
                ...
                'processing-failed' => 'No s\'ha pogut processar la importació. Comproveu el fitxer i torneu-ho a provar.',
        ...
        'roles' => [
            ...
            'create' => [
                ...
                'save-btn' => 'Desar Rol',
                'search-permissions' => 'Cerca permisos',
                'title' => 'Crear Rol',
            ],
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api-key' => 'Clau API',
                    'api-publishable-key' => 'Clau publicable de l’API',
                    'api-test-key' => 'Clau secreta de prova de l’API',
                    'api-test-publishable-key' => 'Clau publicable de prova de l’API',
                    'applicable-production' => 'S’aplica només al mode de producció',
                    'applicable-sandbox' => 'S’aplica només al mode de prova',
                    ...
                    'merchant-key' => 'Clau de comerciant',
                    'merchant-name' => 'Nom del comerciant',
                    'merchant-private-key' => 'Clau privada del comerciant',
                    ...
                    'paid' => 'Pagat',
                    'payglocal' => 'PayGlocal',
                    'payglocal-info' => 'Accepta pagaments transfronterers mitjançant PayGlocal. <a href="https://dashboard.payglocal.in/app/mca/h8271x" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline hover:text-blue-700">Registra\'t aquí per obtenir les teves credencials.</a>',
                    'payglocal-merchant-id-info' => 'Disponible al tauler de PayGlocal a My Account.',
                    'payglocal-private-key-id-info' => 'ID de la teva clau privada, que es mostra al tauler de PayGlocal.',
                    'payglocal-public-key' => 'Clau pública de PayGlocal',
                    'payglocal-public-key-id-info' => 'ID de la clau pública de PayGlocal, que es mostra al tauler de PayGlocal.',
                    ...
                    'pending-payment' => 'Pagament pendent',
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => 'Configureu la configuració del mètode de pagament PhonePe.',
                    'phonepe-client-id-info' => 'Introduïu l\'ID de client de PhonePe obtingut del tauler de PhonePe',
                    'phonepe-client-secret-info' => 'Introduïu el secret de client de PhonePe obtingut del tauler de PhonePe',
                    'phonepe-merchant-info' => 'Introduïu l\'ID de comerciant de PhonePe obtingut del tauler de PhonePe',
                    'private-key-id' => 'ID de la clau privada',
                    'processing' => 'Processant',
                ...
                'rma' => [
                    ...
                    'allowed-request-cancelled-request' => 'Permet reobrir devolucions cancel·lades',
                    'allowed-request-declined-request' => 'Permet reobrir devolucions rebutjades',
                    'allowed-rma-for-product' => 'Permetre RMA per producte',
                    'cancel-items' => 'Cancel·lar articles',
                    'cancelled-request-info' => 'Quan està activat, un client pot tornar a enviar una devolució que s\'ha cancel·lat; torna a l\'estat "Pendent de revisió" per a una nova revisió. Quan està desactivat, una devolució cancel·lada és definitiva i no es pot reobrir.',
                    'complete' => 'Completat',
                    ...
                    'declined-request-info' => 'Quan està activat, un client pot tornar a enviar una devolució que l\'administrador ha rebutjat; torna a l\'estat "Pendent de revisió" per a una nova revisió. Quan està desactivat, una devolució rebutjada és definitiva i no es pot reobrir.',
                    ...
                    'product-type-info' => 'Només els tipus de producte seleccionats són elegibles per a RMA. El termini de devolució es fixa quan es fa la comanda, de manera que els canvis aquí només s\'apliquen a les comandes futures.',
                    'resolution-type' => 'Tipus de resolució',
                    ...
                    'return-policy-info' => 'La política de devolucions que es mostra als clients a la botiga abans que enviïn una sol·licitud de devolució.',
                    'specific-products' => 'Productes específics',
                    'title' => 'RMA',
                    'yes' => 'Sí',

                    'setting' => [
                        'info' => 'Configura com funcionen les devolucions (RMA) a la teva botiga: el termini de devolució, els tipus de fitxers adjunts permesos, els tipus de producte elegibles, la política de devolucions que es mostra als clients i si es poden reobrir les devolucions cancel·lades o rebutjades.',
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                'heading' => 'Hola :name',
                'message' => 'Missatge',
                'quotes' => 'Has rebut un missatge nou a la teva conversa RMA.',
                'subject' => 'Nou missatge de conversa RMA',
