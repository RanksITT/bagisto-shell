            ...
            'all-rma' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'return-window' => 'Periode Pengembalian',
                ...
                'view' => [
                    ...
                    'attachment' => 'Lampiran',
                    'by' => 'Oleh',
                    'change-status' => 'Ubah Status Permintaan',
                    'close-rma' => 'RMA ditutup',
                    'confirm-item-canceled' => 'Status item dibatalkan akan membatalkan item tersebut. Apakah Anda ingin melanjutkan?',
                    'confirm-item-refund' => 'Status paket diterima akan mengembalikan dana kepada pelanggan. Apakah Anda ingin melanjutkan?',
                    ...
                    'conversation-process' => 'Permintaan RMA Anda telah diproses.',
                    'conversations' => 'Percakapan',
                    'customer' => 'Pelanggan :',
                    'customer-details' => 'Detail Pelanggan',
                    'customer-email' => 'Email Pelanggan :',
                    'declined-admin' => 'Permintaan ditolak oleh admin',
                    ...
                    'solved-by-admin' => 'Diselesaikan oleh admin',
                    'status' => 'Status',
                    'status-message' => 'Status RMA ID #:id Anda telah diubah. Status: :status',
            ...
            'rma-status' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'reason-error' => 'Status RMA sedang digunakan dalam RMA.',
                        'reason' => 'Status RMA',
                        'status' => 'Status',
                        'title' => 'Judul',
                        'update' => 'Perbarui',
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    ...
                    'action-type-info-buy-x-get-y' => 'Saat pelanggan membeli X item, tambahan Y item gratis.',
                    'action-type-info-by-fixed' => 'Terapkan diskon jumlah tetap pada setiap item yang cocok.',
                    'action-type-info-by-percent' => 'Terapkan diskon persentase pada item yang cocok.',
                    'action-type-info-cart-fixed' => 'Terapkan diskon jumlah tetap pada seluruh keranjang.',
                    'actions' => 'Aksi',
                    ...
                    'apply-to-shipping-disabled-info' => 'Hanya berlaku untuk diskon persentase dan jumlah tetap.',
                    ...
                    'auto-generate-info' => 'Kode kupon dapat dihasilkan dari halaman edit aturan setelah disimpan.',
                    'back-btn' => 'Kembali',
                    ...
                    'maximum-discounted-quantity' => 'Jumlah Maksimum yang Didiskon',
                    'maximum-discounted-quantity-info' => 'Membatasi berapa banyak unit dari setiap item yang cocok mendapatkan diskon.',
                    'maximum-eligible-quantity-info' => 'Membatasi berapa banyak unit item ini yang ikut dalam penawaran Beli X Dapat Y.',
                    'maximum-eligible-quantity' => 'Jumlah Maksimum yang Memenuhi Syarat',
                    'name' => 'Nama',
                    'no' => 'Tidak',
                ...
                'edit' => [
                    ...
                    'auto-generate-banner-description' => 'Buat secara massal kode kupon unik untuk aturan ini.',
                    'auto-generate-banner-title' => 'Pembuatan otomatis diaktifkan',
                    'back-btn' => 'Kembali',
                    ...
                    'general' => 'Umum',
                    'generate' => 'Buat',
                    'generate-coupons' => 'Hasilkan Kupon',
                    'generate-here' => 'Hasilkan sekarang',
                    'generated-coupons' => 'Kupon yang Dihasilkan',
                    'greater-than' => 'Lebih Besar dari',
                    'is-equal-to' => 'Sama dengan',
                    'is-not-equal-to' => 'Tidak Sama dengan',
                    'less-than' => 'Lebih Kecil dari',
    ...
    'appearance' => [
        ...
        'sections' => [
            ...
            'edit' => [
                ...
                'asc' => 'Naik',
                'back' => 'Kembali',
                'brand-add-btn' => 'Tambah Merek',
                'brand-logo' => 'Logo Merek',
                'brand-name' => 'Nama Merek',
                'brands' => 'Merek',
                'chapter' => 'Bab',
                'chapter-engine' => 'Mesin',
                'chapter-figures' => 'Angka',
                'chapter-protection' => 'Perlindungan',
                'chapter-viscosity' => 'Viskositas',
                'category-carousel' => 'Carousel Kategori',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api-key' => 'Kunci API',
                    'api-publishable-key' => 'Kunci Publik API',
                    'api-test-key' => 'Kunci Rahasia Uji API',
                    'api-test-publishable-key' => 'Kunci Publik Uji API',
                    'applicable-production' => 'Hanya berlaku untuk mode produksi',
                    'applicable-sandbox' => 'Hanya berlaku untuk mode uji',
                    ...
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => 'Konfigurasikan pengaturan metode pembayaran PhonePe.',
                ...
                'rma' => [
                    ...
                    'allowed-request-cancelled-request' => 'Izinkan Pembukaan Kembali Pengembalian yang Dibatalkan',
                    'allowed-request-declined-request' => 'Izinkan Pembukaan Kembali Pengembalian yang Ditolak',
                    'allowed-rma-for-product' => 'Izinkan RMA untuk Produk',
                    'cancel-items' => 'Batalkan Item',
                    'cancelled-request-info' => 'Saat diaktifkan, pelanggan dapat mengajukan ulang pengembalian yang telah dibatalkan; status pengembalian akan kembali ke "Menunggu Tinjauan" untuk ditinjau ulang. Saat dinonaktifkan, pengembalian yang dibatalkan bersifat final dan tidak dapat dibuka kembali.',
                    'complete' => 'Selesai',
                    ...
                    'declined-request-info' => 'Saat diaktifkan, pelanggan dapat mengajukan ulang pengembalian yang ditolak oleh admin; status pengembalian akan kembali ke "Menunggu Tinjauan" untuk ditinjau ulang. Saat dinonaktifkan, pengembalian yang ditolak bersifat final dan tidak dapat dibuka kembali.',
                    ...
                    'product-type-info' => 'Hanya jenis produk yang dipilih yang memenuhi syarat untuk RMA. Jangka waktu pengembalian dikunci saat pesanan dibuat, sehingga perubahan di sini hanya berlaku untuk pesanan mendatang.',
                    'resolution-type' => 'Tipe Resolusi',
                    ...
                    'return-policy-info' => 'Kebijakan pengembalian yang ditampilkan kepada pelanggan di etalase sebelum mereka mengajukan permintaan pengembalian.',
                    'specific-products' => 'Produk Tertentu',
                    'title' => 'RMA',
                    'yes' => 'Ya',

                    'setting' => [
                        'info' => 'Atur cara kerja pengembalian (RMA) di toko Anda: jangka waktu pengembalian, jenis berkas lampiran yang diizinkan, jenis produk yang memenuhi syarat, kebijakan pengembalian yang ditampilkan kepada pelanggan, dan apakah pengembalian yang dibatalkan atau ditolak dapat dibuka kembali.',
                        'read' => 'Baca Kebijakan',
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                'heading' => 'Halo :name',
                'message' => 'Pesan',
                'quotes' => 'Anda menerima pesan baru dalam percakapan RMA Anda.',
                'subject' => 'Pesan Percakapan RMA Baru',
                'title' => 'Percakapan RMA Baru',
            ],
        ],
    ],
