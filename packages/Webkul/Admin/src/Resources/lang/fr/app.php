...
return [
        ...
        'rma' => [
            'all-rma' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'return-window' => 'Période de retour',
                ...
                'view' => [
                    ...
                    'by' => 'Par',
                    'change-status' => 'Changer le statut de la demande',
                    'close-rma' => 'La RMA est clôturée',
                    'confirm-item-canceled' => 'Le statut Article annulé annulera l\'article. Voulez-vous continuer ?',
                    'confirm-item-refund' => 'Le statut Colis reçu remboursera le montant au client. Voulez-vous continuer ?',
                    'confirm-print' => 'Cliquez sur OK pour imprimer la RMA',
                    'cancel-item' => 'Cancel Item',
                    'item-action-note' => 'This action affects the order and cannot be undone.',
                    'order-actions' => 'Order Actions',
                    'refund-item' => 'Refund Item',
                    'conversation-process' => 'Votre demande RMA a été traitée.',
                    'conversations' => 'Conversations',
                    'customer' => 'Client :',
                    'customer-details' => 'Détails du client',
                    'customer-email' => 'E-mail du client :',
                    'declined-admin' => 'Demande refusée par l\'administrateur',
                    ...
                    'on' => 'Le',
                    'order-date' => 'Date de commande :',
                    'order-details' => 'Article(s) demandés pour la RMA',
                    'order-id' => 'ID de commande :',
                    'order-status' => 'Statut de livraison :',
                    ...
                    'solved' => 'Résolu',
                    'solved-by-admin' => 'Résolu par l\'administrateur',
                    'status' => 'Statut',
                    'status-message' => 'Le statut de votre RMA ID #:id a été modifié. Statut : :status',
                    'status-reopen' => 'Rouvrir la demande',
                    'title' => 'RMA',
                    'update-success' => 'Statut de la RMA mis à jour avec succès.',
            ...
            'rma-status' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'enabled' => 'Actif',
                        'id' => 'ID',
                        'mass-delete-success' => 'Les statuts RMA sélectionnés ont été supprimés avec succès.',
                        'reason-error' => 'Le statut RMA est utilisé dans un RMA.',
                        'reason' => 'Statut RMA',
                        'status' => 'Statut',
                        'title' => 'Titre',
            ...
            'reasons' => [
                'index' => [
                    ...
                    'datagrid' => [
                        'created-at' => 'Créé le',
                        'delete' => 'Supprimer',
                        'delete-success' => 'Motif supprimé avec succès.',
                        'disabled' => 'Inactif',
                        'edit' => 'Modifier',
                        'enabled' => 'Actif',
                        'id' => 'ID',
                        'mass-delete-partial' => ':deleted des enregistrements sélectionnés ont été supprimés ; :skipped avaient déjà été retirés.',
                        'mass-delete-success' => 'Les données sélectionnées ont été supprimées avec succès.',
                        'reason-error' => 'Le motif est utilisé dans un RMA.',
                        'reason' => 'Motif',
                        'status' => 'Statut',
                        'update' => 'Mettre à jour',
                    ],
            ...
            'custom-field' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'created-at' => 'Créé le',
                        'delete' => 'Supprimer',
                        'delete-success' => 'Les champs personnalisés ont été supprimés avec succès.',
                        'disabled' => 'Inactif',
                        'edit' => 'Modifier',
                        'enabled' => 'Actif',
                        'id' => 'ID',
            ...
            'rules' => [
                'index' => [
                    ...
                    'datagrid' => [
                        'delete' => 'Supprimer',
                        'delete-success' => 'Les règles RMA ont été supprimées avec succès.',
                        'disabled' => 'Inactif',
                        'edit' => 'Modifier',
                        'enabled' => 'Actif',
            ...
            'create-rma' => [
                'conversation-process' => 'Votre demande de RMA a été traitée.',
                'create-success' => 'RMA créé avec succès.',
                'create-title' => 'Créer un RMA',
                'email' => 'E-mail',
                'failed' => 'Échec de la création du RMA.',
                'image' => 'Image',
                'invalid-order-id' => 'ID de commande invalide',
                'mismatch' => 'L’ID de commande et l’e-mail ne correspondent pas',
                'new-rma' => 'Nouveau RMA',
                'order-id' => 'ID de commande',
                'quantity' => 'Quantité',
                'reason' => 'Raison',
            ...
            'invoice' => [
                'create' => [
                    'order-item-not-found' => 'Élément de commande non trouvé',
                    'rma-created-message' => 'Une demande RMA est disponible pour le produit avec une quantité de :qty',
                    'rma-has-been-created' => 'La RMA a été créée',
                ],
            ],

            'index' => [
                'create-rma-title' => 'Créer',
        ...
        'products' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'sku' => 'SKU',
                    'sku-value' => 'SKU - :sku',
                    'stock-disabled' => 'Stock désactivé',
                    'status' => 'Statut',
                    'type' => 'Type',
                    'update-status' => 'Mettre à jour le statut',
                ],
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    ...
                    'action-type-info-buy-x-get-y' => 'Lorsque le client achète X articles, Y articles supplémentaires sont gratuits.',
                    'action-type-info-by-fixed' => 'Appliquer une remise d\'un montant fixe sur chaque article correspondant.',
                    'action-type-info-by-percent' => 'Appliquer une remise en pourcentage aux articles correspondants.',
                    'action-type-info-cart-fixed' => 'Appliquer une remise d\'un montant fixe sur le panier entier.',
                    'actions' => 'Actions',
                    ...
                    'apply-to-shipping-disabled-info' => 'Ne s\'applique qu\'aux remises en pourcentage et à montant fixe.',
                    'attribute-family' => 'Famille d\'attributs',
                    ...
                    'auto-generate-info' => 'Les codes de coupon peuvent être générés depuis la page d\'édition de la règle après l\'enregistrement.',
                    'back-btn' => 'Retour',
                    ...
                    'free-quantity' => 'Quantité gratuite (Y)',
                    'from' => 'De',
                    'general' => 'Général',
                    ...
                    'maximum-discounted-quantity' => 'Quantité maximale remisée',
                    'maximum-discounted-quantity-info' => 'Limite le nombre d\'unités de chaque article correspondant qui reçoivent la remise.',
                    'maximum-eligible-quantity-info' => 'Limite le nombre d\'unités de cet article participant à l\'offre Achetez X, obtenez Y.',
                    'maximum-eligible-quantity' => 'Quantité maximale éligible',
                    'name' => 'Nom',
                    'no' => 'Non',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name (parents uniquement)',
                    'auto-generate-coupon' => 'Générer automatiquement le coupon',
                    'auto-generate-banner-description' => 'Créez en masse des codes de coupon uniques pour cette règle.',
                    'auto-generate-banner-title' => 'Génération automatique activée',
                    'back-btn' => 'Retour',
                    'buy-x-get-y-free' => 'Achetez X, obtenez Y gratuitement',
                    ...
                    'general' => 'Général',
                    'generate' => 'Générer',
                    'generate-coupons' => 'Générer les coupons',
                    'generate-here' => 'Générer maintenant',
                    'generated-coupons' => 'Coupons générés',
                    'greater-than' => 'Supérieur à',
                    'is-equal-to' => 'Est égal à',
                    'is-not-equal-to' => 'N\'est pas égal à',
                    'less-than' => 'Inférieur à',
    ...
    'appearance' => [
        'themes' => [
            'index' => [
                ...
                'activate-success' => ':theme est maintenant actif sur :channel.',
                'active' => 'Actif',
                'active-on' => 'Actif sur :',
                'active-on-all' => 'Actif sur tous les canaux',
                'buy-btn' => 'Voir et acheter',
                'buy-themes' => 'Acheter des thèmes',
                'by' => 'par',
                'customize-btn' => 'Personnaliser',
                'info' => 'Parcourez les thèmes disponibles pour votre boutique et choisissez celui qu\'utilise chaque canal.',
                'my-themes' => 'Mes thèmes',
                'not-in-use' => 'Non utilisé',
                'not-installed' => 'Ce thème n\'est pas installé sur cette boutique.',
                'preview-btn' => 'Aperçu',
                'title' => 'Thèmes',

                'activate' => [
                    'channels' => 'Canaux',
                    'channels-hint' => 'Maintenez Ctrl (Cmd sur Mac) pour choisir plusieurs canaux.',
                    'confirm-btn' => 'Activer',
                    'info' => 'Choisissez les canaux qui doivent utiliser :theme.',
                    'title' => 'Activer le thème',
                    'warning' => ':channel comporte :count personnalisations créées pour :theme. Elles restent enregistrées, mais n\'apparaîtront pas tant que le nouveau thème est actif.',
                ],
            ],
        ],
        'sections' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'story-chapter' => 'Chapitre de l’histoire',
                    'title' => 'Type',
                ],
            ],
            ...
            'edit' => [
                ...
                'asc' => 'Asc',
                'back' => 'Retour',
                'brand-add-btn' => 'Ajouter une marque',
                'brand-logo' => 'Logo de la marque',
                'brand-name' => 'Nom de la marque',
                'brands' => 'Marques',
                'chapter' => 'Chapitre',
                'chapter-engine' => 'Moteur',
                'chapter-figures' => 'Chiffres',
                'chapter-protection' => 'Protection',
                'chapter-viscosity' => 'Viscosité',
                'category-carousel' => 'Carrousel de catégorie',
            ...
            'create-success' => 'Section créée avec succès',
            'delete-success' => 'Section supprimée avec succès',
            'update-success' => 'Section mise à jour avec succès',
        ],
    ],
    ...
    'reporting' => [
        'sales' => [
            'index' => [
                ...
                'sales-by-coupon' => 'Ventes par coupon',
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'import-confirmation' => 'L\'importation démarrera dès l\'enregistrement. Voulez-vous continuer ?',
                ...
                'import' => [
                    ...
                    'deleting-info' => 'Suppression en cours',
                    'download-error-report' => 'Télécharger le Rapport Complet',
                    'downloading-info' => 'Téléchargement des images',
                    'edit-btn' => 'Éditer',
                    'failed-batches' => ':count lots ne se sont pas terminés. Consultez le journal des erreurs et relancez l\'importation pour ces lignes.',
                    'images-downloaded' => 'Images téléchargées :',
                    'images-progress' => 'images téléchargées',
                    ...
                    'progress' => 'Avancement :',
                    'rows-validated' => 'lignes validées',
                    'step-create' => 'Créer',
                    'step-delete' => 'Supprimer',
                    'step-download' => 'Images',
                    'step-index' => 'Indexation',
                    'step-link' => 'Lier',
                    ...
                    'validation-partial-info' => 'Votre import peut continuer, mais certaines lignes seront ignorées. Consultez les erreurs ci-dessous ou téléchargez le rapport complet.',
                    'validation-success-info' => 'Votre importation est valide. Cliquez sur Importer pour démarrer le processus d\'importation.',
                ],

                'images' => [
                    'current-archive' => 'Actuellement téléversé : :name — :count image(s) prête(s).',
                    'current-images' => ':count image(s) déjà téléversée(s) pour cet import.',
                    'directory-example' => 'Par exemple, pour product-images, les fichiers doivent être placés dans le dossier /project-root/storage/app/import/product-images.',
                    'directory-hint' => 'Utilisez un chemin relatif à /project-root/storage/app/import, par ex. product-images, import-images.',
                    'directory-info' => 'Si vous avez accès au code, placez les images dans un dossier sur le serveur et indiquez ce dossier ci-dessous.',
                    'directory-placeholder' => 'Chemin du dossier d\'images',
                    'directory-title' => 'Images déjà présentes sur le serveur',
                    'download-sample-zip' => 'Télécharger des images d\'exemple',
                    'info' => 'Choisissez où trouver les images nommées dans votre fichier.',
                    'recommended' => 'Recommandé',
                    'replace-archive' => 'Choisir une nouvelle archive les remplace.',
                    'title' => 'Images des produits',
                    'upload-info' => 'Téléversez une seule archive contenant toutes les images. La colonne « images » nomme alors les fichiers qu\'elle contient.',
                    'upload-title' => 'Téléverser une archive ZIP d\'images',
                    'url-info' => 'Indiquez l\'adresse https:// complète de chaque image dans la colonne « images ». Elles sont téléchargées avant l\'import, sans rien déposer au préalable sur le serveur.',
                    'url-title' => 'Liens d\'images dans le fichier',
                ],
                ...
                'processing-failed' => 'L\'importation n\'a pas pu être traitée. Veuillez vérifier le fichier et réessayer.',
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                'info' => 'Paramètres globaux : unités, contenu, design, taux de change, plan du site et RGPD.',
                'title' => 'Général',

                'general' => [
                    'info' => 'Réglages des unités et fil d\'Ariane de la boutique.',
                    'title' => 'Général',
                ...
                'content' => [
                    'info' => 'Bandeau d\'offre, ligne de copyright, règles de spéculation et scripts personnalisés.',
                    'title' => 'Contenu',
                    ...
                    'copyright-content' => [
                        ...
                        'info' => 'La ligne de copyright affichée dans le pied de page de la boutique.',
                    ],
                    ...
                    'custom-scripts' => [
                        ...
                        'title-info' => 'CSS et JavaScript ajoutés à chaque page de la boutique.',
                    ],
                ],

                'design' => [
                    'info' => 'Logo et favicon du panneau d\'administration, et affichage des catégories du menu de la boutique.',
                    'title' => 'Design',
                    ...
                    'admin-logo' => [
                        ...
                        'title-info' => 'Le logo et le favicon affichés dans le panneau d\'administration et dans les e-mails envoyés à l\'administrateur.',
                    ],
                ...
                'gdpr' => [
                    'title' => 'GDPR',
                    'info' => 'Bandeau cookies, catégories de consentement et accord de confidentialité présentés aux clients.',

                    'settings' => [
                        'title' => 'Paramètres de conformité au GDPR',
                        'info' => 'Activer ou désactiver les fonctions RGPD pour ce canal.',
                ...
                'sitemap' => [
                    'info' => 'Génération du plan du site et limites de fichier.',
                    'title' => 'Plan du Site',
                    ...
                    'file-limits' => [
                        'info' => 'Le nombre maximal d\'URL écrites dans un fichier de plan du site avant d\'en commencer un autre.',
            ...
            'magic-ai' => [
                'info' => 'Configurez les paramètres, fournisseurs et fonctionnalités de Magic AI.',
                'title' => 'Magic AI',

                'general' => [
                    'info' => 'Paramètres généraux de Magic AI.',
                    'title' => 'Général',

                    'settings' => [
                        'enabled' => 'Activé',
                        'title' => 'Paramètres',
                        'title-info' => 'Activer ou désactiver Magic AI dans toute l\'application.',
                    ],
                ],

                'providers' => [
                    'api-key' => 'Clé API',
                    'info' => 'Configurez les clés API pour vos fournisseurs d\'IA.',
                    'title' => 'Fournisseurs',

                    'openai' => [
                        'title' => 'OpenAI',
                        'title-info' => 'Configurez vos identifiants API OpenAI.',
                    ],

                    'anthropic' => [
                        'title' => 'Anthropic',
                        'title-info' => 'Configurez vos identifiants API Anthropic.',
                    ],

                    'gemini' => [
                        'title' => 'Gemini',
                        'title-info' => 'Configurez vos identifiants API Google Gemini.',
                    ],

                    'groq' => [
                        'title' => 'Groq',
                        'title-info' => 'Configurez vos identifiants API Groq.',
                    ],

                    'xai' => [
                        'title' => 'xAI',
                        'title-info' => 'Configurez vos identifiants API xAI.',
                    ],

                    'deepseek' => [
                        'title' => 'DeepSeek',
                        'title-info' => 'Configurez vos identifiants API DeepSeek.',
                    ],

                    'mistral' => [
                        'title' => 'Mistral',
                        'title-info' => 'Configurez vos identifiants API Mistral.',
                    ],
                ...
                'admin-features' => [
                    'info' => 'Activer et configurer les fonctionnalités IA pour le panneau d\'administration.',
                    ...
                    'text-generation' => [
                        ...
                        'title-info' => 'Activer la génération de texte par IA dans les éditeurs WYSIWYG du panneau d\'administration.',
                    ],
                    ...
                    'image-generation' => [
                        ...
                        'title-info' => 'Activer la génération d\'images par IA pour les images de produits et de contenu.',
                    ],
                ],
                ...
                'storefront-features' => [
                    ...
                    'review-translation' => [
                        ...
                        'title-info' => 'Permettre aux clients de traduire les avis dans leur langue sur la boutique.',
                    ],
                    ...
                    'checkout-message' => [
                        ...
                        'title-info' => 'Générer des messages de paiement personnalisés pour les clients sur la page de remerciement.',
                    ],
                ],
            ],

            'catalog' => [
                'info' => 'Paramètres des produits, des extraits enrichis et du stock.',
                'title' => 'Catalogue',

                'products' => [
                    'info' => 'Pages produit et panier, recherche, tailles d\'image, avis, attributs et partage.',
                    'title' => 'Produits',
                    ...
                    'settings' => [
                        ...
                        'title' => 'Paramètres',
                        'title-info' => 'Activer ou désactiver la comparaison de produits et la recherche par image.',
                    ...
                    'product-view-page' => [
                        ...
                        'title-info' => 'Le nombre de produits associés et de montée en gamme affichés sur la page produit.',
                    ],
                    ...
                    'cart-view-page' => [
                        ...
                        'title-info' => 'Le nombre de produits de vente croisée affichés sur la page du panier.',
                    ],
                    ...
                    'storefront' => [
                        ...
                        'sort-by' => 'Trier par',
                        'title' => 'Vitrine',
                        'title-info' => 'Comment les produits sont listés sur les pages de catégorie et de recherche.',
                    ],
                    ...
                    'small-image' => [
                        ...
                        'title' => 'Petite image',
                        'title-info' => 'La taille à laquelle les petites images produit sont redimensionnées, et l\'image par défaut si le produit n\'en a pas.',
                        'width' => 'Largeur',
                    ],
                    ...
                    'medium-image' => [
                        ...
                        'title' => 'Image moyenne',
                        'title-info' => 'La taille à laquelle les images produit moyennes sont redimensionnées, et l\'image par défaut si le produit n\'en a pas.',
                        'width' => 'Largeur',
                    ],
                    ...
                    'large-image' => [
                        ...
                        'title' => 'Grande image',
                        'title-info' => 'La taille à laquelle les grandes images produit sont redimensionnées, et l\'image par défaut si le produit n\'en a pas.',
                        'width' => 'Largeur',
                    ],
                    ...
                    'review' => [
                        ...
                        'summary' => 'Résumé',
                        'title' => 'Avis',
                        'title-info' => 'Qui peut évaluer un produit, et comment les avis apparaissent sur la page produit.',
                    ],
                    ...
                    'attribute' => [
                        ...
                        'title' => 'Attribut',
                        'title-info' => 'La taille maximale d\'une image ou d\'un fichier téléversé pour une valeur d\'attribut.',
                    ],

                    'social-share' => [
                        'title-info' => 'Choisissez les boutons de partage affichés sur la page produit et le message qu\'ils portent.',
                        'title' => 'Partage social',
                        'share-message' => 'Message de partage',
                        'share' => 'Partager',
                        'enable-social-share' => 'Activer le partage social ?',
                        'enable-share-whatsapp-info' => 'Le lien de partage WhatsApp n\'apparaît que sur les appareils mobiles.',
                        'enable-share-whatsapp' => 'Activer le partage sur WhatsApp ?',
                        'enable-share-twitter' => 'Activer le partage sur X (Twitter) ?',
                ...
                'rich-snippets' => [
                    'info' => 'Données structurées ajoutées aux pages de la boutique pour les moteurs de recherche.',
                    ...
                    'products' => [
                        ...
                        'title' => 'Produits',
                        'title-info' => 'Choisissez les détails du produit inclus dans les données structurées.',
                    ],
                    ...
                    'categories' => [
                        ...
                        'title' => 'Catégories',
                        'title-info' => 'Ajouter des données structurées de catégorie aux pages de la boutique pour que les moteurs de recherche puissent les lire.',
                    ],
                ],
                ...
                'inventory' => [
                    ...
                    'product-stock-options' => [
                        ...
                        'info' => 'Autoriser les commandes en rupture de stock, et définir la quantité à partir de laquelle un produit est considéré épuisé.',
                    ],
                ],
            ],

            'customer' => [
                'info' => 'Paramètres des adresses, du captcha et des comptes clients.',
                'title' => 'Client',
                ...
                'address' => [
                    ...
                    'requirements' => [
                        ...
                        'state' => 'État',
                        'title' => 'Exigences',
                        'title-info' => 'Les champs d\'adresse qu\'un client doit renseigner.',
                        'zip' => 'Code postal',
                    ],
                    ...
                    'information' => [
                        ...
                        'title' => 'Informations',
                        'title-info' => 'Le nombre de lignes d\'adresse affichées dans le formulaire.',
                    ],
                ],

                'captcha' => [
                    'info' => 'Clés et statut de Google reCAPTCHA Enterprise.',
                    'title' => 'Google Captcha',

                    'credentials' => [
                        'api-key' => 'Clé API',
                        'api-key-info' => 'Après avoir créé le projet, vous devez créer les clés API en naviguant vers la section "Identifiants" dans le menu "APIs et services".',
                        'project-id' => 'ID du projet',
                        'project-id-info' => 'Pour obtenir la clé API et la clé secrète, vous devez créer un projet dans la console Google Cloud.',
                        'score-threshold' => 'Seuil de score',
                        'score-threshold-info' => 'Définissez le seuil de score pour reCAPTCHA v3, allant de 0.0 à 1.0.',
                        'secret-key' => 'Clé secrète',
                        'site-key' => 'Clé du site',
                        'site-key-info' => 'Une fois le projet et la clé API créés, recherchez le service "reCAPTCHA" dans la bibliothèque et générez les clés "reCAPTCHA".',
                        'status' => 'Statut',
                        'title' => 'Identifiants',
                        'title-info' => 'Identifiants Google reCAPTCHA Enterprise, et le score qu\'une requête doit atteindre pour être acceptée.',
                    ],
                ...
                'settings' => [
                    'settings-info' => 'Définir la liste d\'envies, la redirection après connexion, les options de nouveau compte, la newsletter, la vérification d\'e-mail et la connexion sociale.',
                    'title' => 'Paramètres',
                    ...
                    'newsletter' => [
                        ...
                        'subscription-info' => 'Afficher un formulaire d\'inscription dans le pied de page de la boutique.',
                        'title' => 'Abonnement à la newsletter',
                        'title-info' => 'Inscription à la newsletter sur la boutique.',
                    ],

                    'email' => [
                        'email-verification' => 'Autoriser la vérification par e-mail',
                        'title' => 'Vérification par e-mail',
                        'title-info' => 'Demander à un nouveau client de confirmer son adresse e-mail avant de pouvoir se connecter.',
                    ],

                    'social-login' => [
                        'title' => 'Connexion sociale',
                        'info' => 'Permettre aux clients de se connecter avec un compte externe. Chaque fournisseur nécessite son propre identifiant et secret client.',
                        ...
                        'twitter' => [
                            'enable-twitter' => 'Activer X (Twitter)',

                            'client-id' => [
                                'title' => 'Identifiant client',
                                'title-info' => 'Identifiant unique fourni par X lors de la création de votre application OAuth.',
                            ],

                            'client-secret' => [
                                'title' => 'Clé secrète du client',
                                'title-info' => 'Clé secrète associée à votre client OAuth X. Gardez-la confidentielle.',
                            ],

                            'redirect' => [
                                'title' => 'URL de redirection',
                                'title-info' => 'URL de rappel vers laquelle les utilisateurs sont redirigés après authentification auprès de X. Utilisez le format d\'URL affiché (ne changez que votre domaine). Elle doit correspondre à l\'URL configurée dans votre portail développeur X.',
                            ],
                        ],
                    ],
                ],
            ...
            'email' => [
                'info' => 'Pilote de messagerie, coordonnées d\'expéditeur et notifications envoyées par votre boutique.',
                'title' => 'Email',
                ...
                'email-settings' => [
                    ...
                    'admin-email-tip' => 'Toutes les notifications d\'administrateur pour cette chaîne seront envoyées à cette adresse.',
                    'admin-name' => 'Nom de l\'administrateur',
                    'admin-name-tip' => 'Ce nom apparaîtra dans tous les e-mails envoyés à l\'administrateur.',
                    'admin-page-limit' => 'Éléments par défaut par page (administrateur)',
                    'contact-email' => 'Adresse e-mail de contact',
                    'contact-email-tip' => 'Cette adresse e-mail apparaîtra dans le pied de page de vos e-mails.',
                    'contact-name' => 'Nom de contact',
                    'contact-name-tip' => 'Ce nom apparaîtra dans le pied de page de vos e-mails.',
                    'info' => 'Choisissez comment les e-mails sont envoyés et depuis quelles adresses.',
                    'sender-email' => 'Adresse e-mail de l\'expéditeur',
                    'sender-email-tip' => 'Les e-mails à vos clients seront envoyés depuis cette adresse.',
                    'sender-name' => 'Nom de l\'expéditeur',
                    'sender-name-tip' => 'Ce nom apparaîtra dans la boîte de réception de vos clients en tant qu\'expéditeur de l\'e-mail.',
                    'title' => 'Paramètres des e-mails',
                    'title-info' => 'Les noms et adresses depuis lesquels votre boutique envoie ses e-mails et qui apparaissent en pied de page.',
                ],
                ...
                'notifications' => [
                    ...
                    'info' => 'Choisissez les e-mails envoyés aux clients et à l\'administrateur.',
            ...
            'sales' => [
                'info' => 'Paramètres de livraison, paiements, commandes, factures, taxes, commande et retours.',
                'title' => 'Sales',

                'shipping-setting' => [
                    'info' => 'L\'adresse d\'expédition des commandes.',
                    ...
                    'origin' => [
                        ...
                        'street-address' => 'Adresse',
                        'title' => 'Origine',
                        'title-info' => 'L\'adresse d\'expédition des commandes et les coordonnées de la boutique affichées sur les factures.',
                ...
                'shipping-methods' => [
                    'info' => 'Les modes de livraison proposés lors de la commande.',
                    ...
                    'free-shipping' => [
                        ...
                        'status' => 'Statut',
                        'title' => 'Titre',
                        'title-info' => 'Un mode de livraison sans frais.',
                    ],
                    ...
                    'flat-rate-shipping' => [
                        ...
                        'status' => 'Statut',
                        'title' => 'Titre',
                        'title-info' => 'Un mode de livraison à tarif fixe, par commande ou par article.',
                        'type' => [
                ...
                'payment-methods' => [
                    ...
                    'api-key' => 'Clé API',
                    'api-publishable-key' => 'Clé publique de l’API',
                    'api-test-key' => 'Clé secrète de test de l’API',
                    'api-test-publishable-key' => 'Clé publique de test de l’API',
                    'applicable-production' => 'S’applique uniquement au mode production',
                    'applicable-sandbox' => 'S’applique uniquement au mode test',
                    'application-fee' => 'Payeur des frais d’application',
                    'business-account' => 'Compte professionnel',
                    'cash-on-delivery' => 'Paiement à la livraison',
                    'cash-on-delivery-info' => 'Permettre aux clients de payer en espèces à la livraison.',
                    'client-id' => 'ID client',
                    'client-id-info' => 'L\'identifiant client de votre application PayPal. Utilisez celui de l\'application sandbox tant que le mode Sandbox est actif.',
                    'client-secret' => 'Secret client',
                    'client-secret-info' => 'Le secret client de votre application PayPal.',
                    'create-success-refund' => 'Remboursement créé avec succès.',
                    'description' => 'Description',
                    'enable' => 'Activer',
                    ...
                    'info' => 'Configurer les moyens de paiement proposés lors de la commande.',
                    'instructions' => 'Instructions',
                    'logo' => 'Logo',
                    'logo-information' => 'Taille recommandée : 55 x 45 pixels.',
                    ...
                    'merchant-private-key' => 'Clé privée du marchand',
                    'merchant-private-key-info' => 'Collez le contenu du fichier PEM de la clé privée générée dans le tableau de bord PayGlocal. Elle sert à signer les requêtes.',
                    'merchant-salt' => 'Sel marchand',
                    'money-transfer' => 'Virement bancaire',
                    'money-transfer-info' => 'Permettre aux clients de payer par virement bancaire ou par chèque.',
                    'page-title' => 'Méthodes de paiement',
                    'paid' => 'Payé',
                    'payglocal' => 'PayGlocal',
                    'payglocal-info' => 'Acceptez les paiements transfrontaliers via PayGlocal. <a href="https://dashboard.payglocal.in/app/mca/h8271x" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline hover:text-blue-700">Inscrivez-vous ici pour obtenir vos identifiants.</a>',
                    'payglocal-merchant-id-info' => 'Disponible dans le tableau de bord PayGlocal sous My Account.',
                    'payglocal-private-key-id-info' => 'L\'identifiant de votre clé privée, affiché dans le tableau de bord PayGlocal.',
                    'payglocal-public-key' => 'Clé publique PayGlocal',
                    'payglocal-public-key-id-info' => 'L\'identifiant de la clé publique PayGlocal, affiché dans le tableau de bord PayGlocal.',
                    'payglocal-public-key-info' => 'Collez le contenu du fichier PEM de la clé publique PayGlocal. Elle sert à chiffrer les requêtes et à vérifier les réponses.',
                    'payglocal-sandbox-info' => 'Envoyer les paiements vers l\'environnement de test PayGlocal.',
                    'paypal-smart-button' => 'PayPal',
                    'paypal-smart-button-info' => 'Afficher les boutons PayPal lors de la commande pour payer avec PayPal ou par carte.',
                    'paypal-standard' => 'PayPal Standard',
                    'paypal-standard-info' => 'Rediriger les clients vers PayPal pour payer avec leur compte PayPal ou par carte.',
                    'payu' => 'PayU',
                    'payu-info' => 'Accepter les paiements via PayU.',
                    'payu-merchant-key-info' => 'Entrez votre clé marchande PayU obtenue depuis le tableau de bord PayU',
                    'payu-merchant-salt-info' => 'Entrez votre sel marchand PayU obtenu depuis le tableau de bord PayU',
                    'pending' => 'En attente',
                    'pending-payment' => 'Paiement en attente',
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => 'Configurez les paramètres du mode de paiement PhonePe.',
                    'phonepe-client-id-info' => 'Entrez votre ID client PhonePe obtenu du tableau de bord PhonePe',
                    'phonepe-client-secret-info' => 'Entrez votre secret client PhonePe obtenu du tableau de bord PhonePe',
                    'phonepe-merchant-info' => 'Entrez votre ID marchand PhonePe obtenu du tableau de bord PhonePe',
                    'private-key-id' => 'Identifiant de la clé privée',
                    'processing' => 'En cours de traitement',
                    'production-mode-info' => 'Pour le mode production uniquement.',
                    'public-key-id' => 'Identifiant de la clé publique',
                    'razorpay' => 'Razorpay',
                    'razorpay-info' => 'Accepter les paiements via Razorpay.',
                    ...
                    'status' => 'Statut',
                    'stripe' => 'Stripe',
                    'stripe-info' => 'Accepter les paiements par carte via Stripe.',
                ...
                'order-settings' => [
                    'info' => 'Nouvelles tentatives de création de commande, numéros de commande, montant minimum et recommande.',
                    ...
                    'order-number' => [
                        ...
                        'info' => 'Comment les numéros de commande générés sont composés.',
                    ...
                    'minimum-order' => [
                        ...
                        'info' => 'Le montant minimum de commande permettant de passer commande.',
                    ...
                    'reorder' => [
                        ...
                        'admin-reorder-info' => 'Permettre à un administrateur de repasser une commande depuis le panneau d\'administration.',
                        'info' => 'Permettre de repasser une commande depuis le panneau d\'administration ou la boutique.',
                        'shop-reorder' => 'Réorganiser par la boutique',
                        'shop-reorder-info' => 'Permettre à un client de repasser une commande depuis la boutique.',
                ...
                'invoice-settings' => [
                    'info' => 'Numéros de facture, conditions de paiement, impressions PDF et rappels.',
                    'title' => 'Paramètres de facture',

                    'invoice-number' => [
                        'generator' => 'Générateur de numéro de facture',
                        'info' => 'Comment les numéros de facture générés sont composés.',
                    ...
                    'payment-terms' => [
                        ...
                        'info' => 'Le délai de règlement d\'une facture après son émission.',
                    ...
                    'invoice-reminders' => [
                        'info' => 'Combien de rappels de paiement sont envoyés pour une facture impayée, et à quel intervalle.',
                ...
                'taxes' => [
                    'title' => 'Taxes',
                    'title-info' => 'Catégories de taxe, mode de calcul et affichage.',

                    'categories' => [
                        'title' => 'Catégories de taxes',
                        'title-info' => 'La catégorie de taxe appliquée à la livraison, et celle par défaut des nouveaux produits.',
                    ...
                    'calculation' => [
                        ...
                        'title-info' => 'Sur quoi la taxe est calculée, et si les prix saisis l\'incluent déjà.',
                    ],
                    ...
                    'default-destination-calculation' => [
                        ...
                        'title-info' => 'L\'adresse utilisée pour calculer la taxe avant que le client ne saisisse la sienne.',
                    ],
                    ...
                    'shopping-cart' => [
                        ...
                        'title-info' => 'Comment la taxe est affichée dans le panier et lors de la commande.',
                    ...
                    'sales' => [
                        ...
                        'title-info' => 'Comment la taxe est affichée sur les commandes, factures et remboursements.',
                        'display-prices' => 'Afficher les prix',
                        'display-subtotal' => 'Afficher le sous-total',
                        'display-shipping-amount' => 'Afficher le montant de l\'expédition',
                        'excluding-tax' => 'Hors taxe',
                ...
                'checkout' => [
                    ...
                    'info' => 'Commande en tant qu\'invité, page du panier, mini-panier et récapitulatif du panier.',
                    ...
                    'shopping-cart' => [
                        ...
                        'info' => 'Commande en tant qu\'invité, page du panier, produits de vente croisée et livraison estimée.',
                    ...
                    'my-cart' => [
                        ...
                        'info' => 'Si le compteur du panier affiche la quantité totale ou le nombre d\'articles.',
                        'summary' => 'Résumé',
                        'title' => 'Mon panier',
                    ],
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Afficher le mini-panier et le texte d\'offre qui y apparaît.',
                ...
                'rma' => [
                    ...
                    'allow-product-type-for-rma' => 'Autoriser le type de produit pour RMA',
                    'allow-rma-for-digital-product' => 'Permettre RMA pour produit numérique',
                    'allowed-file-extension' => 'Extension de fichier autorisée',
                    'allowed-file-types' => 'Veuillez sélectionner uniquement les types de fichiers :allowed_types',
                    'allowed-info' => 'Séparé par des virgules. Par exemple: jpg,jpeg,pdf',
                    'allowed-request-cancelled-request' => 'Autoriser la réouverture des retours annulés',
                    'allowed-request-declined-request' => 'Autoriser la réouverture des retours refusés',
                    'allowed-rma-for-product' => 'Permettre RMA pour produit',
                    'cancel-items' => 'Annuler les articles',
                    'cancelled-request-info' => 'Lorsque cette option est activée, un client peut soumettre à nouveau un retour annulé ; il repasse au statut "En attente d\'examen" pour un nouvel examen. Lorsqu\'elle est désactivée, un retour annulé est définitif et ne peut pas être rouvert.',
                    'complete' => 'Complet',
                    ...
                    'declined-request-info' => 'Lorsque cette option est activée, un client peut soumettre à nouveau un retour refusé par l\'administrateur ; il repasse au statut "En attente d\'examen" pour un nouvel examen. Lorsqu\'elle est désactivée, un retour refusé est définitif et ne peut pas être rouvert.',
                    'default-allow-days' => 'Jours autorisés par défaut',
                    'enable' => 'Activer RMA',
                    'evening' => 'Soirée',
                    'exchange' => 'Échange',
                    'file-extension-info' => 'Les types de fichiers que les clients et les administrateurs peuvent joindre à une demande de retour, tels que des photos de produits ou des documents justificatifs.',
                    'info' => 'Retours que les clients peuvent demander après avoir passé commande.',
                    'morning' => 'Matin',
                    ...
                    'product-type-info' => 'Seuls les types de produits sélectionnés sont éligibles à une RMA. La période de retour est fixée au moment de la commande ; les modifications apportées ici ne s\'appliquent donc qu\'aux commandes futures.',
                    'resolution-type' => 'Type de résolution',
                    ...
                    'return-policy-info' => 'La politique de retour présentée aux clients sur la boutique avant qu\'ils ne soumettent une demande de retour.',
                    'specific-products' => 'Produits spécifiques',
                    'title' => 'RMA',
                    'yes' => 'Oui',

                    'setting' => [
                        'info' => 'Définissez le fonctionnement des retours (RMA) dans votre boutique : la période de retour, les types de fichiers joints autorisés, les types de produits éligibles, la politique de retour présentée aux clients, et si les retours annulés ou refusés peuvent être rouverts.',
        ...
        'media' => [
            'images' => [
                ...
                'seo' => [
                    ...
                    'alt-text-info' => 'Enregistré pour la langue actuellement sélectionnée. Le nom du produit est utilisé si le champ est vide.',
                    'alt-text-placeholder' => 'Décrivez ce que montre l\'image',
                    'done-btn' => 'Terminé',
                    'file-name' => 'Nom du fichier',
                    'file-name-info' => 'Renommer modifie l\'URL de l\'image. L\'ancienne URL cesse de fonctionner, ce qui peut affecter le classement dans la recherche d\'images.',
                    'file-name-placeholder' => 'blue-running-shoe-side',
                    'info' => 'Améliorez la façon dont les moteurs de recherche et les lecteurs d\'écran comprennent cette image.',
                    'replace' => 'Remplacer l\'image',
                    'replace-btn' => 'Choisir un fichier',
                    'replace-info' => 'Le texte alternatif et le nom du fichier ci-dessus sont conservés pour la nouvelle image.',
                    'title' => 'SEO de l\'image',
                ],
            ],
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                ...
                'message' => 'Message',
                'quotes' => 'Vous avez reçu un nouveau message dans votre conversation RMA.',
