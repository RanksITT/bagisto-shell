        ...
        'rma' => [
            'all-rma' => [
                ...
                'view' => [
                    ...
                    'close-rma' => 'RMA is closed',
                    'confirm-item-canceled' => 'Item Canceled status will cancel the item. Do you want to proceed?',
                    'confirm-item-refund' => 'Received package status will refund the amount to customer. Do you want to proceed?',
                    ...
                    'conversation-process' => 'Your RMA request has been processed.',
                    'conversations' => 'Conversations',
                    'customer' => 'Customer :',
                    'customer-details' => 'Customer Details',
                    'customer-email' => 'Customer Email :',
                    'declined-admin' => 'Request declined by admin',
                    ...
                    'price' => 'Price :',
                    'refund-creation-error' => 'Unable to create refund for this order.',
                    ...
                    'solved' => 'Solved',
                    'solved-by-admin' => 'Solved By Admin',
                    'status' => 'Status',
                    'status-message' => 'Your RMA ID #:id status has been changed. Status: :status',
            ...
            'reasons' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'enabled' => 'Active',
                        'id' => 'ID',
                        'mass-delete-partial' => 'Au fost șterse :deleted dintre înregistrările selectate; :skipped fuseseră deja eliminate.',
    ...
    'catalog' => [
        'products' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'sku' => 'SKU',
                    'sku-value' => 'SKU - :sku',
                    'stock-disabled' => 'Stoc dezactivat',
                    'status' => 'Status',
                    'type' => 'Type',
                    'update-status' => 'Update Status',
                ],
        ...
        'attributes' => [
            ...
            'create' => [
                ...
                'price' => 'Price',
                'regex' => 'Regex',
                'regex-info' => 'Expresia trebuie delimitată prin bare oblice, de exemplu /^[0-9]+$/.',
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    ...
                    'action-type-info-buy-x-get-y' => 'Când clientul cumpără X articole, Y articole suplimentare sunt gratuite.',
                    'action-type-info-by-fixed' => 'Aplică o reducere fixă pentru fiecare articol potrivit.',
                    'action-type-info-by-percent' => 'Aplică o reducere procentuală articolelor potrivite.',
                    'action-type-info-cart-fixed' => 'Aplică o reducere fixă întregului coș.',
                    'actions' => 'Actions',
                    ...
                    'apply-to-shipping-disabled-info' => 'Se aplică doar reducerilor procentuale și de sumă fixă.',
                    'attribute-family' => 'Attribute Family',
                    ...
                    'auto-generate-info' => 'Codurile cupoanelor pot fi generate din pagina de editare a regulii după salvare.',
                    'back-btn' => 'Back',
                    ...
                    'description' => 'Description',
                    'discount-amount' => 'Discount Amount',
                    'discount-percent' => 'Procent reducere (%)',
                    ...
                    'free-quantity' => 'Cantitate gratuită (Y)',
                    'from' => 'From',
                    'general' => 'General',
                    ...
                    'maximum-discounted-quantity' => 'Cantitate maximă redusă',
                    'maximum-discounted-quantity-info' => 'Limitează câte unități din fiecare articol potrivit primesc reducerea.',
                    'maximum-eligible-quantity-info' => 'Limitează câte unități din acest articol participă la oferta Cumpără X Primești Y.',
                    'maximum-eligible-quantity' => 'Cantitate maximă eligibilă',
                    'name' => 'Name',
                    'no' => 'No',
                    'no-coupon' => 'No Coupon',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name (Parent Only)',
                    'auto-generate-coupon' => 'Auto Generate Coupon',
                    'auto-generate-banner-description' => 'Creează în masă coduri cupon unice pentru această regulă.',
                    'auto-generate-banner-title' => 'Generare automată activată',
                    'back-btn' => 'Back',
                    'buy-x-get-y-free' => 'Buy X Get Y Free',
                    'buy-x-quantity' => 'Buy X Quantity',
                    'cart-attribute' => 'Cart attribute',
                    ...
                    'general' => 'General',
                    'generate' => 'Generate',
                    'generate-coupons' => 'Generează Cupoane',
                    'generate-here' => 'Generează acum',
                    'generated-coupons' => 'Cupoane Generate',
                    'greater-than' => 'Greater than',
                    'is-equal-to' => 'Is equal to',
                    'is-not-equal-to' => 'Is not equal to',
                    'less-than' => 'Less than',
    ...
    'appearance' => [
        'themes' => [
            'index' => [
                ...
                'activate-success' => ':theme is now active on :channel.',
                'active' => 'Active',
                'active-on' => 'Active on:',
                'active-on-all' => 'Active on every channel',
                'buy-btn' => 'View & Buy',
                'buy-themes' => 'Cumpără teme',
                'by' => 'by',
                'customize-btn' => 'Customize',
                'info' => 'Browse the themes available for your storefront and choose which one each channel uses.',
                'my-themes' => 'Temele mele',
                'not-in-use' => 'Not in use',
                'not-installed' => 'This theme is not installed on this store.',
                'preview-btn' => 'Preview',
                'title' => 'Themes',

                'activate' => [
                    'channels' => 'Channels',
                    'channels-hint' => 'Hold Ctrl (Cmd on Mac) to pick more than one channel.',
                    'confirm-btn' => 'Activate',
                    'info' => 'Choose the channels that should start using :theme.',
                    'title' => 'Activate Theme',
                    'warning' => ':channel has :count customizations built for :theme. They stay saved, but will not appear while the new theme is active.',
                ],
            ],
        ],
        'sections' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'story-chapter' => 'Capitol din poveste',
                    'title' => 'Type',
                ],
            ],
            ...
            'edit' => [
                ...
                'asc' => 'Asc',
                'back' => 'Back',
                'brand-add-btn' => 'Adaugă marcă',
                'brand-logo' => 'Siglă marcă',
                'brand-name' => 'Nume marcă',
                'brands' => 'Mărci',
                'chapter' => 'Capitol',
                'chapter-engine' => 'Motor',
                'chapter-figures' => 'Cifre',
                'chapter-protection' => 'Protecție',
                'chapter-viscosity' => 'Vâscozitate',
                'category-carousel' => 'Category Carousel',
    ...
    'reporting' => [
        'sales' => [
            'index' => [
                ...
                'sales-by-coupon' => 'Vânzări după Cupon',
    ...
    'settings' => [
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'import-confirmation' => 'Importul va începe imediat după salvare. Doriți să continuați?',
                ...
                'import' => [
                    ...
                    'deleting-info' => 'Ștergere în curs',
                    'download-error-report' => 'Download Full Report',
                    'downloading-info' => 'Se descarcă imaginile',
                    'edit-btn' => 'Edit',
                    'failed-batches' => ':count loturi nu s-au finalizat. Verificați jurnalul de erori și rulați din nou importul pentru acele rânduri.',
                    'images-downloaded' => 'Imagini descărcate:',
                    'images-progress' => 'imagini descărcate',
                    ...
                    'progress' => 'Progress:',
                    'rows-validated' => 'rânduri validate',
                    'step-create' => 'Creare',
                    'step-delete' => 'Ștergere',
                    'step-download' => 'Imagini',
                    'step-index' => 'Indexare',
                    'step-link' => 'Conectare',
                    'step-validate' => 'Validare',
                    'title' => 'Import',
                    ...
                    'validation-partial-info' => 'Importul poate continua, dar unele rânduri vor fi omise. Verificați erorile de mai jos sau descărcați raportul complet.',
                    'validation-success-info' => 'Your import is valid. Click on Import to start the import process.',
                ],

                'images' => [
                    'current-archive' => 'Încărcat în prezent: :name — :count imagine/imagini gata.',
                    'current-images' => 'Pentru acest import sunt deja încărcate :count imagine/imagini.',
                    'directory-example' => 'De exemplu, în cazul product-images, fișierele trebuie plasate în folderul /project-root/storage/app/import/product-images.',
                    'directory-hint' => 'Folosiți calea relativă la /project-root/storage/app/import, de ex. product-images, import-images.',
                    'directory-info' => 'Dacă aveți acces la codul sursă, puneți imaginile într-un folder pe server și indicați acel folder mai jos.',
                    'directory-placeholder' => 'Calea directorului de imagini',
                    'directory-title' => 'Imagini deja pe server',
                    'download-sample-zip' => 'Descărcați imagini exemplu',
                    'info' => 'Alegeți unde trebuie găsite imaginile indicate în fișierul dvs.',
                    'recommended' => 'Recomandat',
                    'replace-archive' => 'Alegerea unei arhive noi le înlocuiește.',
                    'title' => 'Imagini produs',
                    'upload-info' => 'Încărcați o singură arhivă care conține toate imaginile. Coloana „images” numește apoi fișierele din ea.',
                    'upload-title' => 'Încărcați o arhivă ZIP cu imagini',
                    'url-info' => 'Introduceți adresa https:// completă a fiecărei imagini în coloana „images”. Sunt descărcate înainte de import, fără a fi nevoie să puneți ceva pe server.',
                    'url-title' => 'Linkuri de imagine în fișier',
                ],
                ...
                'processing-failed' => 'Importul nu a putut fi procesat. Verificați fișierul și încercați din nou.',
        ...
        'roles' => [
            ...
            'create' => [
                ...
                'save-btn' => 'Save Role',
                'search-permissions' => 'Caută permisiuni',
                'title' => 'Create Role',
            ],
        ...
        'index' => [
            ...
            'customer' => [
                ...
                'captcha' => [
                    ...
                    'credentials' => [
                        'api-key' => 'API Key',
                        'api-key-info' => 'After creating the project, you need to create the API keys by navigating to the "Credentials" section in the "APIs & Services" menu.',
                        'project-id' => 'Project ID',
                        'project-id-info' => 'To obtain the API key and secret key, you need to create a project in the Google Cloud console.',
                        'score-threshold' => 'Score Threshold',
                        'score-threshold-info' => 'Set the score threshold for reCAPTCHA v3, ranging from 0.0 to 1.0.',
            ...
            'email' => [
                ...
                'smtp' => [
                    'brevo-api-key' => 'Cheie API Brevo',
                    'brevo-api-key-info' => 'Creați o cheie API v3 în contul dvs. Brevo la SMTP & API.',
                    'driver' => 'Driver',
                    'driver-brevo-api' => 'Brevo (API)',
                    'driver-info' => 'Alegeți modul în care magazinul dvs. trimite e-mailuri.',
                    ...
                    'driver-notice' => 'Notificare driver',
                    'driver-smtp' => 'SMTP',
                    'encryption' => 'Encryption',
                    'host' => 'Host',
                    'info' => 'Alegeți modul în care magazinul dvs. trimite e-mailuri și configurați driverul selectat.',
                    'password' => 'Password',
                    'port' => 'Port',
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'applicable-production' => 'Applies to production mode only',
                    'applicable-sandbox' => 'Applies to test mode only',
                    ...
                    'merchant-private-key' => 'Cheia privată a comerciantului',
                    ...
                    'payglocal-public-key-id-info' => 'ID-ul cheii publice PayGlocal, afișat în panoul PayGlocal.',
                    ...
                    'pending-payment' => 'Pending Payment',
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => 'Configure PhonePe payment method settings.',
                    'phonepe-client-id-info' => 'Enter your PhonePe Client ID obtained from PhonePe dashboard',
                    'phonepe-client-secret-info' => 'Enter your PhonePe Client Secret obtained from PhonePe dashboard',
                    'phonepe-merchant-info' => 'Enter your PhonePe Merchant ID obtained from PhonePe dashboard',
                    'private-key-id' => 'ID-ul cheii private',
                    'processing' => 'Processing',
                ...
                'rma' => [
                    ...
                    'allowed-request-cancelled-request' => 'Permite redeschiderea returnărilor anulate',
                    'allowed-request-declined-request' => 'Permite redeschiderea returnărilor respinse',
                    'allowed-rma-for-product' => 'Allowed Rma For Product',
                    'cancel-items' => 'Cancel-items',
                    'cancelled-request-info' => 'Când este activată, un client poate retrimite o returnare care a fost anulată; aceasta revine la starea "În așteptarea verificării" pentru o nouă evaluare. Când este dezactivată, o returnare anulată este definitivă și nu poate fi redeschisă.',
                    'complete' => 'Complete',
                    ...
                    'declined-request-info' => 'Când este activată, un client poate retrimite o returnare pe care administratorul a respins-o; aceasta revine la starea "În așteptarea verificării" pentru o nouă evaluare. Când este dezactivată, o returnare respinsă este definitivă și nu poate fi redeschisă.',
                    ...
                    'product-type-info' => 'Doar tipurile de produse selectate sunt eligibile pentru RMA. Perioada de returnare este fixată în momentul plasării comenzii, prin urmare modificările de aici se aplică doar comenzilor viitoare.',
                    'resolution-type' => 'Resolution Type',
                    'return' => 'Return/Refund',
                    'return-pickup-address' => 'Return Pickup Address',
                    'return-pickup-time' => 'Return Pickup Time',
                    'return-policy' => 'Return Policy',
                    'return-policy-info' => 'Politica de returnare afișată clienților în magazin înainte ca aceștia să trimită o cerere de returnare.',
                    'specific-products' => 'Specific Products',
                    'title' => 'RMA',
                    'yes' => 'Yes',

                    'setting' => [
                        'info' => 'Stabiliți modul în care funcționează returnările (RMA) în magazinul dvs.: perioada de returnare, tipurile de fișiere atașate permise, tipurile de produse eligibile, politica de returnare afișată clienților și dacă returnările anulate sau respinse pot fi redeschise.',
                        'read' => 'Read Policy',
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                'heading' => 'Hello :name',
                'message' => 'Message',
                'quotes' => 'You have received a new message in your RMA conversation.',
