        ...
        'rma' => [
            'all-rma' => [
                'index' => [
                    ...
                    'datagrid' => [
                        'action-view' => 'Bestellung ansehen',
                        'canceled' => 'Storniert',
                        'closed' => 'Geschlossen',
                        'create' => 'Erstellt am',
                ...
                'view' => [
                    ...
                    'attachment' => 'Anhang',
                    'by' => 'Von',
                    'change-status' => 'Anfragestatus ändern',
                    'close-rma' => 'RMA ist geschlossen',
                    'confirm-item-canceled' => 'Der Status "Artikel storniert" storniert den Artikel. Möchten Sie fortfahren?',
                    'confirm-item-refund' => 'Der Status "Paket erhalten" erstattet den Betrag an den Kunden. Möchten Sie fortfahren?',
                    'confirm-print' => 'Klicken Sie auf OK, um die RMA zu drucken',
                    'cancel-item' => 'Cancel Item',
                    'item-action-note' => 'This action affects the order and cannot be undone.',
                    'order-actions' => 'Order Actions',
                    'refund-item' => 'Refund Item',
                    'conversation-process' => 'Ihre RMA-Anfrage wurde bearbeitet.',
                    'conversations' => 'Konversationen',
                    'customer' => 'Kunde:',
                    'customer-details' => 'Kundendetails',
                    'customer-email' => 'Kunden-E-Mail:',
                    'declined-admin' => 'Anfrage vom Admin abgelehnt',
                    ...
                    'on' => 'Am',
                    'order-date' => 'Bestelldatum:',
                    'order-details' => 'Für RMA angeforderte Artikel',
                    'order-id' => 'Bestellnummer:',
                    'order-status' => 'Lieferstatus:',
                    ...
                    'solved' => 'Gelöst',
                    'solved-by-admin' => 'Vom Admin gelöst',
                    'status' => 'Status',
                    'status-message' => 'Ihr RMA ID #:id Status wurde geändert. Status: :status',
                    'status-reopen' => 'Anfrage erneut öffnen',
                    'title' => 'RMA',
            ...
            'rma-status' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'enabled' => 'Aktiv',
                        'id' => 'ID',
                        'mass-delete-success' => 'Ausgewählte RMA-Status erfolgreich gelöscht.',
            ...
            'reasons' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'enabled' => 'Aktiv',
                        'id' => 'ID',
                        'mass-delete-partial' => ':deleted der ausgewählten Einträge wurden gelöscht; :skipped waren bereits entfernt.',
                        'mass-delete-success' => 'Ausgewählte Daten wurden erfolgreich gelöscht.',
                        'reason-error' => 'Der Grund wird in einer RMA verwendet.',
                        'reason' => 'Grund',
                        'status' => 'Status',
                        'update' => 'Aktualisieren',
                    ],
            ...
            'custom-field' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'created-at' => 'Erstellt am',
                        'delete' => 'Löschen',
                        'delete-success' => 'Benutzerdefinierte Felder wurden erfolgreich gelöscht.',
                        'disabled' => 'Inaktiv',
                        'edit' => 'Bearbeiten',
                        'enabled' => 'Aktiv',
                        'id' => 'ID',
            ...
            'rules' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'edit' => 'Bearbeiten',
                        'enabled' => 'Aktiv',
                        'exchange-period' => 'Umtauschzeitraum (Tage)',
                        'id' => 'ID',
                        'mass-delete-partial' => ':deleted der ausgewählten Einträge wurden gelöscht; :skipped waren bereits entfernt.',
                        'mass-delete-success' => 'Ausgewählte Daten wurden erfolgreich gelöscht.',
                        'name' => 'Name',
            ...
            'create-rma' => [
                ...
                'email' => 'E-Mail',
                'failed' => 'RMA konnte nicht erstellt werden.',
                'image' => 'Bild',
            ...
            'invoice' => [
                'create' => [
                    'order-item-not-found' => 'Bestellartikel nicht gefunden',
                    'rma-created-message' => 'Eine RMA-Anfrage ist für das Produkt mit einer Menge von :qty verfügbar',
                    'rma-has-been-created' => 'RMA wurde erstellt',
                ],
            ],

            'index' => [
                'create-rma-title' => 'Erstellen',
                'reason-title' => 'Gründe',
                'rma-title' => 'Rückgaben',
            ],
        ],
        ...
        'products' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'stock-disabled' => 'Bestand deaktiviert',
                    'status' => 'Status',
                    'type' => 'Typ',
                    'update-status' => 'Status aktualisieren',
                ],
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    ...
                    'action-type-info-buy-x-get-y' => 'Wenn der Kunde X Artikel kauft, erhält er Y zusätzliche Artikel kostenlos.',
                    'action-type-info-by-fixed' => 'Wendet einen festen Rabatt pro passendem Artikel an.',
                    'action-type-info-by-percent' => 'Wendet einen prozentualen Rabatt auf passende Artikel an.',
                    'action-type-info-cart-fixed' => 'Wendet einen festen Rabatt auf den gesamten Warenkorb an.',
                    'actions' => 'Aktionen',
                    ...
                    'apply-to-shipping-disabled-info' => 'Gilt nur für prozentuale und Festbetragsrabatte.',
                    'attribute-family' => 'Attributfamilie',
                    ...
                    'auto-generate-info' => 'Coupon-Codes können nach dem Speichern der Regel auf der Bearbeitungsseite generiert werden.',
                    'back-btn' => 'Zurück',
                    ...
                    'description' => 'Beschreibung',
                    'discount-amount' => 'Rabattbetrag',
                    'discount-percent' => 'Rabatt-Prozentsatz (%)',
                    ...
                    'free-quantity' => 'Kostenlose Menge (Y)',
                    'from' => 'Von',
                    'general' => 'Allgemein',
                    ...
                    'maximum-discounted-quantity' => 'Maximale rabattierte Menge',
                    'maximum-discounted-quantity-info' => 'Begrenzt, wie viele Einheiten jedes passenden Artikels den Rabatt erhalten.',
                    'maximum-eligible-quantity-info' => 'Begrenzt, wie viele Einheiten dieses Artikels am "Kaufe X, erhalte Y"-Angebot teilnehmen.',
                    'maximum-eligible-quantity' => 'Maximale berechtigte Menge',
                    'name' => 'Name',
                    'no' => 'Nein',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name (nur Hauptkategorien)',
                    'auto-generate-coupon' => 'Coupon automatisch generieren',
                    'auto-generate-banner-description' => 'Erstellen Sie in einem Schritt einzigartige Coupon-Codes für diese Regel.',
                    'auto-generate-banner-title' => 'Automatische Generierung aktiviert',
                    'back-btn' => 'Zurück',
                    'buy-x-get-y-free' => 'Kaufe X, erhalte Y kostenlos',
                    'buy-x-quantity' => 'Kaufe X Menge',
                    'cart-attribute' => 'Warenkorb-Attribut',
                    ...
                    'general' => 'Allgemein',
                    'generate' => 'Generieren',
                    'generate-coupons' => 'Coupons generieren',
                    'generate-here' => 'Jetzt generieren',
                    'generated-coupons' => 'Generierte Coupons',
                    'greater-than' => 'Größer als',
                    'is-equal-to' => 'Ist gleich',
                    'is-not-equal-to' => 'Ist nicht gleich',
                    'less-than' => 'Kleiner als',
    ...
    'appearance' => [
        'themes' => [
            'index' => [
                ...
                'activate-success' => ':theme ist jetzt auf :channel aktiv.',
                'active' => 'Aktiv',
                'active-on' => 'Aktiv auf:',
                'active-on-all' => 'Auf allen Kanälen aktiv',
                'buy-btn' => 'Ansehen & kaufen',
                'buy-themes' => 'Themes kaufen',
                'by' => 'von',
                'customize-btn' => 'Anpassen',
                'info' => 'Durchsuchen Sie die für Ihren Shop verfügbaren Themes und wählen Sie aus, welches jeder Kanal verwendet.',
                'my-themes' => 'Meine Themes',
                'not-in-use' => 'Nicht in Verwendung',
                'not-installed' => 'Dieses Theme ist in diesem Shop nicht installiert.',
                'preview-btn' => 'Vorschau',
                'title' => 'Themes',

                'activate' => [
                    'channels' => 'Kanäle',
                    'channels-hint' => 'Halten Sie Strg (Cmd auf dem Mac) gedrückt, um mehrere Kanäle auszuwählen.',
                    'confirm-btn' => 'Aktivieren',
                    'info' => 'Wählen Sie die Kanäle, die :theme verwenden sollen.',
                    'title' => 'Theme aktivieren',
                    'warning' => ':channel hat :count Anpassungen für :theme. Sie bleiben gespeichert, erscheinen aber nicht, solange das neue Theme aktiv ist.',
                ],
            ],
        ],
        'sections' => [
            ...
            'edit' => [
                ...
                'asc' => 'aufsteigend',
                'back' => 'Zurück',
                'brand-add-btn' => 'Marke hinzufügen',
                'brand-logo' => 'Markenlogo',
                'brand-name' => 'Markenname',
                'brands' => 'Marken',
                'chapter' => 'Kapitel',
                'chapter-engine' => 'Motor',
                'chapter-figures' => 'Kennzahlen',
                'chapter-protection' => 'Schutz',
                'chapter-viscosity' => 'Viskosität',
                'category-carousel' => 'Kategorie Karussell',
            ...
            'create-success' => 'Abschnitt erfolgreich erstellt',
            'delete-success' => 'Abschnitt erfolgreich gelöscht',
            'update-success' => 'Abschnitt erfolgreich aktualisiert',
        ],
    ],
    ...
    'reporting' => [
        'sales' => [
            'index' => [
                ...
                'sales-by-coupon' => 'Verkäufe nach Gutschein',
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'import-confirmation' => 'Der Import startet unmittelbar nach dem Speichern. Möchten Sie fortfahren?',
                    'process-in-queue' => 'In der Warteschlange verarbeiten',
                    'results' => 'Ergebnisse',
                    'save-btn' => 'Importieren',
                    'settings' => 'Einstellungen',
                ...
                'import' => [
                    ...
                    'deleting-info' => 'Löschvorgang läuft',
                    'download-error-report' => 'Vollständigen Bericht herunterladen',
                    'downloading-info' => 'Bilder werden heruntergeladen',
                    'edit-btn' => 'Bearbeiten',
                    'failed-batches' => ':count Stapel wurden nicht abgeschlossen. Prüfen Sie das Fehlerprotokoll und starten Sie den Import für diese Zeilen erneut.',
                    'images-downloaded' => 'Heruntergeladene Bilder:',
                    'images-progress' => 'Bilder heruntergeladen',
                    ...
                    'rows-validated' => 'Zeilen validiert',
                    'step-create' => 'Erstellen',
                    'step-delete' => 'Löschen',
                    'step-download' => 'Bilder',
                    'step-index' => 'Indexierung',
                    'step-link' => 'Verknüpfen',
                    'step-validate' => 'Validieren',
                    'title' => 'Import',
                    ...
                    'validation-partial-info' => 'Ihr Import kann fortgesetzt werden, einige Zeilen werden jedoch übersprungen. Prüfen Sie die Fehler unten oder laden Sie den vollständigen Bericht herunter.',
                    'validation-success-info' => 'Ihr Import ist gültig. Klicken Sie auf "Importieren", um den Importvorgang zu starten.',
                ],

                'images' => [
                    'current-archive' => 'Derzeit hochgeladen: :name — :count Bild(er) bereit.',
                    'current-images' => 'Für diesen Import sind bereits :count Bild(er) hochgeladen.',
                    'directory-example' => 'Im Fall von product-images müssen die Dateien beispielsweise im Ordner /project-root/storage/app/import/product-images liegen.',
                    'directory-hint' => 'Verwenden Sie den relativen Pfad zu /project-root/storage/app/import, z. B. product-images, import-images.',
                    'directory-info' => 'Wenn Sie Zugriff auf die Codebasis haben, legen Sie die Bilder in einem Ordner auf dem Server ab und geben Sie diesen Ordner unten an.',
                    'directory-placeholder' => 'Pfad zum Bilderverzeichnis',
                    'directory-title' => 'Bilder liegen bereits auf dem Server',
                    'download-sample-zip' => 'Beispielbilder herunterladen',
                    'info' => 'Wählen Sie aus, wo die in Ihrer Datei genannten Bilder gefunden werden sollen.',
                    'recommended' => 'Empfohlen',
                    'replace-archive' => 'Ein neues Archiv ersetzt sie.',
                    'title' => 'Produktbilder',
                    'upload-info' => 'Laden Sie ein einzelnes Archiv mit allen Bildern hoch. Die Spalte „images“ nennt dann die darin enthaltenen Dateien.',
                    'upload-title' => 'ZIP-Archiv mit Bildern hochladen',
                    'url-info' => 'Geben Sie die vollständige https://-Adresse jedes Bildes in der Spalte „images“ an. Sie werden vor dem Import heruntergeladen, sodass vorher nichts auf dem Server abgelegt werden muss.',
                    'url-title' => 'Bildlinks in der Datei',
                ],
                ...
                'processing-failed' => 'Der Import konnte nicht verarbeitet werden. Bitte überprüfen Sie die Datei und versuchen Sie es erneut.',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'brevo-api-key' => 'Brevo-API-Schlüssel',
                    'brevo-api-key-info' => 'Erstellen Sie in Ihrem Brevo-Konto unter SMTP & API einen v3-API-Schlüssel.',
                    'driver' => 'Treiber',
                    'driver-brevo-api' => 'Brevo (API)',
                    'driver-info' => 'Wählen Sie, wie Ihr Shop E-Mails versendet.',
                    'driver-mismatch-info' => 'Ihr Mail-Treiber ist auf ":driver" statt auf "bagisto-dynamic-smtp" eingestellt. Alle hier vorgenommenen Änderungen haben keine Auswirkung. Bitte aktualisieren Sie MAIL_MAILER=bagisto-dynamic-smtp in Ihrer .env-Datei, um diese Einstellungen zu aktivieren.',
                    'driver-mismatch-title' => 'Diese Einstellungen sind derzeit inaktiv.',
                    'driver-notice' => 'Treiber-Hinweis',
                    'driver-smtp' => 'SMTP',
                    'encryption' => 'Verschlüsselung',
                    'host' => 'Host',
                    'info' => 'Wählen Sie, wie Ihr Shop E-Mails versendet, und konfigurieren Sie den gewählten Treiber.',
                    'password' => 'Passwort',
                    'port' => 'Port',
                    'title' => 'Mail-Treiber',
                ...
                'email-settings' => [
                    ...
                    'admin-email-tip' => 'Alle Admin-Benachrichtigungen für diesen Kanal werden an diese Adresse gesendet.',
                    'admin-name' => 'Admin Name',
                    'admin-name-tip' => 'Dieser Name erscheint in allen E-Mails, die an den Admin gesendet werden.',
                    'admin-page-limit' => 'Standard Elemente pro Seite (Admin)',
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'applicable-production' => 'Gilt nur für Produktionsmodus',
                    'applicable-sandbox' => 'Gilt nur für Testmodus',
                    ...
                    'merchant-private-key' => 'Privater Schlüssel des Händlers',
                    ...
                    'paid' => 'Bezahlt',
                    'payglocal' => 'PayGlocal',
                    'payglocal-info' => 'Akzeptieren Sie grenzüberschreitende Zahlungen über PayGlocal. <a href="https://dashboard.payglocal.in/app/mca/h8271x" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline hover:text-blue-700">Registrieren Sie sich hier, um Ihre Zugangsdaten zu erhalten.</a>',
                    'payglocal-merchant-id-info' => 'Im PayGlocal-Dashboard unter My Account verfügbar.',
                    'payglocal-private-key-id-info' => 'Die im PayGlocal-Dashboard angezeigte ID Ihres privaten Schlüssels.',
                    'payglocal-public-key' => 'Öffentlicher Schlüssel von PayGlocal',
                    'payglocal-public-key-id-info' => 'Die im PayGlocal-Dashboard angezeigte ID des öffentlichen PayGlocal-Schlüssels.',
                    ...
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => 'Konfigurieren Sie die PhonePe-Zahlungsmethodeneinstellungen.',
                    'phonepe-client-id-info' => 'Geben Sie Ihre PhonePe-Client-ID ein, die vom PhonePe-Dashboard erhalten wurde',
                    'phonepe-client-secret-info' => 'Geben Sie Ihr PhonePe-Client-Geheimnis ein, das vom PhonePe-Dashboard erhalten wurde',
                    'phonepe-merchant-info' => 'Geben Sie Ihre PhonePe-Handels-ID ein, die vom PhonePe-Dashboard erhalten wurde',
                ...
                'rma' => [
                    ...
                    'allow-product-type-for-rma' => 'Erlaube Produkttyp für RMA',
                    'allow-rma-for-digital-product' => 'RMA für digitales Produkt zulassen',
                    'allowed-file-extension' => 'Erlaubte Dateierweiterung',
                    'allowed-file-types' => 'Bitte wählen Sie nur die Dateitypen :allowed_types',
                    'allowed-info' => 'Durch Kommas getrennt. Zum Beispiel: jpg,jpeg,pdf',
                    'allowed-request-cancelled-request' => 'Erneutes Öffnen stornierter Rücksendungen zulassen',
                    'allowed-request-declined-request' => 'Erneutes Öffnen abgelehnter Rücksendungen zulassen',
                    'allowed-rma-for-product' => 'RMA für Produkt zulassen',
                    'cancel-items' => 'Artikel stornieren',
                    'cancelled-request-info' => 'Wenn aktiviert, kann ein Kunde eine stornierte Rücksendung erneut einreichen; sie wechselt zur erneuten Prüfung zurück in den Status "Prüfung ausstehend". Wenn deaktiviert, ist eine stornierte Rücksendung endgültig und kann nicht erneut geöffnet werden.',
                    ...
                    'declined-request-info' => 'Wenn aktiviert, kann ein Kunde eine vom Administrator abgelehnte Rücksendung erneut einreichen; sie wechselt zur erneuten Prüfung zurück in den Status "Prüfung ausstehend". Wenn deaktiviert, ist eine abgelehnte Rücksendung endgültig und kann nicht erneut geöffnet werden.',
                    ...
                    'product-type-info' => 'Nur die ausgewählten Produkttypen kommen für eine RMA infrage. Der Rücksendezeitraum wird bei der Bestellung festgelegt, daher gelten Änderungen hier nur für zukünftige Bestellungen.',
                    'resolution-type' => 'Lösungstyp',
                    'return' => 'Rückgabe/Erstattung',
                    'return-pickup-address' => 'Rückholadresse',
                    'return-pickup-time' => 'Rückholzeit',
                    'return-policy' => 'Rückgaberecht',
                    'return-policy-info' => 'Die Rückgaberichtlinie, die Kunden im Onlineshop angezeigt wird, bevor sie eine Rücksendeanfrage einreichen.',
                    'specific-products' => 'Spezifische Produkte',
                    'title' => 'RMA',
                    'yes' => 'Ja',

                    'setting' => [
                        'info' => 'Legen Sie fest, wie Rücksendungen (RMA) in Ihrem Shop funktionieren: der Rücksendezeitraum, die zulässigen Anhang-Dateitypen, die infrage kommenden Produkttypen, die den Kunden angezeigte Rückgaberichtlinie und ob stornierte oder abgelehnte Rücksendungen erneut geöffnet werden können.',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'currencies' => 'Währungen',
                'custom-fields' => 'Benutzerdefiniertes Feld',
                'customers' => 'Kunden',
                'dashboard' => 'Dashboard',
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                'heading' => 'Hallo :name',
                'message' => 'Nachricht',
                'quotes' => 'Sie haben eine neue Nachricht in Ihrer RMA-Konversation erhalten.',
