...
return [
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Tudo o que você precisa para aproveitar ao máximo o Bagisto — hospedagem, suporte e serviços profissionais, além de extensões e documentação para desenvolvedores.',

            'services-title' => 'Serviços',
            'resources-title' => 'Recursos e Documentação',

            'cloud-hosting' => 'Hospedagem em Nuvem',
            'cloud-hosting-info' => 'Hospedagem em nuvem gerenciada e econômica — lance sua loja Bagisto na nuvem em minutos, totalmente otimizada e escalável.',

            'support' => 'Suporte e Manutenção',
            'support-info' => 'Suporte técnico dedicado e planos de manutenção contínua para manter sua loja segura, atualizada e funcionando sem problemas.',

            'paid-services' => 'Serviços Pagos',
            'paid-services-info' => 'Ajuda especializada para integração de módulos, personalização, migração de dados, atualizações de versão e desenvolvimento sob medida.',

            'extensions' => 'Extensões',
            'extensions-info' => 'Explore complementos oficiais e da comunidade para estender o Bagisto com novos conectores, canais e recursos.',

            'docs' => 'Documentação Dev e Blogs',
            'docs-info' => 'Guias para desenvolvedores, tutoriais e os artigos mais recentes para ajudá-lo a construir, configurar e se manter atualizado.',

            'api-docs' => 'Documentação da API',
            'api-docs-info' => 'Referência completa das APIs REST e GraphQL com endpoints, autenticação e exemplos para integrar o Bagisto à sua stack.',

            'community' => 'Fórum da Comunidade',
            'community-info' => 'Faça perguntas, compartilhe ideias e conecte-se com milhares de desenvolvedores e lojistas do Bagisto em todo o mundo.',

            'video-tutorials' => 'Tutoriais em Vídeo',
            'video-tutorials-info' => 'Tutoriais em vídeo passo a passo abrangendo instalação, configuração e gerenciamento diário da loja.',

            'cta-title' => 'Ainda precisa de ajuda?',
            'cta-description' => 'Fale com a equipe do Bagisto sobre hospedagem, desenvolvimento personalizado ou qualquer outra coisa.',
        ...
        'rma' => [
            'all-rma' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'order-status' => 'Status de entrega',
                        'return-window' => 'Período de devolução',
                ...
                'view' => [
                    ...
                    'attachment' => 'Anexo',
                    'by' => 'Por',
                    'change-status' => 'Alterar status da solicitação',
                    'close-rma' => 'RMA está fechado',
                    'confirm-item-canceled' => 'O status Item cancelado irá cancelar o item. Deseja continuar?',
                    'confirm-item-refund' => 'O status Pacote recebido irá reembolsar o valor ao cliente. Deseja continuar?',
                    ...
                    'conversation-process' => 'Sua solicitação de RMA foi processada.',
                    'conversations' => 'Conversas',
                    'customer' => 'Cliente :',
                    'customer-details' => 'Detalhes do cliente',
                    'customer-email' => 'E-mail do cliente :',
                    'declined-admin' => 'Solicitação recusada pelo administrador',
                    ...
                    'on' => 'Em',
                    'order-date' => 'Data do pedido :',
                    'order-details' => 'Itens solicitados para RMA',
                    'order-id' => 'ID do pedido :',
                    'order-status' => 'Status de entrega :',
                    'order-total' => 'Total do pedido :',
                    'price' => 'Preço :',
                    'refund-creation-error' => 'Não foi possível criar o reembolso para este pedido.',
                    ...
                    'solved' => 'Resolvido',
                    'solved-by-admin' => 'Resolvido pelo administrador',
                    'status' => 'Status',
                    'status-message' => 'O status do seu RMA ID #:id foi alterado. Status: :status',
                    'status-reopen' => 'Reabrir solicitação',
                    'title' => 'RMA',
            ...
            'rma-status' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'created-at' => 'Criado em',
                        'delete' => 'Excluir',
                        'delete-success' => 'Status do RMA excluído com sucesso.',
                        'disabled' => 'Inativo',
                        'edit' => 'Editar',
                        'enabled' => 'Ativo',
                        'id' => 'ID',
                        'mass-delete-success' => 'Os status de RMA selecionados foram excluídos com sucesso.',
                        'reason-error' => 'O status do RMA está sendo usado em um RMA.',
                        'reason' => 'Status do RMA',
                        'status' => 'Status',
                        'title' => 'Título',
                        'update' => 'Atualizar',
                    ],
            ...
            'reasons' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'enabled' => 'Ativo',
                        'id' => 'ID',
                        'mass-delete-partial' => ':deleted dos registros selecionados foram excluídos; :skipped já haviam sido removidos.',
                        'mass-delete-success' => 'Os dados selecionados foram excluídos com sucesso.',
                        'reason-error' => 'O motivo está sendo usado em um RMA.',
                        'reason' => 'Motivo',
                        'status' => 'Status',
                        'update' => 'Atualizar',
                    ],
            ...
            'rules' => [
                'index' => [
                    ...
                    'datagrid' => [
                        'delete' => 'Excluir',
                        'delete-success' => 'As regras de RMA foram excluídas com sucesso.',
                        'disabled' => 'Inativo',
                        'edit' => 'Editar',
                        'enabled' => 'Ativo',
                        ...
                        'name' => 'Nome',
                        'reason' => 'Regras',
                        'return-period' => 'Período de devolução (dias)',
                        'status' => 'Status',
                        'update' => 'Atualizar',
                    ],
                ],
            ...
            'invoice' => [
                'create' => [
                    ...
                    'rma-has-been-created' => 'RMA foi criado com sucesso',
                ],
            ],
        ...
        'products' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'sku' => 'SKU',
                    'sku-value' => 'SKU - :sku',
                    'stock-disabled' => 'Estoque desativado',
                    'status' => 'Status',
                    'type' => 'Tipo',
                    'update-status' => 'Atualizar Status',
                ],
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    ...
                    'action-type-info-buy-x-get-y' => 'Quando o cliente compra X itens, Y itens adicionais são gratuitos.',
                    'action-type-info-by-fixed' => 'Aplica um desconto fixo a cada item correspondente.',
                    'action-type-info-by-percent' => 'Aplica um desconto percentual aos itens correspondentes.',
                    'action-type-info-cart-fixed' => 'Aplica um desconto fixo ao carrinho inteiro.',
                    'actions' => 'Ações',
                    ...
                    'apply-to-shipping-disabled-info' => 'Aplica-se apenas a descontos percentuais e de valor fixo.',
                    'attribute-family' => 'Família de Atributos',
                    ...
                    'auto-generate-info' => 'Os códigos de cupom podem ser gerados na página de edição da regra após salvar.',
                    'back-btn' => 'Voltar',
                    ...
                    'free-quantity' => 'Quantidade Gratuita (Y)',
                    'from' => 'De',
                    'general' => 'Geral',
                    ...
                    'maximum-discounted-quantity' => 'Quantidade Máxima com Desconto',
                    'maximum-discounted-quantity-info' => 'Limita quantas unidades de cada item correspondente recebem o desconto.',
                    'maximum-eligible-quantity-info' => 'Limita quantas unidades deste item participam da oferta Compre X Leve Y.',
                    'maximum-eligible-quantity' => 'Quantidade Máxima Elegível',
                    'name' => 'Nome',
                    'no' => 'Não',
                    'no-coupon' => 'Sem Cupom',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name (Somente Categorias Principais)',
                    'auto-generate-coupon' => 'Gerar Cupom Automaticamente',
                    'auto-generate-banner-description' => 'Crie em massa códigos de cupom exclusivos para esta regra.',
                    'auto-generate-banner-title' => 'Geração automática ativada',
                    'back-btn' => 'Voltar',
                    'buy-x-get-y-free' => 'Compre X e Leve Y de Graça',
                    'buy-x-quantity' => 'Compre X Quantidade',
                    'cart-attribute' => 'Atributo do Carrinho',
                    ...
                    'generate-here' => 'Gerar agora',
                    'generated-coupons' => 'Cupons Gerados',
                    'greater-than' => 'Maior Que',
                    'is-equal-to' => 'É Igual a',
                    'is-not-equal-to' => 'Não é Igual a',
                    'less-than' => 'Menor Que',
    ...
    'appearance' => [
        'themes' => [
            'index' => [
                'activate-btn' => 'Ativar',
                'activate-success' => ':theme agora está ativo em :channel.',
                'active' => 'Ativo',
                'active-on' => 'Ativo em:',
                'active-on-all' => 'Ativo em todos os canais',
                'buy-btn' => 'Ver e comprar',
                'buy-themes' => 'Comprar temas',
                'by' => 'por',
                'customize-btn' => 'Personalizar',
                'info' => 'Explore os temas disponíveis para a sua loja e escolha qual cada canal usa.',
                'my-themes' => 'Meus temas',
                'not-in-use' => 'Sem uso',
                'not-installed' => 'Este tema não está instalado nesta loja.',
                'preview-btn' => 'Pré-visualizar',
                'title' => 'Temas',

                'activate' => [
                    'channels' => 'Canais',
                    'channels-hint' => 'Segure Ctrl (Cmd no Mac) para escolher mais de um canal.',
                    'confirm-btn' => 'Ativar',
                    'info' => 'Escolha os canais que devem passar a usar :theme.',
                    'title' => 'Ativar tema',
                    'warning' => ':channel tem :count personalizações criadas para :theme. Elas continuam salvas, mas não aparecerão enquanto o novo tema estiver ativo.',
                ],
            ],
        ],
        'sections' => [
            'index' => [
                'all-filters-used' => 'Todos os filtros disponíveis já foram adicionados.',
                'channel' => 'Canal',
                'copy-suffix' => 'Cópia',
                'create-btn' => 'Criar seção',
                'delete-confirm' => 'Tem certeza de que deseja excluir esta seção?',
                'desktop' => 'Desktop',
                ...
                'scoped-to' => 'Mostrando as seções do tema :theme no canal :channel.',
                'tablet' => 'Tablet',
                'title' => 'Seções',
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'story-chapter' => 'Capítulo da história',
                    'title' => 'Tipo',
                ],
            ],
            ...
            'edit' => [
                ...
                'asc' => 'crescente',
                'back' => 'Voltar',
                'brand-add-btn' => 'Adicionar marca',
                'brand-logo' => 'Logotipo da marca',
                'brand-name' => 'Nome da marca',
                'brands' => 'Marcas',
                'chapter' => 'Capítulo',
                'chapter-engine' => 'Motor',
                'chapter-figures' => 'Números',
                'chapter-protection' => 'Proteção',
                'chapter-viscosity' => 'Viscosidade',
                'category-carousel' => 'Carrossel de Categoria',
            ...
            'create-success' => 'Seção criada com sucesso',
            'delete-success' => 'Seção excluída com sucesso',
            'update-success' => 'Seção atualizada com sucesso',
        ],
    ],
    ...
    'reporting' => [
        'sales' => [
            'index' => [
                ...
                'sales-by-coupon' => 'Vendas por Cupom',
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'import-confirmation' => 'A importação começará assim que isto for salvo. Deseja continuar?',
                ...
                'import' => [
                    ...
                    'deleting-info' => 'Exclusão em andamento',
                    'download-error-report' => 'Baixar Relatório Completo',
                    'downloading-info' => 'Baixando imagens',
                    'edit-btn' => 'Editar',
                    'failed-batches' => ':count lotes não foram concluídos. Verifique o log de erros e execute a importação novamente para essas linhas.',
                    'images-downloaded' => 'Imagens baixadas:',
                    'images-progress' => 'imagens baixadas',
                    ...
                    'progress' => 'Progresso:',
                    'rows-validated' => 'linhas validadas',
                    'step-create' => 'Criar',
                    'step-delete' => 'Excluir',
                    'step-download' => 'Imagens',
                    'step-index' => 'Indexar',
                    'step-link' => 'Vincular',
                    ...
                    'validation-partial-info' => 'Sua importação pode continuar, mas algumas linhas serão ignoradas. Revise os erros abaixo ou baixe o relatório completo.',
                    'validation-success-info' => 'Sua importação é válida. Clique em Importar para iniciar o processo de importação.',
                ],

                'images' => [
                    'current-archive' => 'Enviado atualmente: :name — :count imagem(ns) pronta(s).',
                    'current-images' => 'Já há :count imagem(ns) enviada(s) para esta importação.',
                    'directory-example' => 'Por exemplo, no caso de product-images, os arquivos devem estar na pasta /project-root/storage/app/import/product-images.',
                    'directory-hint' => 'Use o caminho relativo a /project-root/storage/app/import, por ex. product-images, import-images.',
                    'directory-info' => 'Se você tem acesso ao código, coloque as imagens em uma pasta no servidor e informe essa pasta abaixo.',
                    'directory-placeholder' => 'Caminho do diretório de imagens',
                    'directory-title' => 'Imagens já no servidor',
                    'download-sample-zip' => 'Baixar imagens de exemplo',
                    'info' => 'Escolha onde as imagens indicadas no seu arquivo devem ser encontradas.',
                    'recommended' => 'Recomendado',
                    'replace-archive' => 'Escolher um novo arquivo as substitui.',
                    'title' => 'Imagens dos produtos',
                    'upload-info' => 'Envie um único arquivo compactado com todas as imagens. A coluna «images» então nomeia os arquivos contidos nele.',
                    'upload-title' => 'Enviar um ZIP de imagens',
                    'url-info' => 'Informe o endereço https:// completo de cada imagem na coluna «images». Elas são baixadas antes da importação, sem precisar colocar nada no servidor.',
                    'url-title' => 'Links de imagem no arquivo',
                ],
                ...
                'processing-failed' => 'Não foi possível processar a importação. Verifique o arquivo e tente novamente.',
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                'info' => 'Configurações gerais de unidades, conteúdo, design, taxas de câmbio, sitemap e GDPR.',
                'title' => 'Geral',

                'general' => [
                    'info' => 'Configurações de unidades e trilha de navegação da loja.',
                    'title' => 'Geral',
                ...
                'content' => [
                    'info' => 'Faixa de oferta, linha de direitos autorais, regras de especulação e scripts personalizados.',
                    'title' => 'Conteúdo',
                    ...
                    'copyright-content' => [
                        ...
                        'info' => 'A linha de direitos autorais exibida no rodapé da loja.',
                    ],
                    ...
                    'custom-scripts' => [
                        ...
                        'title-info' => 'CSS e JavaScript adicionados a todas as páginas da loja.',
                    ],
                ],

                'design' => [
                    'info' => 'Logotipo e favicon do painel administrativo, e como as categorias do menu da loja são exibidas.',
                    'title' => 'Design',
                    ...
                    'admin-logo' => [
                        ...
                        'title-info' => 'O logotipo e o favicon exibidos no painel administrativo e nos e-mails enviados ao administrador.',
                    ],
                ...
                'gdpr' => [
                    'title' => 'GDPR',
                    'info' => 'Aviso de cookies, categorias de consentimento e o acordo de privacidade exibido aos clientes.',

                    'settings' => [
                        'title' => 'Configurações de conformidade com GDPR',
                        'info' => 'Ativar ou desativar os recursos de GDPR para este canal.',
                        'enabled' => 'Ativar GDPR',
                    ],
                ...
                'sitemap' => [
                    'info' => 'Geração de sitemap e limites de arquivo.',
                    'title' => 'Sitemap',
                    ...
                    'file-limits' => [
                        'info' => 'O número máximo de URLs gravadas em um arquivo de sitemap antes de iniciar outro.',
            ...
            'magic-ai' => [
                'info' => 'Configure as configurações, provedores e recursos do Magic AI.',
                'title' => 'Magic AI',

                'general' => [
                    'info' => 'Configurações gerais do Magic AI.',
                    'title' => 'Geral',

                    'settings' => [
                        'enabled' => 'Habilitado',
                        'title' => 'Configurações',
                        'title-info' => 'Habilitar ou desabilitar o Magic AI em toda a aplicação.',
                    ],
                ],

                'providers' => [
                    'api-key' => 'Chave API',
                    'info' => 'Configure as chaves API para seus provedores de IA.',
                    'title' => 'Provedores',

                    'openai' => [
                        'title' => 'OpenAI',
                        'title-info' => 'Configure suas credenciais de API do OpenAI.',
                    ],

                    'anthropic' => [
                        'title' => 'Anthropic',
                        'title-info' => 'Configure suas credenciais de API do Anthropic.',
                    ],

                    'gemini' => [
                        'title' => 'Gemini',
                        'title-info' => 'Configure suas credenciais de API do Google Gemini.',
                    ],

                    'groq' => [
                        'title' => 'Groq',
                        'title-info' => 'Configure suas credenciais de API do Groq.',
                    ],

                    'xai' => [
                        'title' => 'xAI',
                        'title-info' => 'Configure suas credenciais de API do xAI.',
                    ],

                    'deepseek' => [
                        'title' => 'DeepSeek',
                        'title-info' => 'Configure suas credenciais de API do DeepSeek.',
                    ],

                    'mistral' => [
                        'title' => 'Mistral',
                        'title-info' => 'Configure suas credenciais de API do Mistral.',
                    ],
                ...
                'admin-features' => [
                    'info' => 'Habilitar e configurar recursos de IA para o painel administrativo.',
                    ...
                    'text-generation' => [
                        ...
                        'title-info' => 'Habilitar a geração de texto por IA nos editores WYSIWYG do painel administrativo.',
                    ],
                    ...
                    'image-generation' => [
                        ...
                        'title-info' => 'Habilitar a geração de imagens por IA para imagens de produtos e conteúdo.',
                    ],
                ],
                ...
                'storefront-features' => [
                    ...
                    'review-translation' => [
                        'enabled' => 'Habilitado',
                        'model' => 'Modelo',
                        'title' => 'Tradução de avaliações',
                        'title-info' => 'Permitir que os clientes traduzam avaliações para seu idioma na loja.',
                    ],
                    ...
                    'checkout-message' => [
                        ...
                        'title-info' => 'Gerar mensagens de checkout personalizadas para os clientes na página de agradecimento.',
                    ],
                ],
            ],

            'catalog' => [
                'info' => 'Configurações de produtos, rich snippets e estoque.',
                'title' => 'Catálogo',

                'products' => [
                    'info' => 'Páginas de produto e carrinho, busca, tamanhos de imagem, avaliações, atributos e compartilhamento.',
                    'title' => 'Produtos',
                    ...
                    'settings' => [
                        ...
                        'title' => 'Configurações',
                        'title-info' => 'Ativar ou desativar a comparação de produtos e a busca por imagem.',
                    ...
                    'product-view-page' => [
                        ...
                        'title-info' => 'Quantos produtos relacionados e de venda superior são exibidos na página do produto.',
                    ],
                    ...
                    'cart-view-page' => [
                        ...
                        'title-info' => 'Quantos produtos de venda cruzada são exibidos na página do carrinho.',
                    ],
                    ...
                    'review' => [
                        ...
                        'summary' => 'Resumo',
                        'title' => 'Avaliação',
                        'title-info' => 'Quem pode avaliar um produto e como as avaliações aparecem na página do produto.',
                    ],
                    ...
                    'attribute' => [
                        ...
                        'title' => 'Atributo',
                        'title-info' => 'O tamanho máximo de imagem e arquivo que pode ser enviado para um valor de atributo.',
                    ],

                    'social-share' => [
                        'title-info' => 'Escolha quais botões de compartilhamento aparecem na página do produto e a mensagem que eles levam.',
                        ...
                        'enable-share-whatsapp-info' => 'O link de compartilhamento do WhatsApp aparece apenas em dispositivos móveis.',
                        'enable-share-whatsapp' => 'Ativar compartilhamento no WhatsApp?',
                        'enable-share-twitter' => 'Ativar compartilhamento no X (Twitter)?',
                ...
                'rich-snippets' => [
                    'info' => 'Dados estruturados adicionados às páginas da loja para os buscadores.',
                    'title' => 'Rich Snippets',
                    ...
                    'products' => [
                        ...
                        'title' => 'Produtos',
                        'title-info' => 'Escolha quais detalhes do produto são incluídos nos dados estruturados.',
                    ],
                    ...
                    'categories' => [
                        ...
                        'title' => 'Categorias',
                        'title-info' => 'Adicionar dados estruturados de categoria às páginas da loja para que os buscadores possam lê-los.',
                    ],
                ],
                ...
                'inventory' => [
                    ...
                    'product-stock-options' => [
                        ...
                        'info' => 'Permitir pedidos sem estoque e definir a quantidade a partir da qual o produto é considerado esgotado.',
                    ],
                ],
            ],

            'customer' => [
                'info' => 'Configurações de endereços, captcha e contas de cliente.',
                'title' => 'Cliente',
                ...
                'address' => [
                    ...
                    'requirements' => [
                        ...
                        'state' => 'Estado',
                        'title' => 'Requisitos',
                        'title-info' => 'Quais campos de endereço o cliente deve preencher.',
                        'zip' => 'CEP',
                    ],
                    ...
                    'information' => [
                        ...
                        'title' => 'Informação',
                        'title-info' => 'Quantas linhas de endereço o formulário exibe.',
                    ],
                ],

                'captcha' => [
                    'info' => 'Chaves e status do Google reCAPTCHA Enterprise.',
                    'title' => 'Google Captcha',

                    'credentials' => [
                        'api-key' => 'Chave API',
                        'api-key-info' => 'Após criar o projeto, você precisa criar as chaves da API navegando até a seção "Credenciais" no menu "APIs e serviços".',
                        'project-id' => 'ID do projeto',
                        'project-id-info' => 'Para obter a chave da API e a chave secreta, você precisa criar um projeto no console do Google Cloud.',
                        'score-threshold' => 'Limite de pontuação',
                        'score-threshold-info' => 'Defina o limite de pontuação para o reCAPTCHA v3, variando de 0.0 a 1.0.',
                        'secret-key' => 'Chave secreta',
                        'site-key' => 'Chave do site',
                        'site-key-info' => 'Depois de criar o projeto e a chave da API, procure o serviço "reCAPTCHA" na biblioteca e gere as chaves do "reCAPTCHA".',
                        'status' => 'Status',
                        'title' => 'Credenciais',
                        'title-info' => 'Credenciais do Google reCAPTCHA Enterprise e a pontuação que uma requisição precisa atingir para ser aceita.',
                    ],
                ...
                'settings' => [
                    'settings-info' => 'Defina lista de desejos, redirecionamento após login, opções de nova conta, newsletter, verificação de e-mail e login social.',
                    'title' => 'Configurações',
                    ...
                    'newsletter' => [
                        ...
                        'subscription-info' => 'Exibir um formulário de inscrição no rodapé da loja.',
                        'title' => 'Assinatura de Newsletter',
                        'title-info' => 'Inscrição na newsletter na loja.',
                    ],

                    'email' => [
                        'email-verification' => 'Permitir Verificação de E-mail',
                        'title' => 'Verificação de E-mail',
                        'title-info' => 'Pedir que um novo cliente confirme seu e-mail antes de poder entrar.',
                    ],

                    'social-login' => [
                        'title' => 'Login Social',
                        'info' => 'Permitir que clientes entrem com uma conta externa. Cada provedor precisa do próprio ID e segredo de cliente.',
                        ...
                        'twitter' => [
                            'enable-twitter' => 'Ativar X (Twitter)',

                            'client-id' => [
                                'title' => 'ID do Cliente',
                                'title-info' => 'Identificador único fornecido pelo X ao criar sua aplicação OAuth.',
                            ],

                            'client-secret' => [
                                'title' => 'Segredo do Cliente',
                                'title-info' => 'Chave secreta associada ao seu cliente OAuth do X. Mantenha-a confidencial.',
                            ],

                            'redirect' => [
                                'title' => 'URL de Redirecionamento',
                                'title-info' => 'URL de retorno para onde os usuários são redirecionados após autenticar no X. Use o formato de URL exibido (altere apenas seu domínio). Ela deve corresponder à URL configurada no portal de desenvolvedores do X.',
                            ],
                        ],
                    ],
                ],
            ...
            'email' => [
                'info' => 'Driver de e-mail, dados do remetente e as notificações que sua loja envia.',
                'title' => 'E-mail',

                'smtp' => [
                    'brevo-api-key' => 'Chave de API do Brevo',
                    'brevo-api-key-info' => 'Crie uma chave de API v3 na sua conta Brevo em SMTP & API.',
                    'driver' => 'Driver',
                    'driver-brevo-api' => 'Brevo (API)',
                    'driver-info' => 'Escolha como sua loja envia e-mails.',
                    'driver-mismatch-info' => 'Seu driver de e-mail está definido como ":driver" em vez de "bagisto-dynamic-smtp". Quaisquer alterações feitas aqui não terão efeito. Por favor, atualize MAIL_MAILER=bagisto-dynamic-smtp em seu arquivo .env para ativar essas configurações.',
                    'driver-mismatch-title' => 'Estas configurações estão atualmente inativas.',
                    'driver-notice' => 'Aviso do driver',
                    'driver-smtp' => 'SMTP',
                    'encryption' => 'Criptografia',
                    'host' => 'Host',
                    'info' => 'Escolha como sua loja envia e-mails e configure o driver selecionado.',
                    'password' => 'Senha',
                    'port' => 'Porta',
                    'title' => 'Driver de e-mail',
                    'username' => 'Nome de usuário',
                ],

                'email-settings' => [
                    'admin-email' => 'Endereço de E-mail do Administrador',
                    'admin-email-tip' => 'Todas as notificações de administrador para este canal serão enviadas para este endereço.',
                    'admin-name' => 'Nome do Administrador',
                    'admin-name-tip' => 'Este nome aparecerá em todos os e-mails enviados ao administrador.',
                    'admin-page-limit' => 'Itens por Página Padrão (Administrador)',
                    'contact-email' => 'Endereço de E-mail de Contato',
                    'contact-email-tip' => 'Este endereço de e-mail aparecerá no rodapé dos seus e-mails.',
                    'contact-name' => 'Nome de Contato',
                    'contact-name-tip' => 'Este nome aparecerá no rodapé dos seus e-mails.',
                    'info' => 'Escolha como os e-mails são enviados e de quais endereços.',
                    'sender-email' => 'Endereço de E-mail do Remetente',
                    'sender-email-tip' => 'Os e-mails para seus clientes serão enviados deste endereço.',
                    'sender-name' => 'Nome do Remetente',
                    'sender-name-tip' => 'Este nome aparecerá na caixa de entrada dos seus clientes como remetente do e-mail.',
                    'title' => 'Configurações de E-mail',
                    'title-info' => 'Os nomes e endereços dos quais sua loja envia e-mails e que aparecem no rodapé.',
                ],
                ...
                'notifications' => [
                    ...
                    'info' => 'Escolha quais e-mails são enviados aos clientes e ao administrador.',
            ...
            'sales' => [
                'info' => 'Configurações de envio, pagamentos, pedidos, faturas, impostos, checkout e devoluções.',
                'title' => 'Vendas',

                'shipping-setting' => [
                    'info' => 'O endereço de onde os pedidos são enviados.',
                    ...
                    'origin' => [
                        ...
                        'street-address' => 'Endereço',
                        'title' => 'Origem',
                        'title-info' => 'O endereço de onde os pedidos são enviados e os dados da loja exibidos nas faturas.',
                ...
                'shipping-methods' => [
                    'info' => 'Os métodos de envio oferecidos no checkout.',
                    ...
                    'free-shipping' => [
                        ...
                        'status' => 'Status',
                        'title' => 'Título',
                        'title-info' => 'Um método de envio sem custo.',
                    ],
                    ...
                    'flat-rate-shipping' => [
                        ...
                        'status' => 'Status',
                        'title' => 'Título',
                        'title-info' => 'Um método de envio com taxa fixa, por pedido ou por item.',
                        'type' => [
                ...
                'payment-methods' => [
                    ...
                    'api-key' => 'Chave API',
                    'api-publishable-key' => 'Chave Publicável da API',
                    'api-test-key' => 'Chave Secreta de Teste da API',
                    'api-test-publishable-key' => 'Chave Publicável de Teste da API',
                    'applicable-production' => 'Aplica-se apenas ao modo de produção',
                    'applicable-sandbox' => 'Aplica-se apenas ao modo de teste',
                    'application-fee' => 'Pagador da Taxa de Aplicação',
                    'business-account' => 'Conta Empresarial',
                    'cash-on-delivery' => 'Pagamento na Entrega',
                    'cash-on-delivery-info' => 'Permitir que clientes paguem em dinheiro na entrega.',
                    'client-id' => 'ID do Cliente',
                    'client-id-info' => 'O ID de cliente do seu aplicativo PayPal. Use o do aplicativo sandbox enquanto o Sandbox estiver ativo.',
                    'client-secret' => 'Chave Secreta do Cliente',
                    'client-secret-info' => 'O segredo de cliente do seu aplicativo PayPal.',
                    'create-success-refund' => 'Reembolso criado com sucesso.',
                    'description' => 'Descrição',
                    'enable' => 'Ativar',
                    ...
                    'info' => 'Configure as formas de pagamento oferecidas no checkout.',
                    'instructions' => 'Instruções',
                    'logo' => 'Logotipo',
                    'logo-information' => 'Tamanho recomendado: 55 x 45 pixels.',
                    ...
                    'merchant-private-key' => 'Chave privada do lojista',
                    'merchant-private-key-info' => 'Cole o conteúdo do arquivo PEM da chave privada gerada no painel do PayGlocal. Ela é usada para assinar as requisições.',
                    'merchant-salt' => 'Salt do Comerciante',
                    'money-transfer' => 'Transferência Bancária',
                    'money-transfer-info' => 'Permitir que clientes paguem por transferência bancária ou cheque.',
                    ...
                    'payglocal-public-key-id-info' => 'O ID da chave pública do PayGlocal, exibido no painel do PayGlocal.',
                    'payglocal-public-key-info' => 'Cole o conteúdo do arquivo PEM da chave pública do PayGlocal. Ela é usada para criptografar as requisições e verificar as respostas.',
                    'payglocal-sandbox-info' => 'Enviar os pagamentos para o ambiente de testes do PayGlocal.',
                    'paypal-smart-button' => 'PayPal',
                    'paypal-smart-button-info' => 'Exibir os botões do PayPal no checkout para que os clientes paguem com PayPal ou cartão.',
                    'paypal-standard' => 'PayPal Padrão',
                    'paypal-standard-info' => 'Enviar os clientes ao PayPal para pagar com a conta PayPal ou com cartão.',
                    'payu' => 'PayU',
                    'payu-info' => 'Aceitar pagamentos pelo PayU.',
                    'payu-merchant-key-info' => 'Insira sua chave de comerciante PayU obtida do painel PayU',
                    'payu-merchant-salt-info' => 'Insira seu salt de comerciante PayU obtido do painel PayU',
                    'pending' => 'Pendente',
                    'pending-payment' => 'Pagamento Pendente',
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => 'Configure as configurações do método de pagamento PhonePe.',
                    'phonepe-client-id-info' => 'Digite seu ID de cliente do PhonePe obtido no painel do PhonePe',
                    'phonepe-client-secret-info' => 'Digite seu segredo do cliente PhonePe obtido no painel do PhonePe',
                    'phonepe-merchant-info' => 'Digite seu ID de comerciante do PhonePe obtido no painel do PhonePe',
                    'private-key-id' => 'ID da chave privada',
                    'processing' => 'Processando',
                    'production-mode-info' => 'Somente para modo de produção.',
                    'public-key-id' => 'ID da chave pública',
                    'razorpay' => 'Razorpay',
                    'razorpay-info' => 'Aceitar pagamentos pelo Razorpay.',
                    ...
                    'sort-order' => 'Ordem de Classificação',
                    'statement-descriptor' => 'Descritor de Extrato',
                    'status' => 'Status',
                    'stripe' => 'Stripe',
                    'stripe-info' => 'Aceitar pagamentos com cartão pelo Stripe.',
                ...
                'order-settings' => [
                    'info' => 'Novas tentativas de criação de pedido, números de pedido, valor mínimo e repetição de pedidos.',
                    'title' => 'Configurações de Pedido',

                    'order-creation' => [
                        'info' => 'Configure o número de tentativas de criação do pedido quando ocorrerem erros durante o checkout.',
                        'max-retry-attempts' => 'Número Máximo de Tentativas',
                        'title' => 'Criação de Pedido',
                    ],

                    'order-number' => [
                        'generator' => 'Gerador de Número de Pedido',
                        'info' => 'Como os números de pedido gerados são compostos.',
                    ...
                    'minimum-order' => [
                        ...
                        'info' => 'O menor valor de pedido com que um cliente pode finalizar a compra.',
                    ...
                    'reorder' => [
                        ...
                        'admin-reorder-info' => 'Permitir que um administrador refaça um pedido pelo painel administrativo.',
                        'info' => 'Permitir refazer um pedido pelo painel administrativo ou pela loja.',
                        'shop-reorder' => 'Reordenar pela Loja',
                        'shop-reorder-info' => 'Permitir que um cliente refaça um pedido pela loja.',
                ...
                'invoice-settings' => [
                    'info' => 'Números de fatura, condições de pagamento, impressões em PDF e lembretes.',
                    'title' => 'Configurações de Fatura',

                    'invoice-number' => [
                        'generator' => 'Gerador de Número de Fatura',
                        'info' => 'Como os números de fatura gerados são compostos.',
                    ...
                    'payment-terms' => [
                        ...
                        'info' => 'Em quanto tempo após a emissão uma fatura vence.',
                    ...
                    'invoice-reminders' => [
                        'info' => 'Quantos lembretes de pagamento são enviados para uma fatura em aberto, e com que intervalo.',
                ...
                'taxes' => [
                    'title' => 'Impostos',
                    'title-info' => 'Categorias de imposto, como o imposto é calculado e como é exibido.',

                    'categories' => [
                        'title' => 'Categorias de Impostos',
                        'title-info' => 'A categoria de imposto aplicada ao frete e a padrão para novos produtos.',
                    ...
                    'calculation' => [
                        ...
                        'title-info' => 'Sobre o que o imposto é calculado e se os preços informados já o incluem.',
                    ],
                    ...
                    'default-destination-calculation' => [
                        ...
                        'title-info' => 'O endereço usado para calcular o imposto antes de o cliente informar o seu.',
                    ],
                    ...
                    'shopping-cart' => [
                        ...
                        'title-info' => 'Como o imposto é exibido no carrinho e no checkout.',
                    ...
                    'sales' => [
                        ...
                        'title-info' => 'Como o imposto é exibido em pedidos, faturas e reembolsos.',
                        'display-prices' => 'Exibir Preços',
                        'display-subtotal' => 'Exibir Subtotal',
                        'display-shipping-amount' => 'Exibir Valor do Envio',
                        'excluding-tax' => 'Excluindo Imposto',
                ...
                'checkout' => [
                    ...
                    'info' => 'Compra como visitante, página do carrinho, minicarrinho e resumo do carrinho.',
                    ...
                    'shopping-cart' => [
                        ...
                        'info' => 'Compra como visitante, página do carrinho, produtos de venda cruzada e frete estimado.',
                    ...
                    'my-cart' => [
                        ...
                        'info' => 'Se o contador do carrinho mostra a quantidade total ou o número de itens.',
                        'summary' => 'Resumo',
                        'title' => 'Meu Carrinho',
                    ],
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Exibir o minicarrinho e o texto de oferta mostrado nele.',
                ...
                'rma' => [
                    ...
                    'allow-product-type-for-rma' => 'Permitir tipo de produto para RMA',
                    'allow-rma-for-digital-product' => 'Permitir RMA para produto digital',
                    'allowed-file-extension' => 'Extensão de arquivo permitida',
                    'allowed-file-types' => 'Por favor, selecione apenas os tipos de arquivo :allowed_types',
                    'allowed-info' => 'Separado por vírgulas. Por exemplo: jpg,jpeg,pdf',
                    'allowed-request-cancelled-request' => 'Permitir reabertura de devoluções canceladas',
                    'allowed-request-declined-request' => 'Permitir reabertura de devoluções recusadas',
                    'allowed-rma-for-product' => 'Permitir RMA para produto',
                    'cancel-items' => 'Cancelar itens',
                    'cancelled-request-info' => 'Quando ativado, o cliente pode reenviar uma devolução que foi cancelada; ela volta para "Aguardando análise" para uma nova avaliação. Quando desativado, uma devolução cancelada é definitiva e não pode ser reaberta.',
                    'complete' => 'Completo',
                    ...
                    'declined-request-info' => 'Quando ativado, o cliente pode reenviar uma devolução que o administrador recusou; ela volta para "Aguardando análise" para uma nova avaliação. Quando desativado, uma devolução recusada é definitiva e não pode ser reaberta.',
                    'default-allow-days' => 'Dias permitidos por padrão',
                    'enable' => 'Habilitar RMA',
                    'evening' => 'Noite',
                    'exchange' => 'Troca',
                    'file-extension-info' => 'Os tipos de arquivo que clientes e administradores podem anexar a uma solicitação de devolução, como fotos do produto ou documentos de apoio.',
                    'info' => 'Devoluções que os clientes podem solicitar após fazer um pedido.',
                    'morning' => 'Manhã',
                    ...
                    'product-type-info' => 'Apenas os tipos de produto selecionados são elegíveis para RMA. O prazo de devolução é definido no momento em que o pedido é feito, portanto as alterações aqui se aplicam apenas a pedidos futuros.',
                    'resolution-type' => 'Tipo de resolução',
                    ...
                    'return-policy-info' => 'A política de devolução exibida aos clientes na loja antes de enviarem uma solicitação de devolução.',
                    'specific-products' => 'Produtos específicos',
                    'title' => 'RMA',
                    'yes' => 'Sim',

                    'setting' => [
                        'info' => 'Defina como as devoluções (RMA) funcionam na sua loja: o prazo de devolução, os tipos de arquivo de anexo permitidos, os tipos de produto elegíveis, a política de devolução exibida aos clientes e se as devoluções canceladas ou recusadas podem ser reabertas.',
                        'read' => 'Ler política',
            ...
            'cache-management' => [
                ...
                'info' => 'Gerencie o cache da aplicação, limpe ou reconstrua dados em cache para configuração, rotas, visualizações e mais.',

                'general' => [
                    'title' => 'Geral',
                    'info' => 'Limpar e reconstruir caches da aplicação.',

                    'cache-actions' => [
                        'title' => 'Ações de Cache',
                        'info' => 'Use os botões abaixo para limpar ou reconstruir caches específicos.',
                    ],
                ],

                'clear-cache-title' => 'Limpar Cache',
                'clear-cache-info' => 'Remover dados em cache para forçar a aplicação a regenerá-los na próxima requisição.',
                'build-cache-title' => 'Construir Cache',
                'build-cache-info' => 'Pré-construir e otimizar caches para melhor desempenho.',
                'warning-title' => 'Notas Importantes',
                'warning-route-closures' => 'route:cache falhará se algum arquivo de rotas usar closures em vez de referências a controllers.',
                'warning-config-closures' => 'config:cache falhará se algum arquivo de configuração retornar closures.',
                'warning-permissions' => 'Problemas de permissão do sistema de arquivos podem impedir a geração ou limpeza do cache.',
                'invalid-action' => 'Ação de cache inválida solicitada.',
                'action-success' => 'Comando ":action" executado com sucesso.',
                'action-failed' => 'Comando ":action" falhou. Verifique a saída abaixo.',
                'action-exception' => 'Ação de cache falhou: :message',
                'clear-console' => 'Limpar Console',
                'console-title' => 'Console de Saída',
                'console-entries' => 'entradas',
                'console-empty' => 'Execute uma ação de cache para ver a saída aqui...',
                'console-unknown-error' => 'Ocorreu um erro inesperado.',

                'actions' => [
                    'clear-all' => 'Limpar Todo o Cache',
                    'clear-config' => 'Limpar Cache de Configuração',
                    'clear-cache' => 'Limpar Cache da Aplicação',
                    'clear-compiled' => 'Limpar Cache Compilado',
                    'clear-events' => 'Limpar Cache de Eventos',
                    'clear-routes' => 'Limpar Cache de Rotas',
                    'clear-views' => 'Limpar Cache de Visualizações',
                    'build-all' => 'Reconstruir Todo o Cache',
                    'build-config' => 'Cachear Configuração',
                    'build-routes' => 'Cachear Rotas',
        ...
        'media' => [
            'images' => [
                ...
                'ai-generation' => [
                    ...
                    'generating' => 'Gerando...',
                    'high' => 'Alta',
                    'landscape' => 'Paisagem (3:2)',
                    'low' => 'Baixa',
                    'medium' => 'Média',
                    'model' => 'Modelo',
                    'number-of-images' => 'Número de Imagens',
                    'portrait' => 'Retrato (2:3)',
                    'prompt' => 'Prompt',
                    'quality' => 'Qualidade',
                ...
                'seo' => [
                    ...
                    'alt-text-info' => 'Salvo para o idioma selecionado no momento. Se ficar vazio, o nome do produto é usado.',
                    'alt-text-placeholder' => 'Descreva o que aparece na imagem',
                    'done-btn' => 'Concluído',
                    'file-name' => 'Nome do arquivo',
                    'file-name-info' => 'Renomear altera a URL da imagem. A URL antiga deixa de funcionar, o que pode afetar o posicionamento na busca por imagens.',
                    'file-name-placeholder' => 'blue-running-shoe-side',
                    'info' => 'Melhore como os mecanismos de busca e leitores de tela entendem esta imagem.',
                    'replace' => 'Substituir imagem',
                    'replace-btn' => 'Escolher arquivo',
                    'replace-info' => 'O texto alternativo e o nome do arquivo acima são mantidos para a nova imagem.',
                    'title' => 'SEO da imagem',
                ],
            ],
    ...
    'acl' => [
        ...
        'shipments' => 'Remessas',
        'sitemaps' => 'Mapas do Site',
        'subscribers' => 'Assinantes de Newsletter',
        'tax-categories' => 'Categorias de Impostos',
        'tax-rates' => 'Taxas de Imposto',
        'taxes' => 'Impostos',
        'themes' => 'Temas',
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                'heading' => 'Olá :name',
                'message' => 'Mensagem',
                'quotes' => 'Você recebeu uma nova mensagem na sua conversa de RMA.',
                'subject' => 'Nova mensagem de conversa RMA',
                'title' => 'Nova conversa RMA',
            ],
        ],
    ],
