...
return [
    'users' => [
        ...
        'verify' => [
            'back' => 'Назад',
            'code-label' => 'Код підтвердження',
            'code-placeholder' => 'Введіть 6-значний код',
            'enter-code' => 'Введіть 6-значний код із вашого додатку автентифікації, щоб продовжити.',
    ...
    'account' => [
        'edit' => [
            ...
            'save-btn' => 'Зберегти акаунт',
            'title' => 'Мій акаунт',
            'update-success' => 'Акаунт успішно оновлено',
            'upload-image-info' => 'Завантажте фото профілю (110px X 110px) у форматі PNG або JPG',
        ],
        ...
        'emails' => [
            ...
            'backup-codes' => [
                'codes-subtitle' => 'Зберігайте ці коди в безпечному місці – кожен можна використати лише один раз.',
                'codes-title' => 'Ваші резервні коди',
                'description' => 'Для вашої безпеки ми згенерували резервні коди, які ви можете використовувати, якщо втратите доступ до додатку автентифікації. Кожен код можна використати лише один раз.',
                'greeting' => 'Ви успішно активували двофакторну автентифікацію для вашого акаунту адміністратора.',
                'subject' => 'Резервні коди двофакторної автентифікації',
                'warning-description' => 'Зберігайте ці коди в безпеці і не діліться ними з іншими. Зберігайте їх офлайн у безпечному місці.',
                'warning-title' => 'Важливе повідомлення про безпеку',
            ],
        ],

        'messages' => [
            'disabled-success' => 'Двофакторна автентифікація вимкнена.',
            'email-failed' => 'Неможливо надіслати резервні коди',
            'enabled-success' => 'Двофакторна автентифікація успішно увімкнена.',
            'invalid-code' => 'Невірний код підтвердження.',
            'verified-success' => 'Двофакторна автентифікація успішно підтверджена.',
        ],

        'setup' => [
            'back' => 'Назад',
            'backup-codes-subtitle' => 'Зберігайте ці коди в безпечному місці – кожен можна використати лише один раз.',
            'backup-codes-title' => 'Ваші резервні коди',
            'backup-codes-warning' => 'Зберігайте ці коди в безпеці і не діліться ними з іншими. Зберігайте їх офлайн у безпечному місці.',
            'code-label' => 'Код підтвердження',
            'code-placeholder' => 'Введіть 6-значний код',
            'enable' => 'Увімкнути',
            'scan-qr' => 'Скануйте цей QR-код у вашому додатку Google Authenticator, а потім введіть 6-значний код нижче.',
            'title' => 'Увімкнути двофакторну автентифікацію',
            'verify-enable' => 'Перевірити & Увімкнути',
        ],
    ],
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Усе, що потрібно, щоб отримати максимум від Bagisto — хостинг, підтримка та професійні послуги, а також розширення й документація для розробників.',

            'services-title' => 'Послуги',
            'resources-title' => 'Ресурси та документація',

            'cloud-hosting' => 'Хмарний хостинг',
            'cloud-hosting-info' => 'Економічний керований хмарний хостинг — запустіть свій магазин Bagisto у хмарі за лічені хвилини, повністю оптимізований і масштабований.',

            'support' => 'Підтримка та обслуговування',
            'support-info' => 'Спеціалізована технічна підтримка та плани постійного обслуговування, щоб ваш магазин залишався захищеним, оновленим і працював безперебійно.',

            'paid-services' => 'Платні послуги',
            'paid-services-info' => 'Експертна допомога з інтеграцією модулів, налаштуванням, міграцією даних, оновленням версій та індивідуальною розробкою.',

            'extensions' => 'Розширення',
            'extensions-info' => 'Перегляньте офіційні та спільнотні доповнення, щоб розширити Bagisto новими конекторами, каналами та функціями.',

            'docs' => 'Документація для розробників та блоги',
            'docs-info' => 'Посібники для розробників, навчальні матеріали та найновіші статті, які допоможуть вам створювати, налаштовувати та залишатися в курсі.',

            'api-docs' => 'Документація API',
            'api-docs-info' => 'Повний довідник REST та GraphQL API з кінцевими точками, автентифікацією та прикладами для інтеграції Bagisto з вашим стеком.',

            'community' => 'Форум спільноти',
            'community-info' => 'Ставте запитання, діліться ідеями та спілкуйтеся з тисячами розробників і продавців Bagisto по всьому світу.',

            'video-tutorials' => 'Відеоуроки',
            'video-tutorials-info' => 'Покрокові відеоінструкції, що охоплюють встановлення, налаштування та повсякденне керування магазином.',

            'cta-title' => 'Усе ще потрібна допомога?',
            'cta-description' => 'Поговоріть із командою Bagisto про хостинг, індивідуальну розробку чи будь-що інше.',
            'cta-btn' => 'Зв\'яжіться з нами',
        ],
    ],
        ...
        'orders' => [
            ...
            'create' => [
                ...
                'types' => [
                    ...
                    'booking' => [
                        'loading' => 'Завантаження конфігурації бронювання…',
                        'config-missing' => 'Конфігурація бронювання відсутня для цього товару.',
                        'date' => 'Дата',
                        'date-from' => 'Дата з',
                        'date-to' => 'Дата по',
                        'slot' => 'Слот',
                        'select-slot' => 'Оберіть слот',
                        'no-slots-available' => 'Немає доступних слотів на обрану дату',
                        'note' => 'Примітка',
                        'quantity' => 'Кількість',
            ...
            'view' => [
                ...
                'booking-cancellation-not-allowed' => [
                    'title' => 'Нескасовні елементи бронювання',
                    'description' => 'Це замовлення містить продукти бронювання, налаштовані як нескасовні для клієнтів. Як адміністратор, ви все одно можете їх скасувати — клієнту заборонено робити це з власного перегляду замовлення.',
                ],
                ...
                'reorder-customer-missing' => 'Неможливо повторно замовити це замовлення, оскільки пов\'язаний клієнт більше не існує.',
                'ship' => 'Відправити',
        ...
        'rma' => [
            'all-rma' => [
                'index' => [
                    ...
                    'datagrid' => [
                        'action-view' => 'Переглянути замовлення',
                        'canceled' => 'Скасовано',
                        'closed' => 'Закрито',
                        'create' => 'Дата створення',
                        'customer-name' => 'Імʼя клієнта',
                ...
                'view' => [
                    ...
                    'by' => 'Від',
                    'change-status' => 'Змінити статус запиту',
                    'close-rma' => 'RMA закрито',
                    'confirm-item-canceled' => 'Статус Товар скасовано скасує товар. Бажаєте продовжити?',
                    'confirm-item-refund' => 'Статус Посилку отримано поверне кошти клієнту. Бажаєте продовжити?',
                    ...
                    'conversation-process' => 'Ваш запит RMA було оброблено.',
                    'conversations' => 'Розмови',
                    'customer' => 'Клієнт :',
                    'customer-details' => 'Дані клієнта',
                    'customer-email' => 'Email клієнта :',
                    'declined-admin' => 'Запит відхилено адміністратором',
                    ...
                    'on' => 'Дата',
                    'order-date' => 'Дата замовлення :',
                    'order-details' => 'Товари, запитані для RMA',
                    'order-id' => 'ID замовлення :',
                    'order-status' => 'Статус доставки :',
                    'order-total' => 'Загальна сума замовлення :',
                    'price' => 'Ціна :',
                    'refund-creation-error' => 'Неможливо створити повернення для цього замовлення.',
                    'refund-failed' => 'Повернення не вдалося.',
                    ...
                    'solved' => 'Вирішено',
                    'solved-by-admin' => 'Вирішено адміністратором',
                    'status' => 'Статус',
                    'status-message' => 'Статус вашого RMA ID #:id було змінено. Статус: :status',
                    'status-reopen' => 'Повторно відкрити запит',
                    'title' => 'RMA',
            ...
            'rma-status' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'enabled' => 'Активний',
                        'id' => 'ID',
                        'mass-delete-success' => 'Вибрані статуси RMA успішно видалено.',
            ...
            'reasons' => [
                'index' => [
                    ...
                    'datagrid' => [
                        'created-at' => 'Дата створення',
                        'delete' => 'Видалити',
                        'delete-success' => 'Причину успішно видалено.',
                        'disabled' => 'Неактивний',
                        'edit' => 'Редагувати',
                        'enabled' => 'Активний',
                        'id' => 'ID',
                        'mass-delete-partial' => 'Видалено :deleted із вибраних записів; :skipped уже було видалено.',
            ...
            'custom-field' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'created-at' => 'Дата створення',
                        'delete' => 'Видалити',
                        'delete-success' => 'Користувацькі поля успішно видалено.',
                        'disabled' => 'Неактивний',
                        'edit' => 'Редагувати',
                        'enabled' => 'Активний',
                        'id' => 'ID',
            ...
            'create-rma' => [
                ...
                'email' => 'Електронна пошта',
                'failed' => 'Не вдалося створити RMA.',
                'image' => 'Зображення',
                'invalid-order-id' => 'Недійсний номер замовлення',
                'mismatch' => 'Номер замовлення та електронна пошта не збігаються',
                'new-rma' => 'Новий RMA',
                'order-id' => 'Номер замовлення',
                'quantity' => 'Кількість',
                'reason' => 'Причина',
    ...
    'catalog' => [
            ...
            'edit' => [
                ...
                'types' => [
                    ...
                    'booking' => [
                        ...
                        'allow-cancellation' => [
                            'no' => 'Ні',
                            'title' => 'Дозволити скасування бронювання',
                            'yes' => 'Так',
                        ],

                        'allow-slot-overlap' => [
                            'no' => 'Ні',
                            'title' => 'Дозволити часові слоти, що перетинаються',
                            'yes' => 'Так',
                        ],
                        ...
                        'default' => [
                            ...
                            'description-info' => 'Визначте доступні часові слоти для цього бронювання. Кожен слот представляє вікно часу для бронювання, що відображається клієнтам у магазині. Слоти не повинні перетинатися, якщо це явно не дозволено.',
                            'edit' => 'Редагувати',
                        ...
                        'slots' => [
                            'add' => 'Додати слоти',
                            'description-info' => 'Визначте доступні часові слоти для цього бронювання. Доступні для бронювання вікна часу будуть згенеровані на основі тривалості слота та часу перерви і відображені клієнтам у магазині.',
                            'save' => 'Зберегти',
                        ...
                        'validations' => [
                            ...
                            'slot-window-too-short' => 'Одне або кілька вікон слоту коротші за необхідну тривалість :duration хвилин. Кожне вікно має тривати щонайменше :duration хвилин.',
                            'slot-window-too-short-field' => 'Це вікно має тривати щонайменше :duration хвилин.',
                        ],
                    ],
        ...
        'attributes' => [
            ...
            'create' => [
                ...
                'regex-info' => 'Вираз має бути взятий у скісні риски, наприклад /^[0-9]+$/.',
                ...
                'info' => [
                    'is-filterable' => 'Додає цей атрибут до фільтрів бічної панелі категорії. Типи на основі опцій відображаються як прапорці; ціна — як повзунок діапазону.',
                    'is-configurable' => 'Позначає цей атрибут як вісь варіанта (напр. Колір, Розмір). Доступно лише для Select. Увімкнення блокує Value Per Channel і Value Per Locale — варіанти вирішуються глобально за id опції.',
                    'value-per-locale' => 'Зберігати різне значення для кожної локалі. Не застосовується для типів на основі опцій або булевих — їхні мітки вже перекладені через таблицю опцій.',
                    'value-per-channel' => 'Зберігати різне значення для кожного каналу. Вимкнено, коли ввімкнено "Use to Create Configurable Product".',
                    'is-visible-on-front' => 'Показати цей атрибут на сторінці товару у вітрині.',
                    'is-comparable' => 'Включати цей атрибут під час порівняння товарів.',
                ],
        ...
        'families' => [
            ...
            'default-delete-error' => 'Родину атрибутів за замовчуванням не можна видалити.',
    ...
    'marketing' => [
        'communications' => [
            'templates' => [
                ...
                'campaign-associate' => 'Цей шаблон використовується в одній або кількох кампаніях.',
            ...
            'events' => [
                ...
                'campaign-associate' => 'Ця подія використовується в одній або кількох кампаніях.',
                'delete-failed' => ':name Видалення не вдалося',
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    'action-type' => 'Тип Дії',
                    'action-type-info-buy-x-get-y' => 'Коли клієнт купує X товарів, додаткові Y товарів безкоштовно.',
                    'action-type-info-by-fixed' => 'Застосувати фіксовану знижку до кожного відповідного товару.',
                    'action-type-info-by-percent' => 'Застосувати відсоткову знижку до відповідних товарів.',
                    'action-type-info-cart-fixed' => 'Застосувати фіксовану знижку до всього кошика.',
                    'actions' => 'Дії',
                    ...
                    'apply-to-shipping-disabled-info' => 'Застосовується лише до відсоткових і фіксованих знижок.',
                    'attribute-family' => 'Сімейство Атрибутів',
                    ...
                    'auto-generate-info' => 'Коди промокодів можна згенерувати на сторінці редагування правила після збереження.',
                    'back-btn' => 'Назад',
                    ...
                    'free-quantity' => 'Безкоштовна кількість (Y)',
                    'from' => 'З',
                    'general' => 'Загальне',
                    'greater-than' => 'Більше',
                    ...
                    'maximum-discounted-quantity' => 'Максимальна знижена кількість',
                    'maximum-discounted-quantity-info' => 'Обмежує, скільки одиниць кожного відповідного товару отримує знижку.',
                    'maximum-eligible-quantity-info' => 'Обмежує, скільки одиниць цього товару бере участь в акції «Купи X — отримай Y».',
                    'maximum-eligible-quantity' => 'Максимальна допустима кількість',
                    'name' => 'Назва',
                    'no' => 'Ні',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name (Тільки Батьки)',
                    'auto-generate-coupon' => 'Автоматично Генерувати Промокод',
                    'auto-generate-banner-description' => 'Масово створюйте унікальні коди промокодів для цього правила.',
                    'auto-generate-banner-title' => 'Автогенерацію увімкнено',
                    'back-btn' => 'Назад',
                    'buy-x-get-y-free' => 'Купи X Отримай Y За Безкоштовно',
                    'buy-x-quantity' => 'Купи Кількість X',
                    'cart-attribute' => 'Атрибут Кошика',
                    ...
                    'general' => 'Загальне',
                    'generate' => 'Генерувати',
                    'generate-coupons' => 'Згенерувати Промокоди',
                    'generate-here' => 'Згенерувати зараз',
                    'generated-coupons' => 'Згенеровані Промокоди',
                    'greater-than' => 'Більше',
                    'is-equal-to' => 'Дорівнює',
                    'is-not-equal-to' => 'Не Дорівнює',
                    'less-than' => 'Менше',
    ...
    'appearance' => [
        'themes' => [
            'index' => [
                ...
                'activate-success' => ':theme тепер активна в :channel.',
                'active' => 'Активна',
                'active-on' => 'Активна в:',
                'active-on-all' => 'Активна в усіх каналах',
                'buy-btn' => 'Переглянути й купити',
                'buy-themes' => 'Купити теми',
                'by' => 'автор',
                'customize-btn' => 'Налаштувати',
                'info' => 'Перегляньте доступні для вітрини теми та виберіть, яку використовує кожен канал.',
                'my-themes' => 'Мої теми',
                'not-in-use' => 'Не використовується',
                'not-installed' => 'Ця тема не встановлена в цьому магазині.',
                'preview-btn' => 'Попередній перегляд',
                'title' => 'Теми',

                'activate' => [
                    'channels' => 'Канали',
                    'channels-hint' => 'Утримуйте Ctrl (Cmd на Mac), щоб вибрати кілька каналів.',
                    'confirm-btn' => 'Активувати',
                    'info' => 'Виберіть канали, які мають використовувати :theme.',
                    'title' => 'Активувати тему',
                    'warning' => 'У :channel є :count налаштувань, створених для :theme. Вони збережуться, але не відображатимуться, доки активна нова тема.',
                ],
            ],
        ],
        'sections' => [
            'index' => [
                'all-filters-used' => 'Усі доступні фільтри вже додано.',
                'channel' => 'Канал',
                'copy-suffix' => 'Копія',
                'create-btn' => 'Створити розділ',
                'delete-confirm' => 'Ви впевнені, що хочете видалити цей розділ?',
                'desktop' => 'Комп’ютер',
                'discard-btn' => 'Скасувати',
                'discarded' => 'Чорнові зміни скасовано.',
                ...
                'scoped-to' => 'Показано розділи теми :theme для каналу :channel.',
                'tablet' => 'Планшет',
                'title' => 'Розділи',
            ...
            'edit' => [
                ...
                'asc' => 'зростання',
                'back' => 'Назад',
                'brand-add-btn' => 'Додати бренд',
                'brand-logo' => 'Логотип бренду',
                'brand-name' => 'Назва бренду',
                'brands' => 'Бренди',
                'chapter' => 'Розділ',
                'chapter-engine' => 'Двигун',
                'chapter-figures' => 'Цифри',
                'chapter-protection' => 'Захист',
                'chapter-viscosity' => 'В’язкість',
            ...
            'create-success' => 'Розділ успішно створено',
            'delete-success' => 'Розділ успішно видалено',
            'update-success' => 'Розділ успішно оновлено',
        ],
    ],
    ...
    'reporting' => [
        'sales' => [
            'index' => [
                ...
                'sales-by-coupon' => 'Продажі за купоном',
        ...
        'data-transfer' => [
            'imports' => [
                'create' => [
                    ...
                    'import-confirmation' => 'Імпорт розпочнеться одразу після збереження. Продовжити?',
                    'process-in-queue' => 'Обробка в черзі',
                    'results' => 'Результати',
                    'save-btn' => 'Імпортувати',
                    'settings' => 'Налаштування',
                ...
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'view-progress' => 'Переглянути прогрес',
                    ],
                ],
                ...
                'import' => [
                    ...
                    'deleting-info' => 'Триває видалення',
                    'download-error-report' => 'Завантажити повний звіт',
                    'downloading-info' => 'Завантаження зображень',
                    'edit-btn' => 'Редагувати',
                    'failed-batches' => 'Не завершено партій: :count. Перевірте журнал помилок і повторіть імпорт для цих рядків.',
                    'images-downloaded' => 'Завантажено зображень:',
                    'images-progress' => 'зображень завантажено',
                    ...
                    'progress' => 'Прогрес:',
                    'rows-validated' => 'рядків перевірено',
                    'step-create' => 'Створення',
                    'step-delete' => 'Видалення',
                    'step-download' => 'Зображення',
                    'step-index' => 'Індексація',
                    'step-link' => 'Зв’язування',
                    'step-validate' => 'Перевірка',
                    'title' => 'Імпорт',
                    ...
                    'validation-partial-info' => 'Імпорт можна продовжити, але деякі рядки буде пропущено. Перегляньте помилки нижче або завантажте повний звіт.',
                    'validation-success-info' => 'Ваш імпорт дійсний. Натисніть „Імпорт“, щоб розпочати процес імпорту.',
                ],

                'images' => [
                    'current-archive' => 'Зараз завантажено: :name — готово зображень: :count.',
                    'current-images' => 'Для цього імпорту вже завантажено зображень: :count.',
                    'directory-example' => 'Наприклад, для product-images файли мають бути в теці /project-root/storage/app/import/product-images.',
                    'directory-hint' => 'Укажіть шлях відносно /project-root/storage/app/import, наприклад product-images, import-images.',
                    'directory-info' => 'Якщо у вас є доступ до коду, покладіть зображення в теку на сервері та вкажіть її нижче.',
                    'directory-placeholder' => 'Шлях до теки із зображеннями',
                    'directory-title' => 'Зображення вже на сервері',
                    'download-sample-zip' => 'Завантажити приклади зображень',
                    'info' => 'Виберіть, де шукати зображення, указані у вашому файлі.',
                    'recommended' => 'Рекомендовано',
                    'replace-archive' => 'Вибір нового архіву замінить їх.',
                    'title' => 'Зображення товарів',
                    'upload-info' => 'Завантажте один архів з усіма зображеннями. Колонка «images» тоді називає файли всередині нього.',
                    'upload-title' => 'Завантажити ZIP-архів із зображеннями',
                    'url-info' => 'Укажіть повну адресу https:// кожного зображення в колонці «images». Вони завантажуються до початку імпорту, тож нічого заздалегідь розміщувати на сервері не потрібно.',
                    'url-title' => 'Посилання на зображення у файлі',
                ],
                ...
                'processing-failed' => 'Не вдалося обробити імпорт. Перевірте файл і спробуйте ще раз.',
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                'info' => 'Загальні налаштування магазину: одиниці, вміст, оформлення, курси валют, карта сайту та GDPR.',
                'title' => 'Загальне',

                'general' => [
                    'info' => 'Налаштування одиниць вимірювання та «хлібні крихти» магазину.',
                    'title' => 'Загальне',
                ...
                'content' => [
                    'info' => 'Банер пропозиції, рядок авторських прав, правила спекулятивного завантаження та власні скрипти.',
                    'title' => 'Контент',
                    ...
                    'copyright-content' => [
                        'title' => 'Вміст авторських прав',
                        'info' => 'Рядок авторських прав у нижньому колонтитулі магазину.',
                    ],
                    ...
                    'custom-scripts' => [
                        ...
                        'title-info' => 'CSS і JavaScript, що додаються до кожної сторінки магазину.',
                    ],
                ],

                'design' => [
                    'info' => 'Логотип і значок панелі адміністратора, а також спосіб показу категорій меню магазину.',
                    'title' => 'Дизайн',
                    ...
                    'admin-logo' => [
                        ...
                        'title-info' => 'Логотип і значок, що показуються в панелі адміністратора та в листах адміністратору.',
                    ],
                ...
                'gdpr' => [
                    'title' => 'GDPR',
                    'info' => 'Повідомлення про файли cookie, категорії згоди та угода про конфіденційність для клієнтів.',

                    'settings' => [
                        'title' => 'Налаштування відповідності GDPR',
                        'info' => 'Увімкнути або вимкнути функції GDPR для цього каналу.',
                ...
                'exchange-rates' => [
                    'info' => 'Налаштуйте сервіси та облікові дані API обмінних курсів.',
                    'title' => 'Обмінні курси',

                    'settings' => [
                        'default-service' => 'Сервіс за замовчуванням',
                        'exchange-rates-api' => 'Exchange Rates API',
                        'fixer-api' => 'Fixer API',
                        'title' => 'Загальні налаштування',
                        'title-info' => 'Виберіть сервіс обмінних курсів за замовчуванням для автоматичного оновлення курсів валют.',
                    ],

                    'fixer' => [
                        'api-key' => 'API Key',
                        'title' => 'Fixer API',
                        'title-info' => 'Введіть ваш API-ключ Fixer.io для автоматичного оновлення обмінних курсів.',
                    ],

                    'exchange-rates-api-section' => [
                        'api-key' => 'API Key',
                        'title' => 'Exchange Rates API',
                        'title-info' => 'Введіть ваш ключ ExchangeRate-API для автоматичного оновлення обмінних курсів (https://www.exchangerate-api.com).',
                    ],
                    ...
                    'schedule' => [
                        ...
                        'frequency' => 'Частота',
                        'monthly' => 'Щомісячно',
                        'time' => 'Час початку (HH:MM)',
                        'title' => 'Запланований імпорт',
                        'title-info' => 'Автоматичне оновлення обмінних курсів за розкладом з використанням налаштованого сервісу API.',
                        'weekly' => 'Щотижнево',
                    ],
                ],

                'sitemap' => [
                    'info' => 'Формування карти сайту та обмеження файлів.',
                    'title' => 'Карта сайту',
                    ...
                    'file-limits' => [
                        'info' => 'Найбільша кількість URL в одному файлі карти сайту, після якої починається наступний.',
            ...
            'catalog' => [
                'info' => 'Налаштування товарів, розширених сніпетів і складу.',
                'title' => 'Каталог',

                'products' => [
                    'info' => 'Сторінки товару й кошика, пошук, розміри зображень, відгуки, атрибути та поширення.',
                    'title' => 'Товари',
                    ...
                    'settings' => [
                        ...
                        'title' => 'Налаштування',
                        'title-info' => 'Увімкнути або вимкнути порівняння товарів і пошук за зображенням.',
                    ...
                    'product-view-page' => [
                        ...
                        'title-info' => 'Скільки супутніх товарів і товарів допродажу показується на сторінці товару.',
                    ],

                    'cart-view-page' => [
                        'allow-no-of-cross-sells-products' => 'Дозволена кількість товарів для продажу',
                        'title' => 'Налаштування сторінки кошика',
                        'title-info' => 'Скільки товарів перехресного продажу показується на сторінці кошика.',
                    ],
                    ...
                    'storefront' => [
                        ...
                        'title' => 'Фронтенд',
                        'title-info' => 'Як товари виводяться на сторінках категорій і пошуку.',
                    ],
                    ...
                    'small-image' => [
                        ...
                        'title-info' => 'Розмір, до якого масштабуються малі зображення товарів, і заглушка для товару без зображення.',
                        'width' => 'Ширина',
                    ],
                    ...
                    'medium-image' => [
                        ...
                        'title-info' => 'Розмір, до якого масштабуються середні зображення товарів, і заглушка для товару без зображення.',
                        'width' => 'Ширина',
                    ],
                    ...
                    'large-image' => [
                        ...
                        'title-info' => 'Розмір, до якого масштабуються великі зображення товарів, і заглушка для товару без зображення.',
                        'width' => 'Ширина',
                    ],
                    ...
                    'review' => [
                        ...
                        'summary' => 'Резюме',
                        'title' => 'Відгуки',
                        'title-info' => 'Хто може залишити відгук про товар і як відгуки показуються на сторінці товару.',
                    ],
                    ...
                    'attribute' => [
                        ...
                        'title' => 'Атрибути',
                        'title-info' => 'Найбільший розмір зображення та файлу, який можна завантажити для значення атрибута.',
                    ],

                    'social-share' => [
                        'title-info' => 'Виберіть, які кнопки поширення показуються на сторінці товару та яке повідомлення вони несуть.',
                        'title' => 'Соціальне поширення',
                        'share-message' => 'Повідомлення для поширення',
                        'share' => 'Поділитися',
                        'enable-social-share' => 'Увімкнути соціальне поширення?',
                        'enable-share-whatsapp-info' => 'Посилання для поширення у WhatsApp з\'являється лише на мобільних пристроях.',
                        'enable-share-whatsapp' => 'Увімкнути поширення в WhatsApp?',
                        'enable-share-twitter' => 'Увімкнути поширення в X (Twitter)?',
                ...
                'rich-snippets' => [
                    'info' => 'Структуровані дані, що додаються на сторінки магазину для пошукових систем.',
                    'title' => 'Rich Snippets',
                    ...
                    'products' => [
                        ...
                        'title' => 'Товари',
                        'title-info' => 'Виберіть, які відомості про товар входять до структурованих даних.',
                    ],
                    ...
                    'categories' => [
                        ...
                        'title' => 'Категорії',
                        'title-info' => 'Додавати структуровані дані категорій на сторінки магазину, щоб пошукові системи могли їх прочитати.',
                    ],
                ],
                ...
                'inventory' => [
                    ...
                    'product-stock-options' => [
                        ...
                        'info' => 'Дозволити замовлення за відсутності на складі та задати кількість, нижче якої товар вважається розпроданим.',
                    ],
                ],
            ],

            'customer' => [
                'info' => 'Налаштування адрес, капчі та облікових записів клієнтів.',
                'title' => 'Клієнт',
                ...
                'address' => [
                    ...
                    'requirements' => [
                        ...
                        'state' => 'Область',
                        'title' => 'Вимоги',
                        'title-info' => 'Які поля адреси клієнт має заповнити.',
                        'zip' => 'Поштовий індекс',
                    ],
                    ...
                    'information' => [
                        ...
                        'title' => 'Інформація',
                        'title-info' => 'Скільки рядків адреси показує форма адреси.',
                    ],
                ],

                'captcha' => [
                    'info' => 'Ключі та стан Google reCAPTCHA Enterprise.',
                    'title' => 'Google Капча',

                    'credentials' => [
                        'api-key' => 'Ключ API',
                        'api-key-info' => 'Після створення проекту вам потрібно створити ключі API, перейшовши до розділу "Облікові дані" в меню "API та сервіси".',
                        'project-id' => 'ID проекту',
                        'project-id-info' => 'Щоб отримати ключ API та секретний ключ, вам потрібно створити проект у консолі Google Cloud.',
                        'score-threshold' => 'Поріг оцінки',
                        'score-threshold-info' => 'Встановіть поріг оцінки для reCAPTCHA v3 у діапазоні від 0.0 до 1.0.',
                        'secret-key' => 'Секретний ключ',
                        'site-key' => 'Ключ сайту',
                        'site-key-info' => 'Після створення проекту та ключа API знайдіть сервіс "reCAPTCHA" у бібліотеці та згенеруйте ключі "reCAPTCHA".',
                        'status' => 'Статус',
                        'title' => 'Облікові дані',
                        'title-info' => 'Облікові дані Google reCAPTCHA Enterprise і оцінка, якої має досягти запит, щоб бути прийнятим.',
                    ],
                ...
                'settings' => [
                    'settings-info' => 'Налаштуйте список бажань, перенаправлення після входу, параметри нового облікового запису, розсилку, підтвердження пошти та вхід через соцмережі.',
                    'title' => 'Налаштування',
                    ...
                    'newsletter' => [
                        ...
                        'subscription-info' => 'Показувати форму підписки в нижньому колонтитулі магазину.',
                        'title' => 'Підписка на розсилку',
                        'title-info' => 'Підписка на розсилку в магазині.',
                    ],

                    'email' => [
                        'email-verification' => 'Дозволити підтвердження електронної пошти',
                        'title' => 'Підтвердження електронної пошти',
                        'title-info' => 'Просити нового клієнта підтвердити адресу електронної пошти перед входом.',
                    ],

                    'social-login' => [
                        'title' => 'Соціальний вхід',
                        'info' => 'Дозволити клієнтам входити через зовнішній обліковий запис. Кожному постачальнику потрібні власні ідентифікатор і секрет клієнта.',
                        ...
                        'google' => [
                            ...
                            'redirect' => [
                                ...
                                'title-info' => 'URL-адреса, на яку користувачі будуть перенаправлені після аутентифікації через Google. Використовуйте показаний формат URL-заповнювача (змініть лише ваш домен). Вона повинна збігатися з URL, налаштованим у вашій консолі Google.',
                            ],
                        ],
                        ...
                        'facebook' => [
                            ...
                            'redirect' => [
                                'title' => 'URL для перенаправлення',
                                'title-info' => 'URL-адреса, на яку користувачі будуть перенаправлені після аутентифікації через Facebook. Використовуйте показаний формат URL-заповнювача (змініть лише ваш домен). Вона повинна збігатися з URL, налаштованим у налаштуваннях вашого додатку на Facebook.',
                            ],
                        ],
                        ...
                        'github' => [
                            ...
                            'redirect' => [
                                'title' => 'URL для перенаправлення',
                                'title-info' => 'URL-адреса, на яку користувачі будуть перенаправлені після аутентифікації через GitHub. Використовуйте показаний формат URL-заповнювача (змініть лише ваш домен). Вона повинна збігатися з URL, налаштованим у вашій консолі GitHub.',
                            ],
                        ],
                        ...
                        'linkedin' => [
                            ...
                            'redirect' => [
                                'title' => 'URL для перенаправлення',
                                'title-info' => 'URL-адреса, на яку користувачі будуть перенаправлені після аутентифікації через LinkedIn. Використовуйте показаний формат URL-заповнювача (змініть лише ваш домен). Вона повинна збігатися з URL, налаштованим у вашій консолі LinkedIn.',
                            ],
                        ],

                        'twitter' => [
                            'enable-twitter' => 'Увімкнути X (Twitter)',

                            'client-id' => [
                                'title' => 'Ідентифікатор клієнта',
                                'title-info' => 'Унікальний ідентифікатор, який видає X під час створення застосунку OAuth.',
                            ],

                            'client-secret' => [
                                'title' => 'Таємний ключ клієнта',
                                'title-info' => 'Секретний ключ вашого клієнта OAuth X. Зберігайте його конфіденційно.',
                            ],

                            'redirect' => [
                                'title' => 'URL для перенаправлення',
                                'title-info' => 'URL зворотного виклику, куди користувачів перенаправляють після автентифікації в X. Використовуйте показаний формат URL (змінюйте лише домен). Він має збігатися з URL, налаштованим у порталі розробника X.',
                            ],
                        ],
                    ],
                ],
            ...
            'email' => [
                'info' => 'Драйвер пошти, дані відправника та сповіщення, які надсилає магазин.',
                'title' => 'Електронна пошта',

                'smtp' => [
                    'brevo-api-key' => 'Ключ API Brevo',
                    'brevo-api-key-info' => 'Створіть ключ API v3 в обліковому записі Brevo у розділі SMTP & API.',
                    'driver' => 'Драйвер',
                    'driver-brevo-api' => 'Brevo (API)',
                    'driver-info' => 'Виберіть, як ваш магазин надсилає листи.',
                    'driver-mismatch-info' => 'Ваш драйвер пошти встановлено на ":driver" замість "bagisto-dynamic-smtp". будь-які зміни, зроблені тут, не матимуть жодного ефекту. Будь ласка, оновіть MAIL_MAILER=bagisto-dynamic-smtp у вашому файлі .env, щоб активувати ці налаштування.',
                    'driver-mismatch-title' => 'Ці налаштування наразі неактивні.',
                    'driver-notice' => 'Сповіщення про драйвер',
                    'driver-smtp' => 'SMTP',
                    'encryption' => 'Шифрування',
                    'host' => 'Хост',
                    'info' => 'Виберіть, як ваш магазин надсилає листи, і налаштуйте вибраний драйвер.',
                    'password' => 'Пароль',
                    'port' => 'Порт',
                    'title' => 'Поштовий драйвер',
                    'username' => 'Ім\'я користувача',
                ],

                'email-settings' => [
                    'admin-email' => 'Адреса електронної пошти адміністратора',
                    'admin-email-tip' => 'Всі повідомлення адміністратора для цього каналу будуть надіслані на цю адресу.',
                    'admin-name' => 'Ім\'я адміністратора',
                    'admin-name-tip' => 'Це ім\'я відображатиметься в усіх листах, надісланих адміністратору.',
                    'admin-page-limit' => 'Елементів на сторінці за замовчуванням (адмін)',
                    'contact-email' => 'Адреса електронної пошти для зв\'язку',
                    'contact-email-tip' => 'Ця адреса електронної пошти відображатиметься у нижній частині ваших листів.',
                    'contact-name' => 'Ім\'я для зв\'язку',
                    'contact-name-tip' => 'Це ім\'я відображатиметься у нижній частині ваших листів.',
                    'info' => 'Виберіть, як надсилається пошта та з яких адрес.',
                    'sender-email' => 'Адреса електронної пошти відправника',
                    'sender-email-tip' => 'Листи вашим клієнтам надсилатимуться з цієї адреси.',
                    'sender-name' => 'Ім\'я відправника',
                    'sender-name-tip' => 'Це ім\'я відображатиметься в папці \"Вхідні\" ваших клієнтів як відправник листа.',
                    'title' => 'Налаштування електронної пошти',
                    'title-info' => 'Імена й адреси, з яких магазин надсилає листи та які показуються в підвалі.',
                ],
                ...
                'notifications' => [
                    ...
                    'info' => 'Виберіть, які листи надсилаються клієнтам і адміністратору.',
                    ...
                    'title' => 'Повідомлення',
                    'title-info' => 'Увімкнути або вимкнути окремі листи-сповіщення.',
                    'verification' => 'Надіслати підтвердження після реєстрації клієнта',
                ],
            ],

            'sales' => [
                'info' => 'Налаштування доставки, оплати, замовлень, рахунків, податків, оформлення та повернень.',
                'title' => 'Продажі',

                'shipping-setting' => [
                    'info' => 'Адреса, з якої відправляються замовлення.',
                    ...
                    'origin' => [
                        ...
                        'title' => 'Походження',
                        'title-info' => 'Адреса, з якої відправляються замовлення, і дані магазину, що показуються в рахунках.',
                ...
                'shipping-methods' => [
                    'info' => 'Способи доставки, що пропонуються під час оформлення замовлення.',
                    ...
                    'free-shipping' => [
                        ...
                        'status' => 'Статус',
                        'title' => 'Назва',
                        'title-info' => 'Спосіб доставки без оплати.',
                    ],
                    ...
                    'flat-rate-shipping' => [
                        ...
                        'status' => 'Статус',
                        'title' => 'Назва',
                        'title-info' => 'Спосіб доставки з фіксованою ставкою — за замовлення або за одиницю товару.',
                        'type' => [
                ...
                'payment-methods' => [
                    ...
                    'api-key' => 'Ключ API',
                    'api-publishable-key' => 'Публічний ключ API',
                    'api-test-key' => 'Тестовий секретний ключ API',
                    'api-test-publishable-key' => 'Тестовий публічний ключ API',
                    'applicable-production' => 'Застосовується лише для режиму виробництва',
                    'applicable-sandbox' => 'Застосовується лише для тестового режиму',
                    'application-fee' => 'Платник комісії за додаток',
                    'business-account' => 'Бізнес-акаунт',
                    'cash-on-delivery' => 'Оплата при отриманні',
                    'cash-on-delivery-info' => 'Дозволити клієнтам платити готівкою під час доставки.',
                    'client-id' => 'Ідентифікатор клієнта',
                    'client-id-info' => 'Ідентифікатор клієнта вашого застосунку PayPal. Поки увімкнено режим Sandbox, використовуйте ідентифікатор тестового застосунку.',
                    'client-secret' => 'Секретний ключ клієнта',
                    'client-secret-info' => 'Секрет клієнта вашого застосунку PayPal.',
                    'create-success-refund' => 'Повернення коштів успішно створено.',
                    'description' => 'Опис',
                    'enable' => 'Увімкнути',
                    ...
                    'info' => 'Налаштуйте способи оплати, які пропонуються під час оформлення замовлення.',
                    'instructions' => 'Інструкції',
                    'logo' => 'Логотип',
                    'logo-information' => 'Рекомендований розмір: 55 x 45 пікселів.',
                    'mailing-address' => 'Адреса для відправки чека',
                    'merchant-description' => 'Опис продавця',
                    'merchant-id' => 'ID продавця',
                    'merchant-key' => 'Ключ продавця',
                    'merchant-name' => 'Ім\'я продавця',
                    ...
                    'merchant-salt' => 'Сіль продавця',
                    'money-transfer' => 'Грошовий переказ',
                    'money-transfer-info' => 'Дозволити клієнтам платити банківським переказом або чеком.',
                    ...
                    'paypal-smart-button-info' => 'Показувати кнопки PayPal під час оформлення, щоб клієнти платили через PayPal або карткою.',
                    'paypal-standard' => 'PayPal Standard',
                    'paypal-standard-info' => 'Перенаправляти клієнтів до PayPal для оплати рахунком PayPal або карткою.',
                    'payu' => 'PayU',
                    'payu-info' => 'Приймати платежі через PayU.',
                    'payu-merchant-key-info' => 'Введіть ваш ключ продавця PayU, отриманий з панелі PayU',
                    'payu-merchant-salt-info' => 'Введіть вашу сіль продавця PayU, отриману з панелі PayU',
                    'pending' => 'Очікується',
                    'pending-payment' => 'Очікується оплата',
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => 'Налаштуйте параметри способу оплати PhonePe.',
                    'phonepe-client-id-info' => 'Введіть свій ID клієнта PhonePe, отриманий з панелі керування PhonePe',
                    'phonepe-client-secret-info' => 'Введіть свій клієнт-секрет PhonePe, отриманий з панелі керування PhonePe',
                    'phonepe-merchant-info' => 'Введіть свій ID продавця PhonePe, отриманий з панелі керування PhonePe',
                    'private-key-id' => 'Private Key ID',
                    'processing' => 'Обробка',
                    'production-mode-info' => 'Тільки для виробничого режиму.',
                    'public-key-id' => 'Public Key ID',
                    'razorpay' => 'Razorpay',
                    'razorpay-info' => 'Приймати платежі через Razorpay.',
                    'sandbox' => 'Пісочниця',
                    ...
                    'sort-order' => 'Порядок сортування',
                    'statement-descriptor' => 'Опис виписки',
                    'status' => 'Статус',
                    'stripe' => 'Stripe',
                    'stripe-info' => 'Приймати платежі карткою через Stripe.',
                    'test-client-id' => 'Ідентифікатор клієнта тестового режиму',
                    'test-client-secret' => 'Секретний ключ клієнта тестового режиму',
                    'test-mode-info' => 'Тільки для тестового режиму/пісочниці.',
                    'title' => 'Назва',
                ],

                'order-settings' => [
                    'info' => 'Повторні спроби створення замовлення, номери замовлень, мінімальна сума та повторне замовлення.',
                    'title' => 'Налаштування замовлення',

                    'order-creation' => [
                        'info' => 'Налаштуйте кількість повторних спроб створення замовлення помилок під час оформлення замовлення.',
                        'max-retry-attempts' => 'Максимальна кількість спроб',
                        'title' => 'Створення замовлення',
                    ],

                    'order-number' => [
                        'generator' => 'Генератор номерів замовлень',
                        'info' => 'Як формуються згенеровані номери замовлень.',
                    ...
                    'minimum-order' => [
                        ...
                        'info' => 'Найменша сума замовлення, з якою клієнт може оформити покупку.',
                    ...
                    'reorder' => [
                        ...
                        'admin-reorder-info' => 'Дозволити адміністратору повторити замовлення з панелі адміністратора.',
                        'info' => 'Дозволити повторити замовлення з панелі адміністратора або з магазину.',
                        'shop-reorder' => 'Повторне замовлення магазину',
                        'shop-reorder-info' => 'Дозволити клієнту повторити замовлення з магазину.',
                ...
                'invoice-settings' => [
                    'info' => 'Номери рахунків, умови оплати, друк у PDF та нагадування.',
                    'title' => 'Налаштування рахунку',

                    'invoice-number' => [
                        'generator' => 'Генератор номерів рахунків',
                        'info' => 'Як формуються згенеровані номери рахунків.',
                    ...
                    'payment-terms' => [
                        ...
                        'info' => 'Через скільки часу після виставлення рахунок підлягає оплаті.',
                        'title' => 'Умови оплати',
                    ],
                    ...
                    'invoice-reminders' => [
                        'info' => 'Скільки нагадувань про оплату надсилається за несплаченим рахунком і з яким інтервалом.',
                ...
                'taxes' => [
                    'title' => 'Податки',
                    'title-info' => 'Податкові категорії, спосіб розрахунку та відображення податку.',

                    'categories' => [
                        'title' => 'Категорії податків',
                        'title-info' => 'Податкова категорія для доставки та категорія за замовчуванням для нових товарів.',
                    ...
                    'calculation' => [
                        'after-discount' => 'Після знижки',
                        'apply-tax-on' => 'Застосувати податок до',
                        'apply-tax-on-info' => 'Виберіть, чи розраховується податок на початкову ціну товару (До знижки) або на ціну після застосування знижок правил кошика (Після знижки). Це налаштування застосовується лише до цін без податку.',
                        'based-on' => 'Розрахунок на основі',
                        'before-discount' => 'До знижки',
                        ...
                        'title-info' => 'На що нараховується податок і чи включений він уже у введені ціни.',
                    ],
                    ...
                    'default-destination-calculation' => [
                        ...
                        'title-info' => 'Адреса, за якою розраховується податок, доки клієнт не вказав свою.',
                    ],

                    'shopping-cart' => [
                        'show-tax-breakdown' => 'Показати розбивку податку',
                        'show-tax-breakdown-info' => 'Відображає детальну розбивку податку за товарами та ставками у зведенні кошика та оформлення. Призначено для налагодження.',
                        'title' => 'Налаштування відображення кошика',
                        'title-info' => 'Як податок показується в кошику та під час оформлення.',
                    ...
                    'sales' => [
                        ...
                        'title-info' => 'Як податок показується в замовленнях, рахунках і поверненнях.',
                        'display-prices' => 'Відображати ціни',
                        'display-subtotal' => 'Відображати підсумок',
                        'display-shipping-amount' => 'Відображати вартість доставки',
                        'excluding-tax' => 'Без урахування податку',
                ...
                'checkout' => [
                    ...
                    'info' => 'Оформлення без реєстрації, сторінка кошика, міні-кошик і підсумок кошика.',
                    ...
                    'shopping-cart' => [
                        ...
                        'info' => 'Оформлення без реєстрації, сторінка кошика, товари перехресного продажу та попередня доставка.',
                        'title' => 'Кошик',
                    ],
                    ...
                    'my-cart' => [
                        ...
                        'info' => 'Чи показує лічильник кошика загальну кількість, чи число позицій.',
                        'summary' => 'Підсумок',
                        'title' => 'Мій кошик',
                    ],
                    ...
                    'mini-cart' => [
                        ...
                        'info' => 'Показувати міні-кошик і текст пропозиції всередині нього.',
                ...
                'rma' => [
                    ...
                    'allowed-file-types' => 'Будь ласка, виберіть тільки типи файлів :allowed_types',
                    'allowed-info' => 'Розділено комами. Наприклад: jpg,jpeg,pdf',
                    'allowed-request-cancelled-request' => 'Дозволити повторне відкриття скасованих повернень',
                    'allowed-request-declined-request' => 'Дозволити повторне відкриття відхилених повернень',
                    'allowed-rma-for-product' => 'Дозволити RMA для продукту',
                    'cancel-items' => 'Скасувати елементи',
                    'cancelled-request-info' => 'Якщо ввімкнено, клієнт може повторно надіслати скасоване повернення; воно повертається до статусу «На розгляді» для повторної перевірки. Якщо вимкнено, скасоване повернення вважається остаточним і не може бути відкрите повторно.',
                    'complete' => 'Завершено',
                    ...
                    'declined-request-info' => 'Якщо ввімкнено, клієнт може повторно надіслати повернення, відхилене адміністратором; воно повертається до статусу «На розгляді» для повторної перевірки. Якщо вимкнено, відхилене повернення вважається остаточним і не може бути відкрите повторно.',
                    'default-allow-days' => 'Дні, дозволені за замовчуванням',
                    'enable' => 'Увімкнути RMA',
                    'evening' => 'Вечір',
                    'exchange' => 'Обмін',
                    'file-extension-info' => 'Типи файлів, які клієнти та адміністратори можуть прикріплювати до запиту на повернення, наприклад фотографії товару або супровідні документи.',
                    'info' => 'Повернення, які клієнти можуть запросити після оформлення замовлення.',
                    'morning' => 'Ранок',
                    ...
                    'product-type-info' => 'Лише вибрані типи товарів підлягають RMA. Термін повернення фіксується під час оформлення замовлення, тому зміни тут застосовуються лише до майбутніх замовлень.',
                    'resolution-type' => 'Тип вирішення',
                    ...
                    'return-policy-info' => 'Політика повернення, що відображається клієнтам у вітрині магазину перед надсиланням запиту на повернення.',
                    'specific-products' => 'Конкретні продукти',
                    'title' => 'RMA',
                    'yes' => 'Так',

                    'setting' => [
                        'info' => 'Налаштуйте, як працюють повернення (RMA) у вашому магазині: термін повернення, дозволені типи прикріплюваних файлів, придатні типи товарів, політику повернення, що відображається клієнтам, а також можливість повторного відкриття скасованих або відхилених повернень.',
            ...
            'cache-management' => [
                ...
                'info' => 'Керуйте кешем додатку, очищуйте або перебудовуйте кешовані дані для конфігурації, маршрутів, представлень та іншого.',

                'general' => [
                    'title' => 'Загальне',
                    'info' => 'Очищення та перебудова кешів додатку.',

                    'cache-actions' => [
                        'title' => 'Дії з кешем',
                        'info' => 'Використовуйте кнопки нижче для очищення або перебудови конкретних кешів.',
                    ],
                ],

                'clear-cache-title' => 'Очистити кеш',
                'clear-cache-info' => 'Видалити кешовані дані, щоб змусити додаток згенерувати їх заново при наступному запиті.',
                'build-cache-title' => 'Побудувати кеш',
                'build-cache-info' => 'Попередньо побудувати та оптимізувати кеші для кращої продуктивності.',
                'warning-title' => 'Важливі зауваження',
                'warning-route-closures' => 'route:cache не спрацює, якщо файл маршрутів використовує замикання замість посилань на контролери.',
                ...
                'actions' => [
                    ...
                    'clear-config' => 'Очистити кеш конфігурації',
                    'clear-cache' => 'Очистити кеш додатку',
                    'clear-compiled' => 'Очистити скомпільований кеш',
                    ...
                    'build-views' => 'Кешувати представлення',
                ],
    ...
    'components' => [
        ...
        'datagrid' => [
            ...
            'table' => [
                ...
                'no-records-hint' => 'Спробуйте налаштувати фільтри або поверніться пізніше, коли будуть додані дані.',
            ],
        ],
        ...
        'media' => [
            'images' => [
                ...
                'seo' => [
                    ...
                    'alt-text-info' => 'Зберігається для вибраної локалі. Якщо поле порожнє, використовується назва товару.',
                    'alt-text-placeholder' => 'Опишіть, що зображено на картинці',
                    'done-btn' => 'Готово',
                    'file-name' => 'Назва файлу',
                    'file-name-info' => 'Перейменування змінює URL зображення. Старий URL перестане працювати, що може вплинути на позиції в пошуку зображень.',
                    'file-name-placeholder' => 'blue-running-shoe-side',
                    'info' => 'Покращте те, як пошукові системи та програми зчитування з екрана розуміють це зображення.',
                    'replace' => 'Замінити зображення',
                    'replace-btn' => 'Вибрати файл',
                    'replace-info' => 'Наведені вище альтернативний текст і назва файлу збережуться для нового зображення.',
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                ...
                'message' => 'Повідомлення',
                'quotes' => 'Ви отримали нове повідомлення у вашій розмові RMA.',
                'subject' => 'Нове повідомлення розмови RMA',
                'title' => 'Нова розмова RMA',
            ],
        ],
    ],
    ...
    'eu_withdrawal' => [
        'menu' => [
            'eu_withdrawals' => 'Відмови від договору (ЄС)',
        ],

        'acl' => [
            'title' => 'Відмови від договору (ЄС)',
            'view' => 'Перегляд',
            'decline' => 'Відхилити',
            'mark_refunded' => 'Позначити як повернено',
            'resend_confirmation' => 'Надіслати підтвердження повторно',
        ],

        'config' => [
            'title' => 'Відмови від договору (ЄС)',
            'info' => 'Налаштування кнопки відмови від договору (Директива (ЄС) 2023/2673, стаття 11a Директиви про права споживачів).',

            'general' => [
                'title' => 'Загальні',
                'info' => 'Головний перемикач кнопки відмови від договору для цього каналу.',
                'enabled' => 'Увімкнути',
                'enabled_info' => 'Коли увімкнено, клієнти цього каналу бачать кнопку «Відмовитися від договору» на сторінках з деталями замовлення та публічну форму пошуку за адресою /withdraw. Вмикайте лише на каналах, що продають споживачам у ЄС.',
            ],
        ],
        ...
        'view' => [
            ...
            'evidence' => 'Доказ',
            'evidence_note' => 'Незмінний — зафіксовано в момент подання',
            'status' => 'Статус',
            'received_at' => 'Отримано',
            'uuid' => 'Номер звернення',
            ...
            'channel' => 'Канал',
            'locale' => 'Мова',
            'reason' => 'Причина клієнта',

            'timeline' => 'Хронологія',
            'timeline_received' => 'Заяву отримано',
            'timeline_received_desc' => 'Клієнт подав заяву про відмову від договору.',
            'timeline_email' => 'Лист-підтвердження',
            'timeline_email_pending' => 'Ще не надіслано',
            'timeline_initial_email' => 'Перший лист-підтвердження',
            'timeline_initial_email_desc_sent' => 'Лист-підтвердження доставлено клієнту.',
            'timeline_initial_email_desc_error' => 'Не вдалося надіслати перший лист-підтвердження.',
            'timeline_initial_email_desc_pending' => 'Перший лист-підтвердження ще не надіслано.',
            'timeline_final_email' => 'Підсумковий лист-підтвердження',
            'timeline_final_email_pending' => 'Ще не надіслано',
            'timeline_final_email_desc_sent' => 'Підсумковий лист доставлено клієнту.',
            'timeline_final_email_desc_pending' => 'Підсумковий лист-підтвердження ще не надіслано.',
            'timeline_declined' => 'Відхилено адміністратором',
            'timeline_declined_desc' => 'Відмову відхилено: :name.',
            'timeline_declined_desc_system' => 'Відмову відхилено.',
            'timeline_declined_reason_label' => 'Зазначена причина:',
            'timeline_refunded' => 'Позначено як повернено адміністратором',
            'timeline_refunded_desc' => 'Повернення оформлено: :name.',
            'timeline_refunded_desc_system' => 'Повернення оформлено.',
            'timeline_refunded_note_label' => 'Примітка адміністратора:',
            'timeline_resolution' => 'Розгляд',
            'timeline_resolution_desc' => 'Очікує розгляду та рішення адміністратора.',
            'timeline_resolution_pending' => 'Очікує дії адміністратора',

            'confirmation_sent_at' => 'Підтвердження надіслано',
            'confirmation_error' => 'Помилка підтвердження',
            'declined_at' => 'Відхилено',
            'refunded_at' => 'Повернено',

            'actions' => 'Дії',
            'actions_note' => 'Повернення обробляються вручну за допомогою наявних інструментів Bagisto: замовлень, повернень та RMA. Скористайтеся цими діями, щоб зафіксувати результат у матеріалах про відмову від договору.',
            'resend_confirmation' => 'Надіслати лист-підтвердження повторно',
            'mark_refunded' => 'Позначити як повернено',
            'refund_note_label' => 'Номер повернення (необов’язково)',
            'refund_note_placeholder' => 'напр., Повернення №1234',
            'decline' => 'Відхилити відмову',
            'decline_reason_label' => 'Причина відхилення',
            'decline_reason_placeholder' => 'Поясніть, чому право оспорюється',
            'mark_refunded_confirm_msg' => 'Позначити цю відмову як повернену? Попередній запис про відхилення буде видалено.',
            'decline_confirm_msg' => 'Відхилити цю відмову? Причина буде видимою для клієнта.',
            'resend_confirmation_confirm_msg' => 'Надіслати клієнту лист-підтвердження повторно?',
            'send_final_confirmation' => 'Надіслати підсумковий лист-підтвердження',
            'send_final_confirmation_confirm_msg' => 'Надіслати клієнту підсумковий лист зі статусом?',
        ],
        ...
        'flash' => [
            'declined' => 'Відмову від договору було відхилено.',
            'refunded' => 'Відмову від договору позначено як повернену.',
            'confirmation_resent' => 'Лист-підтвердження надіслано повторно.',
            'confirmation_failed' => 'Не вдалося надіслати лист-підтвердження. Подробиці див. у хронології.',
        ],
    ],
];
