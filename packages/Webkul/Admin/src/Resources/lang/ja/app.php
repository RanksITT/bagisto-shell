        ...
        'orders' => [
            ...
            'create' => [
                ...
                'types' => [
                    ...
                    'booking' => [
                        'loading' => '予約設定を読み込み中…',
                        'config-missing' => 'この商品の予約設定がありません。',
                        'date' => '日付',
                        'date-from' => '開始日',
                        'date-to' => '終了日',
                        'slot' => '枠',
                        'select-slot' => '枠を選択',
                        'no-slots-available' => '選択した日付に利用できる枠がありません',
                        'note' => 'メモ',
                        'quantity' => '数量',
                        'renting-type' => 'レンタル種別',
                        'daily' => '日単位',
            ...
            'view' => [
                ...
                'booking-cancellation-not-allowed' => [
                    'title' => 'キャンセル不可の予約アイテム',
                    'description' => 'この注文には、顧客向けにキャンセル不可として設定された予約商品が含まれています。管理者はキャンセルできますが、顧客は自分の注文画面からキャンセルできません。',
                ],
        ...
        'rma' => [
            'all-rma' => [
                ...
                'view' => [
                    ...
                    'attachment' => '添付ファイル',
                    'by' => '作成者',
                    'change-status' => 'リクエストステータスを変更',
                    'close-rma' => 'RMAは終了しました',
                    'confirm-item-canceled' => 'アイテムキャンセルのステータスはアイテムをキャンセルします。続行しますか？',
                    'confirm-item-refund' => '荷物受領のステータスは顧客に返金します。続行しますか？',
                    'confirm-print' => 'OKをクリックしてRMAを印刷',
                    'cancel-item' => 'Cancel Item',
                    'item-action-note' => 'This action affects the order and cannot be undone.',
                    'order-actions' => 'Order Actions',
                    'refund-item' => 'Refund Item',
                    'conversation-process' => 'RMAリクエストが処理されました。',
                    'conversations' => '会話',
                    'customer' => '顧客 :',
                    'customer-details' => '顧客詳細',
                    'customer-email' => '顧客メール :',
                    'declined-admin' => '管理者によってリクエストが拒否されました',
                    'enter-message' => 'メッセージを入力',
                    'failed' => '操作に失敗しました。',
                    'images' => '画像 :',
                    'item-canceled' => '商品がキャンセルされました',
                    'no-record' => '記録が見つかりません！',
                    'on' => '日時',
                    'order-date' => '注文日 :',
                    'order-details' => 'RMA対象商品',
                    'order-id' => '注文ID :',
                    'order-status' => '配送状況 :',
                    'order-total' => '注文合計 :',
                    'price' => '価格 :',
                    ...
                    'request-on' => '申請日 :',
                    'resolution-type' => '対応方法 :',
                    'rma-status' => 'リクエストステータス :',
                    'save-btn' => '保存',
                    'send-message' => 'メッセージを送信',
                    'send-message-btn' => 'メッセージを送信',
                    'send-message-success' => 'メッセージが正常に送信されました。',
                    'solved' => '解決済み',
                    'solved-by-admin' => '管理者によって解決されました',
                    'status' => 'ステータス',
                    'status-message' => 'RMA ID #:id のステータスが変更されました。ステータス: :status',
            ...
            'create-rma' => [
                ...
                'rma-not-available-quotes' => '商品はRMA対象外です',
                'save-btn' => '保存',
                'search' => '--選択--',
                'validate' => '検証',
            ],
    ...
    'catalog' => [
                ...
                'types' => [
                    ...
                    'booking' => [
                        ...
                        'default' => [
                            ...
                            'close' => '閉じる',
                            'description' => '予約情報',
                            'description-info' => 'この予約の利用可能なタイムスロットを定義します。各スロットは、ストアフロントで顧客に表示される予約可能な時間枠を表します。明示的に許可されていない限り、スロットは重複してはいけません。',
                            'edit' => '編集',
                            'many' => '1日に複数の予約',
                            'one' => '複数日に1つの予約',
                            'open' => '開く',
                        ...
                        'slots' => [
                            'add' => 'スロットを追加',
                            'description-info' => 'この予約の利用可能なタイムスロットを定義します。予約可能な時間枠はスロットの期間と休憩時間に基づいて生成され、ストアフロントで顧客に表示されます。',
                            'save' => '保存',
                            'title' => 'スロットの時間期間',
                            'unavailable' => '利用不可',
        ...
        'attributes' => [
            ...
            'create' => [
                ...
                'info' => [
                    'is-filterable' => 'この属性をカテゴリーのサイドバーフィルターに追加します。選択肢ベースのタイプはチェックボックスとして、価格は範囲スライダーとして表示されます。',
                    'is-configurable' => 'この属性をバリアント軸（色・サイズなど）としてマークします。Select のみで利用可能。有効にすると「チャネルごとの値」と「ロケールごとの値」はロックされ、バリアントはオプションIDでグローバルに解決されます。',
                    'value-per-locale' => 'ロケールごとに異なる値を保存します。選択肢ベースやブール型には適用されません — それらのラベルはオプションテーブルで翻訳されます。',
                    'value-per-channel' => 'チャネルごとに異なる値を保存します。「Configurable 商品作成に使用」が有効な場合は無効になります。',
                    'is-visible-on-front' => 'この属性をストアフロントの商品ページに表示します。',
                    'is-comparable' => '商品を並べて比較する際にこの属性を含めます。',
                ],
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    ...
                    'action-type-info-buy-x-get-y' => '顧客が X 個のアイテムを購入すると、追加の Y 個のアイテムが無料になります。',
                    'action-type-info-by-fixed' => '一致する各アイテムに固定金額の割引を適用します。',
                    'action-type-info-by-percent' => '一致するアイテムにパーセント割引を適用します。',
                    'action-type-info-cart-fixed' => 'カート全体に固定金額の割引を適用します。',
                    'actions' => 'アクション',
                    'add-condition' => '条件を追加',
                    'additional' => '追加',
                    ...
                    'apply-to-shipping-disabled-info' => 'パーセント割引と固定金額割引にのみ適用されます。',
                    'attribute-family' => '属性ファミリー',
                    ...
                    'auto-generate-info' => 'クーポンコードはルール保存後に編集ページから生成できます。',
                    'back-btn' => '戻る',
                    ...
                    'maximum-discounted-quantity' => '割引対象の最大数量',
                    'maximum-discounted-quantity-info' => '一致する各商品のうち、割引が適用される最大数量を設定します。',
                    'maximum-eligible-quantity-info' => 'この商品が「X個買うとY個無料」キャンペーンで対象となる数量の上限を設定します。',
                    'maximum-eligible-quantity' => '最大対象数量',
                    'name' => '名前',
                    'no' => 'いいえ',
                    'no-coupon' => 'クーポンなし',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name（親カテゴリのみ）',
                    'auto-generate-coupon' => 'クーポンを自動生成',
                    'auto-generate-banner-description' => 'このルール用のユニークなクーポンコードを一括生成します。',
                    'auto-generate-banner-title' => '自動生成が有効です',
                    'back-btn' => '戻る',
                    'buy-x-get-y-free' => 'X個買うとY個無料',
                    'buy-x-quantity' => 'X個購入',
                    'cart-attribute' => 'カートの属性',
    ...
    'appearance' => [
        ...
        'sections' => [
            ...
            'edit' => [
                ...
                'chapter-engine' => 'エンジン',
                'chapter-figures' => '数値',
                'chapter-protection' => '保護',
                'chapter-viscosity' => '粘度',
                'category-carousel' => 'カテゴリーカルーセル',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api-key' => 'APIキー',
                    'api-publishable-key' => '公開可能APIキー',
                    'api-test-key' => 'テスト用シークレットキー',
                    'api-test-publishable-key' => 'テスト用公開APIキー',
                    'applicable-production' => '本番モードのみ適用されます',
                    'applicable-sandbox' => 'テストモードのみ適用されます',
                    ...
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => 'PhonePe支払い方法の設定を構成します。',
                ...
                'rma' => [
                    ...
                    'allowed-request-cancelled-request' => 'キャンセルされた返品の再開を許可する',
                    'allowed-request-declined-request' => '却下された返品の再開を許可する',
                    'allowed-rma-for-product' => '製品に対してRMAを許可する',
                    'cancel-items' => 'アイテムをキャンセル',
                    'cancelled-request-info' => '有効にすると、顧客はキャンセルされた返品を再申請でき、再確認のために「審査待ち」に戻ります。無効にすると、キャンセルされた返品は確定となり、再開できません。',
                    'complete' => '完了',
                    'current-order-quantity' => '現在の注文数量',
                    'days-info' => '注文後、顧客がRMAをリクエストできる日数。',
                    'declined-request-info' => '有効にすると、顧客は管理者が却下した返品を再申請でき、再確認のために「審査待ち」に戻ります。無効にすると、却下された返品は確定となり、再開できません。',
                    ...
                    'product-type-info' => '選択された商品タイプのみがRMAの対象となります。返品可能期間は注文時に確定されるため、ここでの変更は今後の注文にのみ適用されます。',
                    'resolution-type' => '解決方法の種類',
                    'return' => '返品／返金',
                    'return-pickup-address' => '返品の受け取り先住所',
                    'return-pickup-time' => '返品の受け取り時間',
                    'return-policy' => '返品ポリシー',
                    'return-policy-info' => '顧客が返品リクエストを送信する前に、ストアフロントで表示される返品ポリシーです。',
                    'specific-products' => '特定の製品',
                    'title' => 'RMA',
                    'yes' => 'はい',

                    'setting' => [
                        'info' => 'ストアでの返品（RMA）の動作を設定します：返品可能期間、許可する添付ファイルの種類、対象となる商品タイプ、顧客に表示する返品ポリシー、キャンセルまたは却下された返品を再開できるかどうか。',
                        'read' => 'ポリシーを読む',
    ...
    'emails' => [
        ...
        'rma' => [
            'conversation' => [
                'heading' => 'こんにちは :name',
                'message' => 'メッセージ',
                'quotes' => 'RMAの会話に新しいメッセージが届きました。',
                'subject' => '新しいRMA会話メッセージ',
                'title' => '新しいRMA会話',
            ],
        ],
    ],
