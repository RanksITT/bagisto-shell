        ...
        'rma' => [
            'all-rma' => [
                ...
                'view' => [
                    ...
                    'attachment' => '附件',
                    'by' => '由',
                    'change-status' => '更改请求状态',
                    'close-rma' => 'RMA 已关闭',
                    'confirm-item-canceled' => '商品已取消状态将取消该商品。是否继续？',
                    'confirm-item-refund' => '包裹已收到状态将向客户退款。是否继续？',
                    'confirm-print' => '点击确定打印 RMA',
                    'cancel-item' => 'Cancel Item',
                    'item-action-note' => 'This action affects the order and cannot be undone.',
                    'order-actions' => 'Order Actions',
                    'refund-item' => 'Refund Item',
                    'conversation-process' => '您的 RMA 请求已处理。',
                    'conversations' => '会话',
                    'customer' => '客户 :',
                    'customer-details' => '客户详情',
                    'customer-email' => '客户邮箱 :',
                    'declined-admin' => '请求被管理员拒绝',
                    'enter-message' => '输入消息',
                    'failed' => '操作失败。',
                    'images' => '图片 :',
                    'item-canceled' => '商品已取消',
                    ...
                    'solved' => '已解决',
                    'solved-by-admin' => '已由管理员解决',
                    'status' => '状态',
                    'status-message' => '您的 RMA ID #:id 状态已更改。状态：:status',
            ...
            'rma-status' => [
                'index' => [
                    ...
                    'datagrid' => [
                        ...
                        'created-at' => '创建时间',
                        'delete' => '删除',
                        'delete-success' => 'RMA 状态已成功删除。',
                        'disabled' => '未启用',
                        'edit' => '编辑',
                        'enabled' => '启用',
                        'id' => 'ID',
                        'mass-delete-success' => '所选 RMA 状态已成功删除。',
                        'reason-error' => 'RMA 状态正在被 RMA 使用。',
                        'reason' => 'RMA 状态',
                        'status' => '状态',
                        'title' => '标题',
                        'update' => '更新',
            ...
            'create-rma' => [
                'conversation-process' => '您的 RMA 请求已处理。',
                'create-success' => 'RMA 创建成功。',
                'create-title' => '创建 RMA',
                'email' => '电子邮箱',
                'failed' => '创建 RMA 失败。',
                'image' => '图片',
                'invalid-order-id' => '无效的订单 ID',
                'mismatch' => '订单 ID 与邮箱不匹配',
                'new-rma' => '新 RMA',
                'order-id' => '订单 ID',
                'quantity' => '数量',
                'reason' => '原因',
                'rma-already-exist' => 'RMA 已存在',
                'rma-not-available-quotes' => '该商品不可用于 RMA',
                'save-btn' => '保存',
                'search' => '--请选择--',
                'validate' => '验证',
            ],
    ...
    'marketing' => [
        ...
        'promotions' => [
            ...
            'cart-rules' => [
                ...
                'create' => [
                    'action-type' => '操作类型',
                    'action-type-info-buy-x-get-y' => '当客户购买 X 件商品时，额外赠送 Y 件免费商品。',
                    'action-type-info-by-fixed' => '对每个匹配商品应用固定金额折扣。',
                    'action-type-info-by-percent' => '对匹配商品应用百分比折扣。',
                    'action-type-info-cart-fixed' => '对整个购物车应用固定金额折扣。',
                    'actions' => '操作',
                    'add-condition' => '添加条件',
                    'additional' => '附加',
                    ...
                    'apply-to-shipping-disabled-info' => '仅适用于百分比和固定金额折扣。',
                    ...
                    'auto-generate-info' => '保存规则后可在编辑页面生成优惠券代码。',
                    'back-btn' => '返回',
                    ...
                    'less-than' => '小于',
                    'marketing-time' => '营销时间',
                    'maximum-discounted-quantity' => '最大折扣数量',
                    'maximum-discounted-quantity-info' => '限制每个匹配商品获得折扣的件数。',
                    'maximum-eligible-quantity-info' => '限制此商品参与"买 X 送 Y"活动的件数。',
                    'maximum-eligible-quantity' => '最大符合条件数量',
                    'name' => '名称',
                    'no' => '否',
                    'no-coupon' => '无优惠券',
                ...
                'edit' => [
                    ...
                    'attribute-name-parent-only' => ':attribute_name (仅限父类别)',
                    'auto-generate-coupon' => '自动生成优惠券',
                    'auto-generate-banner-description' => '为此规则批量创建唯一的优惠券代码。',
                    'auto-generate-banner-title' => '自动生成已启用',
                    'back-btn' => '返回',
                    'buy-x-get-y-free' => '买 X 送 Y',
                    'buy-x-quantity' => '买 X 数量',
                    'cart-attribute' => '购物车属性',
    ...
    'appearance' => [
        ...
        'sections' => [
            ...
            'edit' => [
                ...
                'chapter-engine' => '发动机',
                'chapter-figures' => '数据',
                'chapter-protection' => '保护',
                'chapter-viscosity' => '黏度',
                'category-carousel' => '类别轮播',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'api-key' => 'API 密钥',
                    'api-publishable-key' => '可发布的 API 密钥',
                    'api-test-key' => 'API 测试密钥',
                    'api-test-publishable-key' => 'API 测试可发布密钥',
                    'applicable-production' => '仅适用于生产模式',
                    'applicable-sandbox' => '仅适用于测试模式',
                    ...
                    'phonepe' => 'PhonePe',
                    'phonepe-info' => '配置 PhonePe 支付方式设置。',
                ...
                'rma' => [
                    ...
                    'allowed-request-cancelled-request' => '允许重新开启已取消的退货',
                    'allowed-request-declined-request' => '允许重新开启已拒绝的退货',
                    'allowed-rma-for-product' => '允许产品的RMA',
                    'cancel-items' => '取消项目',
                    'cancelled-request-info' => '启用后，客户可以重新提交已取消的退货，该退货将退回至“待审核”状态以便重新审查。禁用后，已取消的退货为最终状态，无法重新开启。',
                    'complete' => '完成',
                    'current-order-quantity' => '当前订单数量',
                    'days-info' => '客户在下订单后可以请求RMA的天数。',
                    'declined-request-info' => '启用后，客户可以重新提交被管理员拒绝的退货，该退货将退回至“待审核”状态以便重新审查。禁用后，已拒绝的退货为最终状态，无法重新开启。',
                    ...
                    'product-type-info' => '只有所选的产品类型才符合 RMA 条件。退货期限在下单时即已锁定，因此此处的更改仅适用于未来的订单。',
                    'resolution-type' => '解决类型',
                    'return' => '退货/退款',
                    'return-pickup-address' => '退货取件地址',
                    'return-pickup-time' => '退货取件时间',
                    'return-policy' => '退货政策',
                    'return-policy-info' => '客户在提交退货请求之前，于店面向其展示的退货政策。',
                    'specific-products' => '特定产品',
                    'title' => 'RMA',
                    'yes' => '是',

                    'setting' => [
                        'info' => '设置退货（RMA）在您店铺中的运作方式：退货期限、允许的附件文件类型、符合条件的产品类型、向客户展示的退货政策，以及是否可以重新开启已取消或已拒绝的退货。',
                        'read' => '阅读政策',
                        'terms' => '我已阅读并接受退货政策。',
                        'title' => 'RMA',
                    ],
