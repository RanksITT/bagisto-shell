...
return [
    ...
    'installer' => [
        ...
        'index' => [
            ...
            'sample-products' => [
                'no' => 'خیر',
                'note' => 'توجه: زمان ایندکس‌گذاری بستگی به تعداد زبان‌های انتخاب شده دارد. این فرآیند ممکن است تا ۲ دقیقه طول بکشد. اگر زبان‌های بیشتری اضافه کنید، سعی کنید حداکثر زمان اجرای سرور و تنظیمات PHP را افزایش دهید یا می‌توانید از نصب‌کننده CLI ما برای جلوگیری از اتمام زمان درخواست استفاده کنید.',
