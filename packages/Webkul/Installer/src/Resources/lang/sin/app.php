...
return [
    ...
    'installer' => [
        ...
        'index' => [
            ...
            'sample-products' => [
                'no' => 'නැහැ',
                'note' => 'සටහන: සුචිගත කිරීමේ කාලය තෝරාගත් ස්ථාන සංඛ්‍යාව මත රඳා පවතී. මෙම ක්‍රියාවලිය සම්පූර්ණ කිරීමට මිනිත්තු 2ක් දක්වා ගත විය හැක. ඔබ තවත් ස්ථාන එක් කරනවා නම්, සේවාදායකය සහ PHP සැකසුම්වල උපරිම ක්‍රියාත්මක කිරීමේ කාලය වැඩි කිරීමට උත්සාහ කරන්න, නැතහොත් ඉල්ලීමේ කාලය ඉක්මවා යාම වැළැක්වීමට අපගේ CLI ස්ථාපකය භාවිතා කරන්න.',
