...
return [
    ...
    'installer' => [
        ...
        'index' => [
            ...
            'sample-products' => [
                'no' => 'לא',
                'note' => 'הערה: זמן האינדוקס תלוי במספר השפות שנבחרו. תהליך זה עשוי להימשך עד 2 דקות. אם תוסיף שפות נוספות, נסה להגדיל את זמן הביצוע המרבי בהגדרות השרת ו-PHP שלך, או תוכל להשתמש במתקין ה-CLI שלנו כדי למנוע פקיעת זמן בקשה.',
