...
return [
    ...
    'installer' => [
        ...
        'index' => [
            ...
            'sample-products' => [
                'no' => 'لا',
                'note' => 'ملاحظة: يعتمد وقت الفهرسة على عدد اللغات المحددة. قد تستغرق هذه العملية ما يصل إلى دقيقتين حتى تكتمل. إذا قمت بإضافة المزيد من اللغات، حاول زيادة وقت التنفيذ الأقصى في إعدادات الخادم وPHP، أو يمكنك استخدام أداة التثبيت عبر سطر الأوامر لتجنب انتهاء مهلة الطلب.',
