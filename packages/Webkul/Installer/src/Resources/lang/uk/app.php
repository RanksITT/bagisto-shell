...
return [
    ...
    'installer' => [
        ...
        'index' => [
            ...
            'sample-products' => [
                'no' => 'Ні',
                'note' => 'Примітка: час індексації залежить від кількості вибраних мов. Цей процес може тривати до 2 хвилин. Якщо ви додаєте більше мов, спробуйте збільшити максимальний час виконання у налаштуваннях сервера та PHP або скористайтеся нашим CLI-інсталятором, щоб уникнути тайм-ауту запиту.',
            ...
            'start' => [
                'language' => 'Мова майстра встановлення',
                'locale' => 'Локаль',
                'main' => 'Початок',
